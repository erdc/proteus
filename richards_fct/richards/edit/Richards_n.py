...
#                                                                      c[('da',0,0,0)])
    ...
    def postStep(self, t, firstStep=False):
        ...
        with open('seepage_flux_nn', "a") as f:
            f.write("\n Time"+ ",\t" +"Seepage\n")
            f.write(repr(t)+ ",\t" +repr(self.anb_seepage_flux))
...
#                assert(self.nElementBoundaryQuadraturePoints_elementBoundary == 1)
    ...
    def getResidual(self,u,r):
        ...
        #print("Seepage Flux from Python file", self.coefficients.anb_seepage_flux)
