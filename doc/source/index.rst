...
For now, Proteus is only available to developers as source from our
git repository (:ref:`git-sec`) because we haven't had the resources
...
long and complicated compilation process.
...
Build instructions are available on our wiki
