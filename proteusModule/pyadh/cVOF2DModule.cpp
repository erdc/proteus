...
static PyObject* cVOF2D_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  //calculateResidual_VOF2D(nElements_global,
...
static PyObject* cVOF2D_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
  ...
  if (!PyArg_ParseTuple(args,
    ...
    return NULL;
  //calculateJacobian_VOF2D(nElements_global,
...
static PyMethodDef cVOF2DMethods[] = {
 { "calculateResidual",
    cVOF2D_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cVOF2D_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVOF2D(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVOF2D", cVOF2DMethods);
