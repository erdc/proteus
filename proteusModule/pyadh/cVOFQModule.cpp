...
static PyObject* cVOFQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
static PyObject* cVOFQ_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
...
static PyMethodDef cVOFQMethods[] = {
 { "calculateResidual",
    cVOFQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cVOFQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVOFQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVOFQ", cVOFQMethods);
