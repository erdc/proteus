...
//extern "C" void calculateResidual_MCorrQ(int nElements_global,
...
{
  using namespace MCORR_NAME;//MCorrQ;
  //
...
//extern "C" void calculateJacobian_MCorrQ(int nElements_global,
