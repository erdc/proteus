...
static PyObject* cRANS2P2D_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&flux))
    return NULL;
  calculateResidual_RANS2P2D(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2P2D_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  double dt,
  ...
  if (!PyArg_ParseTuple(args,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_RANS2P2D(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2P2D_calculateVelocityAverage(PyObject* self,
						  PyObject* args)
{
  int nInteriorElementBoundaries_global;
  PyObject* interiorElementBoundariesArray,
    *elementBoundaryElementsArray,
    *elementBoundaryLocalElementBoundariesArray,
    *vel_l2g, 
    *u_dof, 
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RANS2P2D(nInteriorElementBoundaries_global,
...
{
  PyObject *m,*d;
  m = Py_InitModule("cRANS2P2D", cRANS2P2DMethods);
