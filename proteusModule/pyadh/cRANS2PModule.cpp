					   ...
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&flux))
    return NULL;
  calculateResidual_RANS2P(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2P_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  double dt,
  ...
  if (!PyArg_ParseTuple(args,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_RANS2P(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2P_calculateVelocityAverage(PyObject* self,
						  PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RANS2P(nExteriorElementBoundaries_global,
				  IDATA(exteriorElementBoundariesArray),
				  nInteriorElementBoundaries_global,
...
{
  PyObject *m,*d;
  m = Py_InitModule("cRANS2P", cRANS2PMethods);
