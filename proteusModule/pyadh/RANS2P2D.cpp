...
extern "C" void calculateResidual_RANS2P2D(int nElements_global,
					   double alphaBDF,
					   double eps_rho,
					   double eps_mu,
					   double sigma,
...
extern "C" void calculateJacobian_RANS2P2D(int nElements_global,
					   double alphaBDF,
					   double eps_rho,
					   double eps_mu,
					   double sigma,
...
extern "C" void calculateVelocityAverage_RANS2P2D(int nInteriorElementBoundaries_global,
