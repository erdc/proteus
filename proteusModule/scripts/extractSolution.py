  ...
  <Domain>"""+"\n")
		...
		XMFfile.write(r'      <Grid GridType="Collection" CollectionType="Spatial">'+"\n")	
			...
			XMFfile.write(r'      <Time Value="'+str(step)+'" />'+"\n")
         		...
         		XMFfile.write (r' <DataItem DataType="Int" Dimensions="' +str(len(data))+ ' 4" Format="HDF">' + filename + ':/elementx</DataItem>'+"\n")
        		XMFfile.write (r'</Topology>'+"\n")  
     			...
     			XMFfile.write (r'<Attribute AttributeType="Scalar" Center="Node" Name="v">'+"\n")
                  	XMFfile.write (r'  <DataItem DataType="Float" Dimensions="' +str(len(data))+ '" Format="HDF" Precision="8">' + filename + ':/v_p"+str(proc)</DataItem>'+"\n")
                  	XMFfile.write (r'</Attribute>'+"\n")
