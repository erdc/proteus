...
coefficients = NCLevelSetCoefficients(V_model=1)
...
class Bubble_phi:
    ...
    def uOfX(self,X):
        ...
        dBubble = self.radius - sqrt((a*dx)**2 + dy**2)
...
initialConditions  = {0:Bubble_phi(center=[0.5*L[0],0.5*L[1]],radius=bubbleRadius)}
#bubble fall
