...
from HypPar_Test1_TransportCoefficients import *
from HypPar_SetParams import *
#John Chrispell, Spring 08


#analyticalSolutions = True
#analyticalSolution = {0:SimpleTest()}
analyticalSolution = {0:Ern_and_Proft_Test1()}
coefficients = HypPar_Test1_Coefficients(q=q,alpha=alpha,rFuncClass=rFuncClass,setParamsFunc=setParams)
...
#def getDBC(x):
#    if x[0] == 0.0:
#        return lambda x,t: SimpleTest().uOfXT(x,t) 
#    if x[0] == 2.0:
#        return lambda x,t: SimpleTest().uOfXT(x,t)
...
#initialConditions  = {0:SimpleTest()}
