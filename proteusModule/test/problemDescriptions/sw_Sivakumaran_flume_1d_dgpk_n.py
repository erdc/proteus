...
from sw_Sivakumaran_flume_1d_p import *

spaceOrder = 2; lagrangeBasis=False
if spaceOrder == 1:
    runCFL=0.1#0.3
elif spaceOrder == 2:
    runCFL=0.1
...
numericalFluxType = ShallowWaterHLL_1D#ShallowWaterHLL_1D#RusanovNumericalFlux#ShallowWater_1D
