...
class UnitSquareVortex(TransportCoefficients.TC_base):
    ...
    def initializeElementQuadrature(self,t,cq):
        cq[('velocity',0)] = cq[('dH',0,0)]
    def initializeElementBoundaryQuadrature(self,t,cebq):
        cebq[('velocity',0)] = cebq[('dH',0,0)]
    def initializeGlobalExteriorElementBoundaryQuadrature(self,t,cebqe):
        cebqe[('velocity',0)] = cebqe[('dH',0,0)]
    def attachModels(self,modelList):
        self.model = modelList[0]
        self.dummy = numpy.zeros(self.model.q[('dH',0,0)].shape,'d')
        ...
        if tryNCLS:
            ...
            self.unitSquareVortexLevelSetEvaluate(self.model.timeIntegration.tLast,
                                                  ...
                                                  self.model.q[('H',0)],self.model.q[('dH',0,0)])
