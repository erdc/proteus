...
# \ref ladr_2c_up_ss_1d_p.py "Linear advection-diffusion-reaction, two-component, upper triangular system, at steady state"
#

##\ingroup test
#\file ladr_2c_up_ss_1d_p.py
#
#\brief Linear advection-diffusion-reaction system with two-components at equilibrium in 1D.
#\todo finish ladr_2c_up_ss_1d_p.py doc
...
coefficients = LinearVADR_ConstantCoefficients_upper(nc=2,M=M0,A=A0,B=B0,C=C0)
