...
coefficients = ConservativeHeadRichardsL2projMualemVanGenuchtenBlockHet(hydraulicConductivity=dimensionless_conductivity,
...
#initialConditions  = {0:LinearIC_2D_Richards()}
initialConditions  = {0:HydroIC_2D_Richards()}

fluxBoundaryConditions = {0:'setFlow'}#{0:'noFlow'}

advectiveFluxBoundaryConditions =  {0:getDummyFlux}#{0:getRecharge_2D_UpperLeft}#{}

diffusiveFluxBoundaryConditions = {0:{0:getRecharge_2D_UpperLeft}} #{0:{}}
