...
name = "twp_darcy_split_het_col_sat"
model = 'VGM'
...
mvg_alpha_types = numpy.array([4.42*0.3048, 0.487e1*0.3048, 0.244e1*0.3048])
mvg_n_types     = numpy.array([2.68,2.37,2.09])
...
Ksw_types_md = numpy.array([1.1808e-1,1.1808e-2,1.1808e-3])
#m/s
