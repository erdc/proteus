...
from kEpsilon_k_step_2d_p import *
...
#subgridError = None
subgridError = AdvectionDiffusionReaction_ASGS(coefficients,nd,lag=lag_k_subgridError)

numericalFluxType = None

#shockCapturing = None
shockCapturing = ResGrad_SC(coefficients,nd,shockCapturingFactor=k_shockCapturingFactor,lag=True)
