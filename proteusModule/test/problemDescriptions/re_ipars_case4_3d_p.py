...
coefficients = ConservativeHeadRichardsJLeverettAni(phi_block=numpy.array([0.4,0.4,0.4,0.4,0.4]),
                                                    ...
                                                    nk_block=numpy.array([1.5,1.5,2.0,1.8,2.0]),
                                                    S_wirr_block=numpy.array([0.22,0.25,0.30,0.28,0.30]),
                                                    S_nwr_block=numpy.array([0.02,0.05,0.10,0.08,0.10]),
