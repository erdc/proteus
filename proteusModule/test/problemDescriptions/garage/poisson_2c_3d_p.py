...
"""
Poisson's equations for two components (uncoupled) in 3D
"""

##\page Tests Test Problems 
# \ref poisson_2c_3d_p.py "Poisson's equation for two components"
#

##\ingroup test
#\file poisson_2c_3d_p.py
#
#\brief Poisson's equations for two components (uncoupled) in 3D
...
A0={0:Numeric.array([[a0,0.0,0.0],[0.0,a0,0.0],[0.0,0.0,a0]]),
    1:Numeric.array([[a1,0.0,0.0],[0.0,a1,0.0],[0.0,0.0,a1]])}
