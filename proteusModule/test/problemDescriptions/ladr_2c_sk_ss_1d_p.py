...
# \ref ladr_2c_sk_ss_1d_p.py "Linear advection-diffusion-reaction, two-component, skew system, at steady state"
#

##\ingroup test
#\file ladr_2c_sk_ss_1d_p.py
#
#\brief Linear advection-diffusion-reaction system with two-components at equilibrium in 1D.
#\todo finish ladr_2c_di_sk_1d_p.py doc
...
if a0 > 0.0 and (b0/a0 < 1.0/2.5e-2):
    analyticalSolutions = {0:AnalyticalSolutions.LinearAD_SteadyState(b=B0[1][0],a=A0[1][0,0]),
                           1:AnalyticalSolutions.LinearAD_SteadyState(b=B0[0][0],a=A0[0][0,0])}
else:
    analyticalSolutions = None

coefficients = LinearVADR_ConstantCoefficients_skew(nc=2,M=M0,A=A0,B=B0,C=C0)
