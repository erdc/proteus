...
setup(name='proteus',
      ...
      packages = ['proteus'],
      ext_package='proteus',
      ext_modules=[Extension('cRANS2PV2HEX',
                             ['proteus/cRANS2PV2HEXModule.cpp','proteus/RANS2PV2HEX.cpp'],
		   ...
		   Extension('cRBLES2P',
                   ...
                   Extension('cMCorr',
                             ...
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension('cMCorrV2',
                             ['proteus/cMCorrV2Module.cpp','proteus/MCorrV2.cpp'],
                             define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H)],
                             include_dirs=[numpy.get_include(),'include',
                                           PROTEUS_SUPERLU_INCLUDE_DIR],
                             libraries=['m'],
                   ...
                   Extension('cRDLS',
                             ...
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension('cRDLSV2',
                             ['proteus/cRDLSV2Module.cpp','proteus/RDLSV2.cpp'],
                             define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H)],
                             #               ('RDLS_SPACE_DIM',3)],
                             include_dirs=[numpy.get_include(),'include',
                                           PROTEUS_SUPERLU_INCLUDE_DIR],
