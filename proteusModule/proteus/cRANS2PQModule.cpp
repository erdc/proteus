...
static PyObject* cRANS2PQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&flux))
    return NULL;
  calculateResidual_RANS2PQ(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2PQ_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  double dt,
  ...
  if (!PyArg_ParseTuple(args,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_RANS2PQ(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2PQ_calculateVelocityAverage(PyObject* self,
						  PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RANS2PQ(nExteriorElementBoundaries_global,
				  IDATA(exteriorElementBoundariesArray),
				  nInteriorElementBoundaries_global,
...
extern "C"
{
PyMODINIT_FUNC initcRANS2PQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cRANS2PQ", cRANS2PQMethods);
