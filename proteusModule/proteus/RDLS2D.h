...
#define RDLS_SPACE_DIM 2
 ...
 #define RDLS_NAME RDLS3D
 #define RDLS_RES calculateResidual_RDLS3D
 #define RDLS_JAC calculateJacobian_RDLS3D
#else
 #if (RDLS_SPACE_DIM == 2)
  #define nSpace 2
  ...
  #define nQuadraturePoints_elementBoundary 4
  #define RDLS_NAME RDLS2D
  #define RDLS_RES calculateResidual_RDLS2D
  #define RDLS_JAC calculateJacobian_RDLS2D
 #else 
  #define nSpace 1
  ...
  #define RDLS_NAME RDLS1D
  #define RDLS_RES calculateResidual_RDLS1D
  #define RDLS_JAC calculateJacobian_RDLS1D
 #endif
#endif
namespace RDLS_NAME
{
...
extern "C"
{
  //void calculateResidual_RDLS(int nElements_global,
  void RDLS_RES(int nElements_global,
			    double dt,
  ...
  //void calculateJacobian_RDLS(int nElements_global,
  void RDLS_JAC(int nElements_global,
			      double dt,
			      double epsilon_redist,
			      int freezeLevelSet,
			      int useTimeIntegration,
