...
static PyObject* cLADR1Dellam_calculateResidual(PyObject* self,
						PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
                        "ddddiiiiiOOOOOOOOOOOOOOOOOOOOOOOOiiOiiOOOOOOOOOOOOOOO",
                        &theta,
			&aL,
			&Dm,
			&dtnp1,
  ...
  calculateResidual_LADR1Dellam(theta,
				aL,
				Dm,
				dtnp1,
				nElements_global,
...
static PyObject* cLADR1Dellam_calculateJacobian(PyObject* self,
						PyObject* args)
{
  int nElements_global,
  ...
  if (!PyArg_ParseTuple(args,
                        "ddddiiOOOOOOOOOOOOOOOOiiOOOOOOOOOOOOO",
			&theta,
			&aL,
			&Dm,
			&dtnp1,
    ...
    return NULL;
  calculateJacobian_LADR1Dellam(theta,
				aL,
				Dm,
				dtnp1,
				nElements_global,
...
static PyObject* cLADR1Dellam_markInflowBoundaryPoints(PyObject* self,
						       PyObject* args)
{
  double tn,tnp1,t;
...
static PyObject* cLADR1Dellam_accumulateInflowFluxInGlobalResidual(PyObject* self,
								   PyObject* args)
{
  ...
  accumulateInflowFluxInGlobalResidual(nElements_global,
				       nNodes_global,
				       nNodes_element,
				       nElementBoundaries_element,
				       nExteriorElementBoundaries_global,
...
extern "C"
{
PyMODINIT_FUNC initcLADR1Dellam(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cLADR1Dellam", cLADR1DellamMethods);
