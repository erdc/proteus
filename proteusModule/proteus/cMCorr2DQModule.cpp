...
static PyObject* cMCorr2DQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  //calculateResidual_MCorr2DQ(nElements_global,
...
static PyObject* cMCorr2DQ_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  double epsHeaviside,epsDirac,epsDiffusion;
  ...
  if (!PyArg_ParseTuple(args,
			...
			&globalJacobian))
    return NULL;
  //calculateJacobian_MCorr2DQ(nElements_global,
...
static PyMethodDef cMCorr2DQMethods[] = {
 { "calculateResidual",
    cMCorr2DQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cMCorr2DQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcMCorr2DQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cMCorr2DQ", cMCorr2DQMethods);
