...
extern "C"
{
  void calculateResidual_RANS2P(int nElements_global,
				double alpha_bdf,
				double eps_rho,
				double eps_mu,
				double sigma,
  ...
  void calculateJacobian_RANS2P(int nElements_global,
				double alpha_bdf,
				double eps_rho,
				double eps_mu,
				double sigma,
  ...
  void calculateVelocityAverage_RANS2P(int nExteriorElementBoundaries_global,
				       int* exteriorElementBoundariesArray,
