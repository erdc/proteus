...
static PyObject* cNCLS2D_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  /*calculateResidual_NCLS(nElements_global,*/
  NCLS_RES (nElements_global,
		    dt,
		    lag_shockCapturing,
		    shockCapturingDiffusion,
		    IDATA(u_l2g), 
...
static PyObject* cNCLS2D_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
  ...
  if (!PyArg_ParseTuple(args,
    ...
    return NULL;
  /*calculateJacobian_NCLS(nElements_global,*/
  NCLS_JAC (nElements_global,
		    dt,
		    lag_shockCapturing,
		    shockCapturingDiffusion,
		    IDATA(u_l2g), 
...
static PyMethodDef cNCLS2DMethods[] = {
 { "calculateResidual",
    cNCLS2D_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cNCLS2D_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcNCLS2D(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cNCLS2D", cNCLS2DMethods);
