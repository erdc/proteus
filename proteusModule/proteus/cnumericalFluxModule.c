...
static PyObject*
cnumericalFluxCalculateGlobalExteriorNumericalStressTrace(PyObject* self, 
							  PyObject* args)
{
  PyObject *exteriorElementBoundaries,
    *elementBoundaryElements,
  ...
  if(!PyArg_ParseTuple(args,"OOOOOOOOOOOOOOOOOO",
		       ...
		       &stressTrace_w))
    return NULL;
  calculateGlobalExteriorNumericalStressTrace(SHAPE(stressTrace_u)[0],
					      SHAPE(stressTrace_u)[1],
					      SHAPE(stressTrace_u)[2],
					      IDATA(exteriorElementBoundaries),
					      IDATA(elementBoundaryElements),
					      IDATA(elementBoundaryLocalElementBoundaries),
					      IDATA(isDOFBoundary_u),
...
static PyMethodDef cnumericalFluxMethods[] = {
  ...
  { "calculateGlobalExteriorNumericalStressTrace",
    cnumericalFluxCalculateGlobalExteriorNumericalStressTrace,
    METH_VARARGS, 
