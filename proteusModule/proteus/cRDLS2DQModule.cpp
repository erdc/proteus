...
static PyObject* cRDLS2DQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
static PyObject* cRDLS2DQ_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int useTimeIntegration,lag_shockCapturing,lag_stabilization,
...
static PyMethodDef cRDLS2DQMethods[] = {
 { "calculateResidual",
    cRDLS2DQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for redistancing the level set equation"},
 { "calculateJacobian",
    cRDLS2DQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcRDLS2DQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cRDLS2DQ", cRDLS2DQMethods);
