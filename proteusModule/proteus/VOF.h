...
#define VOF_NAME VOF3D
#define VOF_RES calculateResidual_VOF3D
#define VOF_JAC calculateJacobian_VOF3D
#else
#if (VOF_SPACE_DIM == 2)
#define nSpace 2
...
#define nQuadraturePoints_elementBoundary 4
#define VOF_NAME VOF2D
#define VOF_RES calculateResidual_VOF2D
#define VOF_JAC calculateJacobian_VOF2D
#else 
#define nSpace 1
...
#define VOF_NAME VOF1D
#define VOF_RES calculateResidual_VOF1D
#define VOF_JAC calculateJacobian_VOF1D
#endif
#endif
...
extern "C"
{
  //void calculateResidual_VOF(int nElements_global,
  void VOF_RES (int nElements_global,
		double alphaBDF,
		...
		double* ebqe_u,
		double* ebqe_flux);
  //void calculateJacobian_VOF(int nElements_global,
  void VOF_JAC(int nElements_global,
	       double alphaBDF,
	       int lag_shockCapturing,/*mwf not used yet*/
	       double shockCapturingDiffusion,
	       int* u_l2g,
