...
//extern "C" void calculateResidual_VOFQ(int nElements_global,
extern "C" void VOFQ_RES(int nElements_global,
			 double alphaBDF,
...
//extern "C" void calculateJacobian_VOFQ(int nElements_global,
extern "C" void VOFQ_JAC (int nElements_global,
			  double alphaBDF,
			  int lag_shockCapturing,/*mwf not used yet*/
			  double shockCapturingDiffusion,
			  int* u_l2g,
