#ifndef RANS2PV2HEX_H
#define RANS2PV2HEX_H
#include <cmath>
#include <iostream>
...
extern "C"
{
  void calculateResidual_RANS2PV2HEX(//testing mesh replacement
  ...
  void calculateJacobian_RANS2PV2HEX(//testing mesh replacement
				  double* mesh_trial_ref,
				  double* mesh_grad_trial_ref,
				  double* mesh_dof,
				  int* mesh_l2g,
  ...
  void calculateVelocityAverage_RANS2PV2HEX(int* permutations,
					 int nExteriorElementBoundaries_global,
					 int* exteriorElementBoundariesArray,
