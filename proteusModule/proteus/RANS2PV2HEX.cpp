#include "RANS2PV2HEX.h"
#include <iostream>
#include <cassert>
 
extern "C" void calculateResidual_RANS2PV2HEX(//element
					   ...
					   double* flux)
{
  ...
  for(int eN=0;eN<nElements_global;eN++)
      ...
      for (int i=0;i<nDOF_test_element;i++)
	{
	  ...
	  //eps_rho=0.1;
	  //eps_mu=0.1;
	  RANS2PV2HEX::evaluateCoefficients(eps_rho,
					 eps_mu,
					 sigma,
					 rho_0,
					 nu_0,
  ...
  for (int ebNE = 0; ebNE < nExteriorElementBoundaries_global; ebNE++) 
	...
	{ 
	  ...
	  RANS2PV2HEX::exteriorNumericalAdvectiveFlux(isDOFBoundary_p[ebNE_kb],
	  ...
	  RANS2PV2HEX::exteriorNumericalDiffusiveFlux(eps_rho,
						   ebqe_phi_ext[ebNE_kb],
						   sdInfo_u_u_rowptr,
						   sdInfo_u_u_colind,
						   isDOFBoundary_u[ebNE_kb],
...
extern "C" void calculateJacobian_RANS2PV2HEX(//element
					   double* mesh_trial_ref,
					   double* mesh_grad_trial_ref,
					   double* mesh_dof,
					   int* mesh_l2g,
					   ...
					   int* csrColumnOffsets_eb_w_w)
{
  ...
  for (int ebNE = 0; ebNE < nExteriorElementBoundaries_global; ebNE++) 
	...
	{ 
	  ...
	  //calculate the numerical fluxes 
	  // 
	  RANS2PV2HEX::exteriorNumericalAdvectiveFluxDerivatives(isDOFBoundary_p[ebNE_kb],
							      isDOFBoundary_u[ebNE_kb],
							      isDOFBoundary_v[ebNE_kb],
							      isDOFBoundary_w[ebNE_kb],
							      isAdvectiveFluxBoundary_p[ebNE_kb],
	  ...
	  for (int j=0;j<nDOF_trial_element;j++)
		...
		RANS2PV2HEX::ExteriorNumericalDiffusiveFluxJacobian(eps_rho,
								 ebqe_phi_ext[ebNE_kb],
								 sdInfo_u_u_rowptr,
								 sdInfo_u_u_colind,
								 isDOFBoundary_u[ebNE_kb],
...
extern "C" void calculateVelocityAverage_RANS2PV2HEX(int* permutations,
						  int nExteriorElementBoundaries_global,
						  int* exteriorElementBoundariesArray,
