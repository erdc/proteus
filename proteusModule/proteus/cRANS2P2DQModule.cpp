...
static PyObject* cRANS2P2DQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
                        "iddddddddddOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOiiiiiiiiOiOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO",
                        &nElements_global,
			&dt,
			&eps_rho,
			&eps_mu,
			...
			&sdInfo_w_u_rowptr,&sdInfo_w_u_colind,
			&sdInfo_w_v_rowptr,&sdInfo_w_v_colind,
                        &offset_p,&offset_u,&offset_v,&offset_w,&stride_p,&stride_u,&stride_v,&stride_w,
			&globalResidual,
			...
			&flux))
    return NULL;
  calculateResidual_RANS2P2DQ(nElements_global,
			      dt,
			      eps_rho,
			      eps_mu,
			      sigma,
			      ...
			      offset_p,offset_u,offset_v,stride_p,stride_u,stride_v,DDATA(globalResidual),
			      nExteriorElementBoundaries_global,
...
static PyObject* cRANS2P2DQ_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  double dt,
  ...
  if (!PyArg_ParseTuple(args,
                        "iddddddddddOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOiOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO",
                        &nElements_global,
			&dt,
			&eps_rho,
			&eps_mu,
			...
			&csrColumnOffsets_eb_v_v))
    return NULL;
  calculateJacobian_RANS2P2DQ(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRANS2P2DQ_calculateVelocityAverage(PyObject* self,
						     PyObject* args)
{
  int nInteriorElementBoundaries_global,nExteriorElementBoundaries_global;
  PyObject* interiorElementBoundariesArray, *exteriorElementBoundariesArray,
    *elementBoundaryElementsArray,
    *elementBoundaryLocalElementBoundariesArray,
    *vel_l2g, 
    *u_dof, 
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RANS2P2DQ(nExteriorElementBoundaries_global,
				     IDATA(exteriorElementBoundariesArray),
				     nInteriorElementBoundaries_global,
...
extern "C"
{
PyMODINIT_FUNC initcRANS2P2DQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cRANS2P2DQ", cRANS2P2DQMethods);
