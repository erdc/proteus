...
//cek hack
// static PyObject* cRANS2PV2HEX_checkMem(PyObject* self,
// 				    PyObject* args)
// {
//   PyObject *test; 
...
static PyObject* cRANS2PV2HEX_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
*exteriorElementBoundariesArray,
  ...
  if (!PyArg_ParseTuple(args,
			...
			&flux))
    return NULL;
  calculateResidual_RANS2PV2HEX(//testing mesh replacement
...
static PyObject* cRANS2PV2HEX_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  double dt,
  ...
  if (!PyArg_ParseTuple(args,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_RANS2PV2HEX(//testing mesh replacement
  			     DDATA(mesh_trial_ref),
  			     DDATA(mesh_grad_trial_ref),
  			     DDATA(mesh_dof),
  			     IDATA(mesh_l2g),
...
static PyObject* cRANS2PV2HEX_calculateVelocityAverage(PyObject* self,
						  PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RANS2PV2HEX(IDATA(permutations),
				    nExteriorElementBoundaries_global,
				    IDATA(exteriorElementBoundariesArray),
				    nInteriorElementBoundaries_global,
...
extern "C"
{
PyMODINIT_FUNC initcRANS2PV2HEX(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cRANS2PV2HEX", cRANS2PV2HEXMethods);
