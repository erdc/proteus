...
#define VOFQ_SPACE_DIM 3
 ...
 #define VOFQ_NAME VOFQ3D
 #define VOFQ_RES calculateResidual_VOFQ3D
 #define VOFQ_JAC calculateJacobian_VOFQ3D
#else
 #if (VOFQ_SPACE_DIM == 2)
  #define nSpace 2
  ...
  #define VOFQ_NAME VOFQ2D
  #define VOFQ_RES calculateResidual_VOFQ2D
  #define VOFQ_JAC calculateJacobian_VOFQ2D
 #else 
  #define nSpace 1
  ...
  #define VOFQ_NAME VOFQ1D
  #define VOFQ_RES calculateResidual_VOFQ1D
  #define VOFQ_JAC calculateJacobian_VOFQ1D
 #endif
#endif
...
extern "C"
{
  //void calculateResidual_VOFQ(int nElements_global,
  void VOFQ_RES (int nElements_global,
		 double dt,
		 ...
		 double* ebqe_u,
		 double* ebqe_flux);
  //void calculateJacobian_VOFQ(int nElements_global,
  void VOFQ_JAC(int nElements_global,
		double dt,
		int lag_shockCapturing,/*mwf not used yet*/
		double shockCapturingDiffusion,
		int* u_l2g,
