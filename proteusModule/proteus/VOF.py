...
import cVOF,cVOF2D,cVOFQ,cVOF2DQ
...
#         self.numericalFlux.ebqe[('u',0)].flat[:]=1.0
        ...
        if isinstance(self.u[0].femSpace,C0_AffineLinearOnSimplexWithNodalBasis):
            cResidual = cVOF.calculateResidual
        ...
        #cVOF.calculateResidual(self.mesh.nElements_global,
        #mwf debug
        #import pdb
        #pdb.set_trace()
	...
	cfemIntegrals.zeroJacobian_CSR(self.nNonzerosInJacobian,
        ...
        #try to use 1d,2d,3d specific modules
        if isinstance(self.u[0].femSpace,C0_AffineLinearOnSimplexWithNodalBasis):
            cJacobian = cVOF.calculateJacobian
            if self.nSpace_global == 2:
        ...
        #cVOF.calculateJacobian(self.mesh.nElements_global,
