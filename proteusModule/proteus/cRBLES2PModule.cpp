...
static PyObject* cRBLES2P_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
                        "iddddddddddOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOiiiiiiiiOiOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO",
                        &nElements_global,
			&dt,
			&eps_rho,
			&eps_mu,
			...
			&flux))
    return NULL;
  calculateResidual_RBLES2P(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRBLES2P_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  double dt,
  ...
  if (!PyArg_ParseTuple(args,
                        "iddddddddddOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOiOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO",
                        &nElements_global,
			&dt,
			&eps_rho,
			&eps_mu,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_RBLES2P(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
...
static PyObject* cRBLES2P_calculateVelocityAverage(PyObject* self,
						  PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RBLES2P(nExteriorElementBoundaries_global,
				  IDATA(exteriorElementBoundariesArray),
				  nInteriorElementBoundaries_global,
...
static PyMethodDef cRBLES2PMethods[] = {
 { "calculateResidual",
    cRBLES2P_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the two-phase RBLES equations"},
 { "calculateJacobian",
    cRBLES2P_calculateJacobian,
   METH_VARARGS, 
   "Calculate the global Jacobian for the two-phase RBLES equations"},
 { "calculateVelocityAverage",
    cRBLES2P_calculateVelocityAverage,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcRBLES2P(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cRBLES2P", cRBLES2PMethods);
