...
extern "C"
{
void calculateResidual_RANS2P2D(int nElements_global,
		       double dt,
		       double eps_rho,
		       double eps_mu,
		       double sigma,
...
void calculateJacobian_RANS2P2D(int nElements_global,
		       double dt,
		       double eps_rho,
		       double eps_mu,
		       double sigma,
...
void calculateVelocityAverage_RANS2P2D(int nInteriorElementBoundaries_global,
