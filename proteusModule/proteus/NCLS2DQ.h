...
#define NCLSQ_SPACE_DIM 2
#if (NCLSQ_SPACE_DIM == 3)
 #define nSpace 3
 ...
 #define NCLSQ_NAME NCLSQ3D
 #define NCLSQ_RES calculateResidual_NCLSQ3D
 #define NCLSQ_JAC calculateJacobian_NCLSQ3D
#else
 #if (NCLSQ_SPACE_DIM == 2)
  #define nSpace 2
  ...
  #define NCLSQ_NAME NCLSQ2D
  #define NCLSQ_RES calculateResidual_NCLSQ2D
  #define NCLSQ_JAC calculateJacobian_NCLSQ2D
 #else 
  #define nSpace 1
  ...
  #define NCLSQ_NAME NCLSQ1D
  #define NCLSQ_RES calculateResidual_NCLSQ1D
  #define NCLSQ_JAC calculateJacobian_NCLSQ1D
 #endif
#endif

namespace NCLSQ_NAME
{
inline
...
extern "C"
{
  //void calculateResidual_NCLSQ(int nElements_global,
  void NCLSQ_RES (int nElements_global,
		double dt,
  ...
  //  void calculateJacobian_NCLSQ(int nElements_global,
  void NCLSQ_JAC (int nElements_global,
			 double dt,
			 int lag_shockCapturing,/*mwf not used yet*/
			 double shockCapturingDiffusion,
			 int* u_l2g,
