...
extern "C" void calculateResidual_RANS2P2DQ(int nElements_global,
					  double alphaBDF,
					  double epsFact_rho,
					  double epsFact_mu, 
					  double sigma,
...
extern "C" void calculateJacobian_RANS2P2DQ(int nElements_global,
					    double alphaBDF,
					    double epsFact_rho,
					    double epsFact_mu,
					    double sigma,
...
extern "C" void calculateVelocityAverage_RANS2P2DQ(int nExteriorElementBoundaries_global,
						   int* exteriorElementBoundariesArray,
