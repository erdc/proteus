#ifndef VOLUME_AVERAGED_VOF2DQ_H
#define VOLUME_AVERAGED_VOF2DQ_H
#include <cmath>
#include <iostream>

#define VOL_VOF_SPACE_DIM 2
 ...
 #define VOL_VOF_JAC calculateJacobian_VolumeAveragedVOF3D
  ...
  #define VOL_VOF_NAME VolumeAveragedVOF2DQ
  #define VOL_VOF_RES calculateResidual_VolumeAveragedVOF2DQ
  #define VOL_VOF_JAC calculateJacobian_VolumeAveragedVOF2DQ
 #else 
  #define nSpace 1
...
void VOL_VOF_RES(int nElements_global,
					 double dt,
