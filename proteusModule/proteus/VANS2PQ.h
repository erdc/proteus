...
#define nQuadraturePoints_elementBoundary 6
			    ...
			    double dmom_w_ham_grad_p[nSpace])
{
  ...
  mom_w_source = -porosity*g[2] - porosity*d_mu*sigma*kappa*n[2]/(rho*(norm_n+1.0e-8))
	+ porosity*porosity*nu*Kinv*(1.0+Ftilde*uc)*w;
  ...
  dmom_u_source_w = porosity*porosity*nu*Kinv*(0.0 + Ftilde*(u*w/(uc+1.0e-12)));
  ...
  dmom_v_source_w = porosity*porosity*nu*Kinv*(0.0 + Ftilde*(w*v/(uc+1.0e-12)));
  
  dmom_w_source_u = porosity*porosity*nu*Kinv*(0.0 + Ftilde*(w*u/(uc+1.0e-12)));
  dmom_w_source_v = porosity*porosity*nu*Kinv*(0.0 + Ftilde*(w*v/(uc+1.0e-12)));
  dmom_w_source_w = porosity*porosity*nu*Kinv*(1.0 + Ftilde*(uc + w*w/(uc+1.0e-12)));
				 ...
				 double& nu_t)
{
  const double norm_S2 = 	    
    grad_u[0]*grad_u[0] + grad_v[1]*grad_v[1] + grad_w[2]*grad_w[2]
    +
...
//need to add porosity for nu_t definition
inline 
			   ...
			   double mom_wv_diff_ten[1])
{
  ...
  mom_u_diff_ten[2] += nu_t;

  mom_uv_diff_ten[0]+=nu_t;
  
  mom_uw_diff_ten[0]+=nu_t;

  //v momentum diffusion tensor
  mom_v_diff_ten[0] += nu_t;
  mom_v_diff_ten[1] += 2.0*nu_t;
  mom_v_diff_ten[2] += nu_t;

  mom_vu_diff_ten[0]+=nu_t;

  mom_vw_diff_ten[0]+=nu_t;
  
  //w momentum diffusion tensor
  mom_w_diff_ten[0] += nu_t;
  mom_w_diff_ten[1] += nu_t;
  mom_w_diff_ten[2] += 2.0*nu_t;

  mom_wu_diff_ten[0]+=nu_t;
  
  mom_wv_diff_ten[0]+=nu_t;
...
void evaluateWaveForcing_c(const double& t,
			   ...
			   const double& source_z0,
			   const double& source_z1,
			   const double& eps,
			   double& mass_source)
{
  const double dx_source   = source_x1-source_x0;
  const double dy_source   = source_y1-source_y0;
  const double dz_source   = source_z1-source_z0;
  const double source_volume = dx_source*dy_source*dz_source;
  ...
  const double distance_z = fabs(x[2]-0.5*(source_z0+source_z1)) - 0.5*dz_source;
  
  const double delta =  (1.0-smoothedHeaviside(eps,distance_x))*(1.0-smoothedHeaviside(eps,distance_y))*(1.0-smoothedHeaviside(eps,distance_z));
...
void calculateSubgridErrorDerivatives_tauRes_c(const double& tau0,
					       ...
					       const double dpdeResidualU_dw[nDOF_trial_element],//new
					       ...
					       const double dpdeResidualV_dw[nDOF_trial_element],//new
					       const double dpdeResidualW_dp[nDOF_trial_element],
					       const double dpdeResidualW_dw[nDOF_trial_element],
					       const double dpdeResidualW_du[nDOF_trial_element],//new
					       const double dpdeResidualW_dv[nDOF_trial_element],//new
					       ...
					       double dsubgridErrorU_dw[nDOF_trial_element],//new
					       double dsubgridErrorV_dp[nDOF_trial_element],
					       double dsubgridErrorV_dv[nDOF_trial_element],
					       double dsubgridErrorV_du[nDOF_trial_element],//new
					       double dsubgridErrorV_dw[nDOF_trial_element],//new
					       double dsubgridErrorW_dp[nDOF_trial_element],
					       double dsubgridErrorW_dw[nDOF_trial_element],
					       double dsubgridErrorW_du[nDOF_trial_element],//new
					       double dsubgridErrorW_dv[nDOF_trial_element])
{
...
void calculateSubgridError_tauRes(int eN,
                                  ...
                                  double* dpdeResidualU_dv,//new
                                  double* dpdeResidualU_dw,//new
                                  double* pdeResidualV,
                                  double* dpdeResidualV_dp,
                                  double* dpdeResidualV_dv,
                                  double* dpdeResidualV_du,//new
                                  double* dpdeResidualV_dw,//new
                                  double* pdeResidualW,
                                  double* dpdeResidualW_dp,
                                  double* dpdeResidualW_dw,
                                  double* dpdeResidualW_du,//new
                                  double* dpdeResidualW_dv,//new
                                  double* subgridErrorP,
                                  ...
                                  double* dsubgridErrorU_dv,//new
                                  double* dsubgridErrorU_dw,//new
                                  double* subgridErrorV,
                                  double* dsubgridErrorV_dp,
                                  double* dsubgridErrorV_dv,
                                  double* dsubgridErrorV_du,//new
                                  double* dsubgridErrorV_dw,//new
                                  double* subgridErrorW,
                                  double* dsubgridErrorW_dp,
                                  double* dsubgridErrorW_dw,
                                  double* dsubgridErrorW_du,//new
                                  double* dsubgridErrorW_dv)
{
  ...
  calculateSubgridErrorDerivatives_tauRes_c(tau0[eN*nQuadraturePoints_element+k],
					    ...
					    &dpdeResidualU_dw[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    ...
					    &dpdeResidualV_dw[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    ...
					    &dpdeResidualW_du[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    &dpdeResidualW_dv[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    ...
					    &dsubgridErrorU_dw[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    ...
					    &dsubgridErrorV_dw[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    ...
					    &dsubgridErrorW_du[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element],
					    &dsubgridErrorW_dv[eN*nQuadraturePoints_element*nDOF_trial_element+k*nDOF_trial_element]);
}
...
inline
void exteriorNumericalDiffusiveFlux_c(int* rowptr,
				      int* colind,
...
inline
void exteriorNumericalDiffusiveFlux(int ebNE,
				    int k,
				    int* rowptr,
				    int* colind,
				    int* isDOFBoundary,
...
{
  const int nnz=rowptr[nSpace];
  exteriorNumericalDiffusiveFlux_c(rowptr,
				   colind,
...
inline
double ExteriorNumericalDiffusiveFluxJacobian_c(int* rowptr,
						int* colind,
						const int& isDOFBoundary,
						const double n[nSpace],
						double* a,
...
inline
void updateExteriorNumericalDiffusiveFluxJacobian(int ebNE,
						  int k,
						  int j,
						  int* rowptr,
						  int* colind,
						  ...
						  double* fluxJacobian)
{
  ...
  fluxJacobian[ebNE*nQuadraturePoints_elementBoundary*nDOF_trial_element+
	       k*nDOF_trial_element+
	       j] += ExteriorNumericalDiffusiveFluxJacobian_c(rowptr,
							      colind,
							      isDOFBoundary[ebNE*nQuadraturePoints_elementBoundary+k],
							      &n[ebNE*nQuadraturePoints_elementBoundary*nSpace+
								 k*nSpace],
...
extern "C"
{
void calculateResidual_VANS2PQ(int nElements_global,
			      double dt,
			      double eps_rho,
			      double eps_mu,
			      double sigma,
...
void calculateJacobian_VANS2PQ(int nElements_global,
			      double dt,
			      double eps_rho,
			      double eps_mu,
			      double sigma,
