...
*exteriorElementBoundariesArray,
  ...
  if (!PyArg_ParseTuple(args,
                        "OOOOOOOOOOOOOOOOOOOOOOOOOOiddddddddddOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOiiiiiiiiOiOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO",
			//testing
			&mesh_trial_ref,
			&mesh_grad_trial_ref,
			&mesh_dof,
					   ...
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_RANS2PV2(nElements_global,
	      dt,
	      eps_rho,
	      eps_mu,
	      sigma,
						  ...
						  PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&velocityAverage))
    return NULL;
  calculateVelocityAverage_RANS2PV2(nExteriorElementBoundaries_global,
				  IDATA(exteriorElementBoundariesArray),
				  nInteriorElementBoundaries_global,
