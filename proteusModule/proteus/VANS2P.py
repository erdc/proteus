...
import cVANS2P
import cRANS2P #for velocity average calculation

class OneLevelVANS2P(OneLevelTransport):
    nCalls=0
    def __init__(self,
                 uDict,
                 phiDict,
...
#                                    movingDomain)
        ...
        if isinstance(self.u[0].femSpace,C0_AffineLinearOnSimplexWithNodalBasis):
            ...
            print self.nQuadraturePoints_element
            assert(self.nQuadraturePoints_element == 15)
            print self.nElementBoundaryQuadraturePoints_elementBoundary
            assert(self.nElementBoundaryQuadraturePoints_elementBoundary == 7)
        #
        ...
        self.ebq[('v',0)] = numpy.zeros((self.mesh.nElements_global,self.mesh.nElementBoundaries_element,self.nElementBoundaryQuadraturePoints_elementBoundary,self.nDOF_trial_element[0]),'d')
        self.ebq[('w',0)] = self.ebq[('v',0)]
        self.ebq[('grad(v)',0)] =  numpy.zeros((self.mesh.nElements_global,self.mesh.nElementBoundaries_element,self.nElementBoundaryQuadraturePoints_elementBoundary,self.nDOF_trial_element[0],self.nSpace_global),'d')
        self.ebq[('w*dS_u',0)] =  numpy.zeros((self.mesh.nElements_global,self.mesh.nElementBoundaries_element,self.nElementBoundaryQuadraturePoints_elementBoundary,self.nDOF_trial_element[1]),'d')
        self.ebq[('dS_u',0)] =  numpy.zeros((self.mesh.nElements_global,self.mesh.nElementBoundaries_element,self.nElementBoundaryQuadraturePoints_elementBoundary),'d')
        #
        #show quadrature
        #
    ...
    def getResidual(self,u,r):
        ...
        """
#         if isinstance(self.u[0].femSpace,C0_AffineLinearOnSimplexWithNodalBasis):
#             cResidual = cRANS2P.calculateResidual
...
#                 cResidual = cRANS2P2DQ.calculateResidual
        ...
        self.stabilization.v_last.flat[:] = self.q[('velocity',0)].flat
        #import pdb
        #pdb.set_trace()
        cVANS2P.calculateResidual(self.mesh.nElements_global,
                                  ...
                                  self.coefficients.turbulenceClosureFlag,#new
                                  self.coefficients.smagorinskyConstant_0,#new
                                  self.timeIntegration.t,#new
                                  self.q['x'],#new
                                  self.coefficients.eps_source,#new
                                  self.coefficients.waveFlag,#new
                                  self.coefficients.waveHeight,#new
                                  self.coefficients.waveCelerity,#new
                                  self.coefficients.waveFrequency,#new
                                  self.coefficients.Omega_s[0][0],#new
                                  self.coefficients.Omega_s[0][1],#new
                                  self.coefficients.Omega_s[1][0],#new
                                  self.coefficients.Omega_s[1][1],#new
                                  self.coefficients.Omega_s[2][0],#new
                                  self.coefficients.Omega_s[2][1],#new
                                  self.coefficients.killNonlinearDrag,#new
                                  self.coefficients.q_meanGrain,#new
                                  self.coefficients.q_porosity,#new
                                  ...
                                  self.offset[0],self.offset[1],self.offset[2],self.offset[3],self.stride[0],self.stride[1],self.stride[2],self.stride[3],
                                  r,
                                  ...
                                  self.coefficients.ebqe_meanGrain,#new
                                  self.coefficients.ebqe_porosity,#new
    ...
    def getJacobian(self,jacobian):
        ...
        import numpy
#         if isinstance(self.u[0].femSpace,C0_AffineLinearOnSimplexWithNodalBasis):
#             cJacobian = cRANS2P.calculateJacobian
#             if self.nSpace_global == 2:
...
#                 cJacobian = cRANS2P2DQ.calculateJacobian
    ...
    def calculateAuxiliaryQuantitiesAfterStep(self):
        cRANS2P.calculateVelocityAverage(self.mesh.nExteriorElementBoundaries_global,
                                         self.mesh.exteriorElementBoundariesArray,
...
#         if isinstance(self.u[0].femSpace,C0_AffineLinearOnSimplexWithNodalBasis):
#             cva = cRANS2P.calculateVelocityAverage
#             if self.nSpace_global == 2:
