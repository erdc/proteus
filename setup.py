...
EXTENSIONS_TO_BUILD = [Extension("MeshAdaptPUMI.MeshAdaptPUMI",
              ...
              Extension("mprans.cPresInc",['proteus/mprans/cPresInc.pyx'],
                        ...
                        extra_compile_args=PROTEUS_OPT,
                        include_dirs=[numpy.get_include(),'proteus']),
              Extension("yy.cMy_projection",['proteus/yy/cMy_projection.pyx'],
                        depends=['proteus/yy/My_projection.h', 'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
                        language='c++',
                        extra_compile_args=PROTEUS_OPT,
                        include_dirs=[numpy.get_include(),'proteus']),
              Extension("yy.cMy_correction",['proteus/yy/cMy_correction.pyx'],
                        depends=['proteus/yy/My_correction.h', 'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
                        language='c++',
                        extra_compile_args=PROTEUS_OPT,
                        include_dirs=[numpy.get_include(),'proteus']),
