      ...
      data_files=[(proteus_install_path,
                  ...
                  (os.path.join(proteus_install_path,'tests','solver_tests','import_modules'),
                   ['proteus/tests/solver_tests/import_modules/quad_mass_matrix.npy',
                    ...
                    'proteus/tests/solver_tests/import_modules/input_vec_tppcd',
                    'proteus/tests/solver_tests/import_modules/tp_pcd_y_output',
                    'proteus/tests/solver_tests/import_modules/Qp_visc',
                    'proteus/tests/solver_tests/import_modules/Qp_dens',
                    'proteus/tests/solver_tests/import_modules/Ap_rho',
                    'proteus/tests/solver_tests/import_modules/Np_rho']),
                  ...
                  (os.path.join(proteus_install_path,'tests','cylinder2D','conforming_rans3p'),
                   ['proteus/tests/conforming_rans3p/comparison_files/T1P1.h5',
                    'proteus/tests/conforming_rans3p/comparison_files/T4P2.h5',
                    'proteus/tests/conforming_rans3p/comparison_files/T8P2.h5']),
                  (os.path.join(proteus_install_path,'tests','cylinder2D','ibm_method'),
                   ['proteus/tests/ibm_method/comparison_files/T1_rans3p.h5']),
                  (os.path.join(proteus_install_path,'tests','cylinder2D','conforming_rans2p'),
                   ['proteus/tests/conforming_rans2p/comparison_files/T1_rans2p.h5'])
      ],
