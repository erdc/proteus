...
setup(name='proteus',
      ...
      ext_modules=[Extension('MeshAdaptPUMI.MeshAdaptPUMI',
                   ...
                   Extension("mbd.pyChronoCore",['proteus/mbd/pyChronoCore.pyx'],
                             ...
                             language='c++',
                             include_dirs=[numpy.get_include(),'proteus',PROTEUS_INCLUDE_DIR,PROTEUS_CHRONO_INCLUDE_DIR+'/collision/bullet',],#, PROTEUS_INCLUDE_DIR+'/chrono', PROTEUS_INCLUDE_DIR+'/chrono_fea'],
