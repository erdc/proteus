...
EXTENSIONS_TO_BUILD = [Extension("MeshAdaptPUMI.MeshAdaptPUMI",
              ...
              Extension('cmeshTools',
                        ...
                        extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS+PROTEUS_OPT,
                        extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
              Extension("cmeshToolsTest",
                        ['proteus/cmeshToolsTest.pyx', 'proteus/mesh.cpp', 'proteus/meshio.cpp'],
                        language='c++',
              ...
              Extension('cSubsurfaceTransportCoefficients',
                        ...
                        extra_link_args=PROTEUS_EXTRA_LINK_ARGS,
                        extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS+PROTEUS_OPT),
              Extension("flcbdfWrappersTest",["proteus/flcbdfWrappersTest.pyx",
                                              "proteus/partitioning.cpp"],
                        depends=["proteus/partitioning.h"],
                        extra_compile_args=PROTEUS_OPT,
                        language="c++",
                        include_dirs=[numpy.get_include(), 'proteus', PROTEUS_HDF5_INCLUDE_DIR],
              ...
              Extension('flcbdfWrappers',
                        ['proteus/flcbdfWrappersModule.cpp','proteus/mesh.cpp','proteus/meshio.cpp','proteus/partitioning.cpp'],
                        define_macros=[('PROTEUS_TRIANGLE_H',PROTEUS_TRIANGLE_H),
                                       ('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H),
                                       ('CMRVEC_BOUNDS_CHECK',1),
                                       ('MV_VECTOR_BOUNDS_CHECK',1),
