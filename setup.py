...
setup(name='proteus',
      ...
      ext_modules=[Extension('MeshAdaptPUMI.MeshAdaptPUMI',
                             ...
                             include_dirs=[numpy.get_include(),'include',
                                           'proteus']+
                                           PROTEUS_SCOREC_INCLUDE_DIRS + [PROTEUS_CGAL_INCLUDE_DIR],
                              library_dirs=PROTEUS_SCOREC_LIB_DIRS+[PROTEUS_CGAL_LIB_DIR],
                              libraries=PROTEUS_SCOREC_LIBS+PROTEUS_CGAL_LIBS,
