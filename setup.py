...
EXTENSIONS_TO_BUILD = [Extension("MeshAdaptPUMI.MeshAdaptPUMI",
              ...
              Extension("subsurfaceTransportFunctions",['proteus/subsurfaceTransportFunctions.pyx'],
                        ...
                        extra_compile_args=PROTEUS_OPT,
                        extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
              #Extension("cfemIntegrals_v2",["proteus/cfemIntegrals_v2.pyx", "proteus/femIntegrals_v2.c"],
              #          depends=["proteus/cfemIntegrals_v2.h"],
              #          extra_compile_args=PROTEUS_OPT,
              #          language="c", include_dirs=[numpy.get_include(), 'proteus']),
              Extension('cfemIntegrals_v2',
                        ['proteus/cfemIntegrals_v2.pyx','proteus/femIntegrals_v2.c','proteus/postprocessing.c'],
                        define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H),
              ...
              Extension("mprans.cVOF",["proteus/mprans/cVOF.pyx"],
                        ...
                        extra_compile_args=PROTEUS_OPT,
                        include_dirs=[numpy.get_include(), 'proteus']),
              Extension("mprans.cTestFemIntegrals",["proteus/mprans/cTestFemIntegrals.pyx"],
                        depends=["proteus/mprans/TestFemIntegrals.h"] + ["proteus/ModelFactory.h","proteus/CompKernel.h"],
                        language="c++",
                        extra_compile_args=PROTEUS_OPT,
                        include_dirs=[numpy.get_include(), 'proteus']),
