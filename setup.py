...
setup(name='proteus',
      ...
      packages = ['proteus',
                  'proteus.mprans',
                  'proteus.richards',
                  'proteus.dilutetransport',
                  'proteus.nondilutetransport',
      ...
      ext_modules=[Extension('MeshAdaptPUMI.MeshAdaptPUMI',
                   ...
                   Extension("mprans.cRANS2P",["proteus/mprans/cRANS2P.pyx"],
                             depends=["proteus/mprans/RANS2P.h"] + ["proteus/ModelFactory.h","proteus/CompKernel.h"],
                   ...
                   Extension("mprans.cVOF",["proteus/mprans/cVOF.pyx"],
                             ...
                             language="c++",
                             include_dirs=[numpy.get_include(), 'proteus']),
                   Extension("mprans.cTIM",["proteus/mprans/cTIM.pyx"],
                             depends=["proteus/mprans/TIM.h"] + ["proteus/ModelFactory.h","proteus/CompKernel.h"],
                             language="c++",
                             include_dirs=[numpy.get_include(), 'proteus']),
                   Extension('dilutetransport.cdilutetransportCoefficients',
                             ['proteus/dilutetransport/TCAT_ND.cpp','proteus/dilutetransport/cdilutetransportCoefficientsModule.cpp','proteus/dilutetransport/dilutetransportCoefficients.cpp'],
                             include_dirs=[numpy.get_include(),'proteus'],
                             language="c++",
                             depends=['proteus/dilutetransport/TCAT_ND.h'],
                             extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS,
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension("dilutetransport.cEVDiluteTransport",["proteus/dilutetransport/cEVDiluteTransport.pyx","proteus/dilutetransport/TCAT_ND.cpp"],
                             depends=["proteus/dilutetransport/EVDiluteTransport.h","proteus/dilutetransport/TCAT_ND.h","proteus/ModelFactory.h","proteus/CompKernel.h"],
                             language="c++",
                             include_dirs=[numpy.get_include(), 'proteus'],
                             extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS,
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension('nondilutetransport.cnondilutetransportCoefficients',
                             ['proteus/nondilutetransport/TCAT_ND.cpp','proteus/nondilutetransport/cnondilutetransportCoefficientsModule.cpp','proteus/nondilutetransport/nondilutetransportCoefficients.cpp'],
                             include_dirs=[numpy.get_include(),'proteus'],
                             language="c++",
                             depends=['proteus/nondilutetransport/TCAT_ND.h'],
                             extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS,
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
                   Extension("nondilutetransport.cEVNonDiluteTransport",["proteus/nondilutetransport/cEVNonDiluteTransport.pyx","proteus/nondilutetransport/TCAT_ND.cpp"],
                             depends=["proteus/nondilutetransport/EVNonDiluteTransport.h","proteus/nondilutetransport/TCAT_ND.h","proteus/ModelFactory.h","proteus/CompKernel.h"],
                             language="c++",
                             include_dirs=[numpy.get_include(), 'proteus'],
                             extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS,
                             extra_link_args=PROTEUS_EXTRA_LINK_ARGS),
