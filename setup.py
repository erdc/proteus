...
setup(name='proteus',
      ...
      ext_modules=[Extension("mprans.Pres",['proteus/mprans/Pres.pyx'],
                   ...
                   Extension("mprans.BoundaryConditions",['proteus/mprans/BoundaryConditions.py'],
                             language='c',
                             include_dirs=[numpy.get_include(),'proteus']),
                   Extension("mbd.ChRigidBody",['proteus/mbd/ChRigidBody.pyx'],
                             depends=['proteus/mbd/ChRigidBody.h', 'proteus/mbd/ChMoorings.h'],
                             language='c++',
                             include_dirs=[numpy.get_include(),'proteus',PROTEUS_INCLUDE_DIR, PROTEUS_INCLUDE_DIR+'/chrono', PROTEUS_INCLUDE_DIR+'/chrono_fea'],
