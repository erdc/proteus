...
setup(name='proteus',
      ...
      data_files=[(proteus_install_path,
                  ...
                  (os.path.join(proteus_install_path,'tests','matrix_constructor','comparison_files'),
                   ['proteus/tests/matrix_constructor/comparison_files/B_mat_reference_element_1.npy',
                    'proteus/tests/matrix_constructor/comparison_files/advection_reference_triangle_2d.npy',
                    'proteus/tests/matrix_constructor/comparison_files/advection_pressure_mesh_8.npy',
                    'proteus/tests/matrix_constructor/comparison_files/laplace_reference_c0p1_3D.txt',
                    'proteus/tests/matrix_constructor/comparison_files/laplace_TH_mesh.npy',
                    ...
                    'proteus/tests/matrix_constructor/comparison_files/mass_mat_stokes_ex.txt',
                    ...
                    'proteus/tests/matrix_constructor/comparison_files/pressure_C0P1_mesh.npy',
                    'proteus/tests/matrix_constructor/comparison_files/pressure_laplace_C0P1_mesh.npy',
                    'proteus/tests/matrix_constructor/comparison_files/pressure_vel_mat.npy',
                    'proteus/tests/matrix_constructor/comparison_files/single_phase_THQuad_4_expected.data',
                    'proteus/tests/matrix_constructor/comparison_files/two_phase_THQuad_4_expected.data',
                    'proteus/tests/matrix_constructor/comparison_files/two_phase_mass_matrix_expected_mesh_8.data',
                    'proteus/tests/matrix_constructor/comparison_files/two_phase_invscaled_laplace_TH_8_expected.data',
                  ...
                  (os.path.join(proteus_install_path,'tests','mesh_tests','comparison_files'),
                   ['proteus/tests/mesh_tests/comparison_files/drivenCavityStokesC0Q1C0Q1.h5',
                    'proteus/tests/mesh_tests/comparison_files/drivenCavityStokesC0Q1C0Q1.xmf',
                    'proteus/tests/mesh_tests/comparison_files/poiseulleFlow_expected.h5',
                    'proteus/tests/mesh_tests/comparison_files/poiseulleFlow_expected.h5']),
                  ...
                  (os.path.join(proteus_install_path,'tests','solver_tests_slow','comparison_files'),
                   ['proteus/tests/solver_tests_slow/comparison_files/drivenCavityNSE_LSC_expected.h5',
                    ...
                    'proteus/tests/solver_tests_slow/comparison_files/drivenCavityStokes_expected.xmf',
                    'proteus/tests/solver_tests_slow/comparison_files/drivenCavityStokes_expected.h5',
                    'proteus/tests/solver_tests_slow/comparison_files/drivenCavityTPNSE_PCD_expected.h5',
                    'proteus/tests/solver_tests_slow/comparison_files/drivenCavityTPNSE_PCD_expected.log']),
                  (os.path.join(proteus_install_path,'tests','solver_tests','comparison_files'),
                   ['proteus/tests/solver_tests/comparison_files/pressure_mass_matrix.txt',
                    'proteus/tests/solver_tests/comparison_files/velocity_mass_matrix.txt',
                    'proteus/tests/solver_tests/comparison_files/pressure_laplace_matrix.txt'])
       ],
