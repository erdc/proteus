...
EXTENSIONS_TO_BUILD = [Extension("MeshAdaptPUMI.MeshAdaptPUMI",
              ...
              Extension("mprans.BoundaryConditions",['proteus/mprans/BoundaryConditions.py'],
                        ...
                        extra_compile_args=PROTEUS_OPT,
                        include_dirs=[numpy.get_include(),'proteus']),
              Extension("mbd.pyChronoCore",
                        sources=['proteus/mbd/pyChronoCore.pyx',
              ...
              Extension("mbd.ChRigidBody",
                        ...
                        depends=['proteus/mbd/ChRigidBody.h',
                                 'proteus/mbd/ChMoorings.h'],
                        language='c++',
                        include_dirs=[numpy.get_include(),
                                      'proteus',
                                      PROTEUS_INCLUDE_DIR,
          ...
          data_files=[(proteus_install_path,
                      ...
                      (os.path.join(proteus_install_path,'tests','solver_tests','import_modules'),
                       ['proteus/tests/solver_tests/import_modules/quad_mass_matrix.npy',
                        ...
                        'proteus/tests/solver_tests/import_modules/tppcd_y_dirichlet_dof',
                        ...
                        'proteus/tests/solver_tests/import_modules/saddle_point_small',
                        'proteus/tests/solver_tests/import_modules/saddle_point_matrix',
                        'proteus/tests/solver_tests/import_modules/rans2p_step_newton_1',
                        'proteus/tests/solver_tests/import_modules/rans2p_step_newton_5']),
