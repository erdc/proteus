...
setup(name='proteus',
      ...
      data_files=[(proteus_install_path,
                  ...
                  (os.path.join(proteus_install_path,'tests','solver_tests'),
                   ['proteus/tests/solver_tests/import_modules/NSE_cavity_matrix',
                    'proteus/tests/solver_tests/import_modules/NSE_step_no_slip',
