...
##======================
def linearADR_ConstantCoefficientsEvaluate(const int nPoints,
                                            const int nSpace,
                                            const double M,
                                            np.ndarray A,
                                            np.ndarray B,
                                            ...
                                            np.ndarray r,
                                            np.ndarray dr):
    clinearADR_ConstantCoefficientsEvaluate(nPoints,
                                            nSpace,
                                            M,
                                            <double*> A.data,
                                            <double*> B.data,
                                            ...
                                            <double*> r.data,
                                            <double*> dr.data)
def groundwaterTransportCoefficientsEvaluate(const int nPoints,
                                              const int nSpace,
                                              const double omega,
                                              const double d,
                                              const double alpha_L,
                                              ...
                                              np.ndarray df,
                                              np.ndarray a):
    cgroundwaterTransportCoefficientsEvaluate(nPoints,
                                              nSpace,
                                              omega,
                                              d,
                                              alpha_L,
                                              ...
                                              <double*> df.data,
                                              <double*> a.data)
def groundwaterBiodegradation01EvaluateFC(const int nPoints,
                       const int nSpace,
                       const double omega,
                       const double d_c,
                       const double d_e,
                       ...
                       np.ndarray dr_x_de,
                       np.ndarray dr_x_dx):
    cgroundwaterBiodegradation01EvaluateFC(nPoints,
                       nSpace,
                       omega,
                       d_c,
                       d_e,
                       ...
                       <double*> dr_x_de.data,
                       <double*> dr_x_dx.data)
def groundwaterBryantDawsonIonExEvaluateFC(const int nPoints,
                        const int nSpace,
                        const double omega,
                        const double d_m,
                        const double d_h,
                        ...
                        np.ndarray dr_h_dm,
                        np.ndarray dr_h_dh):
    cgroundwaterBryantDawsonIonExEvaluateFC(nPoints,
                        nSpace,
                        omega,
                        d_m,
                        d_h,
                        ...
                        <double*> dr_h_dm.data,
                        <double*> dr_h_dh.data)
def groundwaterTransportCoefficientsEvaluate_hetMat(const int nSimplex,
                             const int nPointsPerSimplex,
                             const int nSpace,
                             const double d,
                             ...
                             np.ndarray df,
                             np.ndarray a):
    cgroundwaterTransportCoefficientsEvaluate_hetMat(nSimplex,
                             nPointsPerSimplex,
                             nSpace,
                             d,
                             ...
                             <double*> df.data,
                             <double*> a.data)
def variablySaturatedGroundwaterTransportCoefficientsEvaluate_hetMat(const int nSimplex,
                                      const int nPointsPerSimplex,
                                      const int nSpace,
                                      const double d,
                                      np.ndarray materialTypes,
    ...
    cvariablySaturatedGroundwaterTransportCoefficientsEvaluate_hetMat(nSimplex,
                                      ...
                                      <double*> df.data,
                                      <double*> a.data)
def variablySaturatedGroundwaterEnergyTransportCoefficientsEvaluate_hetMat(const int nSimplex,
                                        const int nPointsPerSimplex,
                                        const int nSpace,
                                        const double rho_w,
                                        const double rho_n,
    ...
    cvariablySaturatedGroundwaterEnergyTransportCoefficientsEvaluate_hetMat(nSimplex,
                                        ...
                                        <double*> df.data,
                                        <double*> a.data)
def nonlinearADR_pqrstEvaluate(const int nPoints,
                                const int nSpace,
                                const double M,
                                np.ndarray A,
                                np.ndarray B,
                                ...
                                np.ndarray r,
                                np.ndarray dr):
    cnonlinearADR_pqrstEvaluate(nPoints,
                                nSpace,
                                M,
                                <double*> A.data,
                                <double*> B.data,
...
def nonlinearADR_pqrstDualEvaluate(const int nPoints,
    ...
    cnonlinearADR_pqrstDualEvaluate(nPoints,
                                    ...
                                    <double*> r.data,
                                    <double*> dr.data)
def unitSquareRotationEvaluate(const int nPoints,
                                const int nSpace,
                                np.ndarray x,
                                np.ndarray u,
                                np.ndarray m,
                                ...
                                np.ndarray f,
                                np.ndarray df):
    cunitSquareRotationEvaluate(nPoints,
                                nSpace,
                                <double*> x.data,
                                <double*> u.data,
                                <double*> m.data,
                                ...
                                <double*> f.data,
                                <double*> df.data)
def unitCubeRotationEvaluate(const int nPoints,
                  const int nSpace,
                  np.ndarray x,
                  np.ndarray u,
                  np.ndarray m,
                  ...
                  np.ndarray f,
                  np.ndarray df):
    cunitCubeRotationEvaluate(nPoints,
                  nSpace,
                  <double*> x.data,
                  <double*> u.data,
                  <double*> m.data,
...
def disVelEvaluate(const int nPoints,
    ...
    cdisVelEvaluate(nPoints,
                    ...
                    <double*> phi.data,
                    <double*> dphi.data)
def burgersDiagonalVelEvaluate(const int nPoints,
                                const int nSpace,
                                const double self_a,
                np.ndarray self_v,
                                np.ndarray u,
                                ...
                                np.ndarray phi,
                                np.ndarray dphi):
    cburgersDiagonalVelEvaluate(nPoints,
                                nSpace,
                                self_a,
                <double*> self_v.data,
                                <double*> u.data,
                                ...
                                <double*> phi.data,
                                <double*> dphi.data)
def burgersDiagonalVelHJEvaluate(const int nPoints,
                  const int nSpace,
                  const double self_a,
                  np.ndarray self_v,
                  np.ndarray u,
                  ...
                  np.ndarray phi,
                  np.ndarray dphi):
    cburgersDiagonalVelHJEvaluate(nPoints,
                  nSpace,
                  self_a,
                  <double*> self_v.data,
                  <double*> u.data,
...
def twophaseLevelSetCoefficientsEvaluateCI(int nPoints,
    ...
    ctwophaseLevelSetCoefficientsEvaluateCI( nPoints,
                                            ...
                                            <double*> r.data,
                                            <double*> dr.data)
def ncLevelSetCoefficientsEvaluate(int nPoints,
                                    int nSpace,
                                    np.ndarray v,
                                    np.ndarray u,
                                    np.ndarray grad_u,
                                    ...
                                    np.ndarray H,
                                    np.ndarray dH):
    cncLevelSetCoefficientsEvaluate( nPoints,
                                     nSpace,
                                    <double*> v.data,
                                    <double*> u.data,
                                    <double*> grad_u.data,
                                    ...
                                    <double*> H.data,
                                    <double*> dH.data)
def cLevelSetCoefficientsEvaluate(int nPoints,
                                   int nSpace,
                                   np.ndarray v,
                                   np.ndarray u,
                                   np.ndarray m,
                                   ...
                                   np.ndarray f,
                                   np.ndarray df):
    ccLevelSetCoefficientsEvaluate( nPoints,
                                    nSpace,
                                   <double*> v.data,
                                   <double*> u.data,
                                   <double*> m.data,
                                   ...
                                   <double*> f.data,
                                   <double*> df.data)
def VOFCoefficientsEvaluate(int nPoints,
                             int nSpace,
                             double eps,
                             np.ndarray v,
                             np.ndarray phi,
                             ...
                             np.ndarray f,
                             np.ndarray df):
    cVOFCoefficientsEvaluate( nPoints,
                              nSpace,
                              eps,
                             <double*> v.data,
                             <double*> phi.data,
                             ...
                             <double*> f.data,
                             <double*> df.data)
def levelSetCurvatureCoefficientsEvaluate(int nPoints,
                                           int nSpace,
                                           np.ndarray grad_phi,
                                           np.ndarray u,
                                           np.ndarray f,
                                           np.ndarray r,
                                           np.ndarray dr):
    clevelSetCurvatureCoefficientsEvaluate( nPoints,
                                            nSpace,
...
def twophaseSignedDistanceCoefficientsEvaluate(int nPoints,
    ...
    ctwophaseSignedDistanceCoefficientsEvaluate( nPoints,
                                                ...
                                                <double*> dh.data,
                                                <double*> rh.data)
def eikonalEquationEvaluate(int nPoints,
                 int nSpace,
                 double rhs,
                 np.ndarray u,
                 np.ndarray grad_u,
                 ...
                 np.ndarray dH,
                 np.ndarray r):
    ceikonalEquationEvaluate( nPoints,
                  nSpace,
                  rhs,
                 <double*> u.data,
                 <double*> grad_u.data,
                 ...
                 <double*> dH.data,
                 <double*> r.data)
def redistanceLevelSetCoefficientsEvaluate(int nPoints,
                        int nSpace,
                        double eps,
                        np.ndarray u_levelSet,
                        np.ndarray u,
                        ...
                        np.ndarray dH,
                        np.ndarray r):
    credistanceLevelSetCoefficientsEvaluate( nPoints,
                         nSpace,
                         eps,
                        <double*> u_levelSet.data,
                        <double*> u.data,
                        ...
                        <double*> dH.data,
                        <double*> r.data)
def redistanceLevelSetCoefficientsWithWeakPenaltyEvaluate(int nPoints,
                               int nSpace,
                               double eps,
                               double Lambda_penalty,
                               np.ndarray u_levelSet,
                               ...
                               np.ndarray r,
                               np.ndarray dr):
    credistanceLevelSetCoefficientsWithWeakPenaltyEvaluate( nPoints,
                                nSpace,
                                eps,
                                Lambda_penalty,
                               <double*> u_levelSet.data,
                               ...
                               <double*> r.data,
                               <double*> dr.data)
def redistanceLevelSetSandFCoefficientsEvaluate(int nSimplex, 
                         int nPointsPerSimplex,
                         int nSpace,
                         double eps,
                         np.ndarray u_levelSet,
...
def setSimpleWeakDirichletConditionsForLevelSet(int nElements_global,
    ...
    csetSimpleWeakDirichletConditionsForLevelSet( nElements_global,
                                                 ...
                                                 <int*>  freeze_nodes_tmp.data,
                                                 <int*>  weakDirichletConditionFlags.data)
def darcySharpInterfaceFlowEvaluate(int nPoints,
                     int nSpace,
                     double Km, double rhoM,
                     double Kp, double rhoP,
                     double eps,
                     ...
                     np.ndarray  dr,
                     np.ndarray  dm):
    cdarcySharpInterfaceFlowEvaluate( nPoints,
                      nSpace,
                      Km,  rhoM,
                      Kp,  rhoP,
                      eps,
                     ...
                     <double*>  dr.data,
                     <double*>  dm.data)
def darcySharpInterfaceFlowImEvaluate(int nPoints,
                       int nSpace,
                       double Km, double rhoM,
                       double Kp, double rhoP,
                       double eps,
                       ...
                       np.ndarray  dr,
                       np.ndarray  dm):
    cdarcySharpInterfaceFlowImEvaluate( nPoints,
                        nSpace,
                        Km,  rhoM,
                        Kp,  rhoP,
                        eps,
                       ...
                       <double*>  dr.data,
                       <double*>  dm.data)
def NavierStokes_2D_Evaluate(const int nPoints,
                              const double rho,
                              const double nu,
                              np.ndarray g,
                              np.ndarray p,
    ...
    cNavierStokes_2D_Evaluate(nPoints,
                              rho,
                              nu,
                              <double*> g.data,
                              <double*> p.data,
...
def NavierStokes_3D_Evaluate(const int nPoints,
                              const double rho,
                              const double nu,
                              np.ndarray g,
                              np.ndarray p,
    ...
    cNavierStokes_3D_Evaluate(nPoints,
                              rho,
                              nu,
                              <double*> g.data,
                              <double*> p.data,
...
def Stokes_2D_Evaluate(const int nPoints,
                        const double rho,
                        const double nu,
                        np.ndarray g,
                        np.ndarray p,
    ...
    cStokes_2D_Evaluate(nPoints,
                        ...
                        <double*> mom_v_ham.data,
                        <double*> dmom_v_ham_grad_p.data)
def StokesP_2D_Evaluate(const int nPoints,
                         const double rho,
                         const double nu,
                         np.ndarray g,
                         np.ndarray p,
    ...
    cStokesP_2D_Evaluate(nPoints,
                         ...
                         <double*> mom_u_source.data,
                         <double*> mom_v_source.data)
def Stokes_3D_Evaluate(const int nPoints,
                        const double rho,
                        const double nu,
                        np.ndarray g,
                        np.ndarray p,
...
def StokesP_3D_Evaluate(const int nPoints,
    ...
    cStokesP_3D_Evaluate(nPoints,
             ...
             <double*> mom_w_diff_ten.data,
                         ...
                         <double*> mom_v_source.data,
             <double*> mom_w_source.data)
def TwophaseNavierStokes_LS_SO_2D_Evaluate(const int nPoints,
                                            const double eps,
                                            const double rho_0,
                                            const double nu_0,
                                            const double rho_1,
                                            ...
                                            np.ndarray mom_v_ham,
                                            np.ndarray dmom_v_ham_grad_p):
    cTwophaseNavierStokes_LS_SO_2D_Evaluate(nPoints,
                                            eps,
                                            rho_0,
                                            nu_0,
                                            rho_1,
                                            ...
                                            <double*> mom_v_ham.data,
                                            <double*> dmom_v_ham_grad_p.data)
def TwophaseNavierStokes_ST_LS_SO_2D_Evaluate(const int nPoints,
                                               const double eps_rho,
                                               const double eps_mu,
                                               const double sigma,
                                               const double rho_0,
                                               ...
                                               np.ndarray mom_v_ham,
                                               np.ndarray dmom_v_ham_grad_p):
    cTwophaseNavierStokes_ST_LS_SO_2D_Evaluate(nPoints,
                                               eps_rho,
                                               eps_mu,
                                               sigma,
                                               rho_0,
                                               ...
                                               <double*> mom_v_ham.data,
                                               <double*> dmom_v_ham_grad_p.data)
def TwophaseNavierStokes_ST_LS_SO_2D_Evaluate_sd(const int nPoints,
                                                  const double eps_rho,
                                                  const double eps_mu,
                                                  const double sigma,
                                                  const double rho_0,
                                                  ...
                                                  np.ndarray mom_v_ham,
                                                  np.ndarray dmom_v_ham_grad_p):
    cTwophaseNavierStokes_ST_LS_SO_2D_Evaluate_sd(nPoints,
                                                  eps_rho,
                                                  eps_mu,
                                                  sigma,
                                                  rho_0,
                                                  ...
                                                  <double*> mom_v_ham.data,
                                                  <double*> dmom_v_ham_grad_p.data)
def ThreephaseNavierStokes_ST_LS_SO_2D_Evaluate(const int nPoints,
                         const double boundaryPenaltyCoef,
                         const double volumePenaltyCoef,
                         const double eps_rho,
                         const double eps_mu,
                         ...
                         np.ndarray mom_v_ham,
                         np.ndarray dmom_v_ham_grad_p):
    cThreephaseNavierStokes_ST_LS_SO_2D_Evaluate(nPoints,
                         boundaryPenaltyCoef,
                         volumePenaltyCoef,
                         eps_rho,
                         eps_mu,
                         ...
                         <double*> mom_v_ham.data,
                         <double*> dmom_v_ham_grad_p.data)
def TwophaseNavierStokes_ST_LS_SO_3D_Evaluate(const int nPoints,
                                               const double eps_rho,
                                               const double eps_mu,
                                               const double sigma,
                                               const double rho_0,
                                               ...
                                               np.ndarray mom_w_ham,
                                               np.ndarray dmom_w_ham_grad_p):
    cTwophaseNavierStokes_ST_LS_SO_3D_Evaluate(nPoints,
                                               eps_rho,
                                               eps_mu,
                                               sigma,
                                               rho_0,
                                               ...
                                               <double*> mom_w_ham.data,
                                               <double*> dmom_w_ham_grad_p.data)
def TwophaseNavierStokes_ST_LS_SO_3D_Evaluate_sd(const int nPoints,
                                                  const double eps_rho,
                                                  const double eps_mu,
                                                  const double sigma,
                                                  const double rho_0,
                                                  ...
                                                  np.ndarray mom_w_ham,
                                                  np.ndarray dmom_w_ham_grad_p):
    cTwophaseNavierStokes_ST_LS_SO_3D_Evaluate_sd(nPoints,
                                                  eps_rho,
                                                  eps_mu,
                                                  sigma,
                                                  rho_0,
                                                  ...
                                                  <double*> mom_w_ham.data,
                                                  <double*> dmom_w_ham_grad_p.data)
def ThreephaseNavierStokes_ST_LS_SO_3D_Evaluate(const int nPoints,
                         const double boundaryPenaltyCoef,
                         const double volumePenaltyCoef,
                         const double eps_rho,
                         const double eps_mu,
                         ...
                         np.ndarray mom_w_ham,
                         np.ndarray dmom_w_ham_grad_p):
    cThreephaseNavierStokes_ST_LS_SO_3D_Evaluate(nPoints,
                         boundaryPenaltyCoef,
                         volumePenaltyCoef,
                         eps_rho,
                         eps_mu,
                         ...
                         <double*> mom_w_ham.data,
                         <double*> dmom_w_ham_grad_p.data)
def TwophaseNavierStokes_LS_SO_3D_Evaluate(const int nPoints,
                                            const double eps,
                                            const double rho_0,
                                            const double nu_0,
                                            const double rho_1,
                                            ...
                                            np.ndarray mom_w_ham,
                                            np.ndarray dmom_w_ham_grad_p):
    cTwophaseNavierStokes_LS_SO_3D_Evaluate(nPoints,
                                            eps,
                                            rho_0,
                                            nu_0,
                                            rho_1,
                                            ...
                                            <double*> mom_w_ham.data,
                                            <double*> dmom_w_ham_grad_p.data)
def TwophaseStokes_LS_SO_2D_Evaluate(const int nPoints,
                                      const double eps,
                                      const double rho_0,
                                      const double nu_0,
                                      const double rho_1,
                                      ...
                                      np.ndarray mom_v_ham,
                                      np.ndarray dmom_v_ham_grad_p):
    cTwophaseStokes_LS_SO_2D_Evaluate(nPoints,
                                      eps,
                                      rho_0,
                                      nu_0,
                                      rho_1,
                                      ...
                                      <double*> mom_v_ham.data,
                                      <double*> dmom_v_ham_grad_p.data)
def TwophaseStokes_LS_SO_3D_Evaluate(const int nPoints,
                                      const double eps,
                                      const double rho_0,
                                      const double nu_0,
                                      const double rho_1,
                                      ...
                                      np.ndarray mom_w_ham,
                                      np.ndarray dmom_w_ham_grad_p):
    cTwophaseStokes_LS_SO_3D_Evaluate(nPoints,
                                      eps,
                                      rho_0,
                                      nu_0,
                                      rho_1,
                                      ...
                                      <double*> mom_w_ham.data,
                                      <double*> dmom_w_ham_grad_p.data)
def TwophaseNavierStokes_VOF_SO_2D_Evaluate(const int nPoints,
                                             const double eps,
                                             const double rho_0,
                                             const double nu_0,
                                             const double rho_1,
                                             ...
                                             np.ndarray mom_v_ham,
                                             np.ndarray dmom_v_ham_grad_p):
    cTwophaseNavierStokes_VOF_SO_2D_Evaluate(nPoints,
                                             eps,
                                             rho_0,
                                             nu_0,
                                             rho_1,
                                             ...
                                             <double*> mom_v_ham.data,
                                             <double*> dmom_v_ham_grad_p.data)
def TwophaseNavierStokes_VOF_SO_3D_Evaluate(const int nPoints,
                                             const double eps,
                                             const double rho_0,
                                             const double nu_0,
                                             const double rho_1,
                                             ...
                                             np.ndarray mom_w_ham,
                                             np.ndarray dmom_w_ham_grad_p):
    cTwophaseNavierStokes_VOF_SO_3D_Evaluate(nPoints,
                                             eps,
                                             rho_0,
                                             nu_0,
                                             rho_1,
                                             ...
                                             <double*> mom_w_ham.data,
                                             <double*> dmom_w_ham_grad_p.data)
def TwophaseStokes_VOF_SO_2D_Evaluate(const int nPoints,
                                       const double eps,
                                       const double rho_0,
                                       const double nu_0,
                                       const double rho_1,
                                       ...
                                       np.ndarray mom_v_ham,
                                       np.ndarray dmom_v_ham_grad_p):
    cTwophaseStokes_VOF_SO_2D_Evaluate(nPoints,
                                       eps,
                                       rho_0,
                                       nu_0,
                                       rho_1,
                                       ...
                                       <double*> mom_v_ham.data,
                                       <double*> dmom_v_ham_grad_p.data)
def TwophaseStokes_VOF_SO_3D_Evaluate(const int nPoints,
                                       const double eps,
                                       const double rho_0,
                                       const double nu_0,
                                       const double rho_1,
                                       ...
                                       np.ndarray mom_w_ham,
                                       np.ndarray dmom_w_ham_grad_p):
    cTwophaseStokes_VOF_SO_3D_Evaluate(nPoints,
                                       eps,
                                       rho_0,
                                       nu_0,
                                       rho_1,
                                       ...
                                       <double*> mom_w_ham.data,
                                       <double*> dmom_w_ham_grad_p.data)
def unitSquareVortexEvaluate(const int nPoints,
                  const int nSpace,
                  double t,
                  np.ndarray x,
                  np.ndarray u,
                  ...
                  np.ndarray f,
                  np.ndarray df):
    cunitSquareVortexEvaluate(nPoints,
                  nSpace,
                   t,
                  <double*> x.data,
                  <double*> u.data,
                  ...
                  <double*> f.data,
                  <double*> df.data)
def constantVelocityLevelSetEvaluate(const int nPoints,
                      const int nSpace,
                      np.ndarray b,
                      np.ndarray x,
                      np.ndarray u,
                      ...
                      np.ndarray H,
                      np.ndarray dH):
    cconstantVelocityLevelSetEvaluate(nPoints,
                      nSpace,
                      <double*> b.data,
                      <double*> x.data,
                      <double*> u.data,
                      ...
                      <double*> H.data,
                      <double*> dH.data)
def constantNormalVelocityLevelSetEvaluate(const int nPoints,
                        const int nSpace,
                        double b,
                        np.ndarray x,
                        np.ndarray u,
                        ...
                        np.ndarray H,
                        np.ndarray dH):
    cconstantNormalVelocityLevelSetEvaluate(nPoints,
                        nSpace,
                         b,
                        <double*> x.data,
                        <double*> u.data,
                        ...
                        <double*> H.data,
                        <double*> dH.data)
def unitSquareVortexLevelSetEvaluate(const int nPoints,
                      const int nSpace,
                      double t,
                      np.ndarray x,
                      np.ndarray u,
                      ...
                      np.ndarray H,
                      np.ndarray dH):
    cunitSquareVortexLevelSetEvaluate(nPoints,
                      nSpace,
                       t,
                      <double*> x.data,
                      <double*> u.data,
                      ...
                      <double*> H.data,
                      <double*> dH.data)
def unitSquareRotationLevelSetEvaluate(const int nPoints,
                    const int nSpace,
                    double t,
                    np.ndarray x,
                    np.ndarray u,
                    ...
                    np.ndarray H,
                    np.ndarray dH):
    cunitSquareRotationLevelSetEvaluate(nPoints,
                    nSpace,
                     t,
                    <double*> x.data,
                    <double*> u.data,
                    ...
                    <double*> H.data,
                    <double*> dH.data)
def HJBurgersEvaluate(const int nPoints,
               const int nSpace,
               const double offset,
               np.ndarray u,
               np.ndarray gradu,
    ...
    cHJBurgersEvaluate(nPoints,
               ...
               <double*> H.data,
               <double*> dH.data)
def conservativeHeadRichardsMualemVanGenuchtenHomEvaluate(const int nPoints,
                                                           const int nSpace,
                                                           const double rho,
                                                           const double beta,
                                                           np.ndarray gravity,
                                                           ...
                                                           np.ndarray phi,
                                                           np.ndarray dphi):
    cconservativeHeadRichardsMualemVanGenuchtenHomEvaluate(nPoints,
                                                           nSpace,
                                                           rho,
                                                           beta,
                                                           <double*> gravity.data,
                                                           ...
                                                           <double*> phi.data,
                                                           <double*> dphi.data)
def conservativeHeadRichardsL2projMualemVanGenuchtenHomEvaluate(const int nSimplices,
                                 const int nPointsPerSimplex,
                                 const int nSpace,
                                 const double rho,
                                 np.ndarray gravity,
                                 ...
                                 np.ndarray a,
                                 np.ndarray da):
    cconservativeHeadRichardsL2projMualemVanGenuchtenHomEvaluate(nSimplices,
                                 nPointsPerSimplex,
                                 nSpace,
                                 rho,
                                 <double*> gravity.data,
                                 ...
                                 <double*> a.data,
                                 <double*> da.data)
def conservativeHeadRichardsL2projBndMualemVanGenuchtenHomEvaluate(const int nElements,
                                    const int nElementBoundaries_element,
                                    const int nPointsPerElementBoundary,
                                    const int nSpace,
                                    const double rho,
                                    ...
                                    np.ndarray a,
                                    np.ndarray da):
    cconservativeHeadRichardsL2projBndMualemVanGenuchtenHomEvaluate(nElements,
                                    ...
                                    <double*> a.data,
                                    <double*> da.data)
def conservativeHeadRichardsL2projMualemVanGenuchtenHetEvaluate(const int nSimplices,
                                 const int nPointsPerSimplex,
                                 const int nSpace,
                                 const double rho,
                                 np.ndarray gravity,
                                 ...
                                 np.ndarray a,
                                 np.ndarray da):
    cconservativeHeadRichardsL2projMualemVanGenuchtenHetEvaluate(nSimplices,
                                 nPointsPerSimplex,
                                 nSpace,
                                 rho,
                                 <double*> gravity.data,
                                 ...
                                 <double*> a.data,
                                 <double*> da.data)
def conservativeTotalHeadRichardsMualemVanGenuchtenHomEvaluate(const int nPoints,
                                const int nSpace,
                                const double rho,
                                np.ndarray gravity,
                                np.ndarray x,
                                ...
                                np.ndarray phi,
                                np.ndarray dphi):
    cconservativeTotalHeadRichardsMualemVanGenuchtenHomEvaluate(nPoints,
                                nSpace,
                                rho,
                                <double*> gravity.data,
                                <double*> x.data,
                                ...
                                <double*> phi.data,
                                <double*> dphi.data)
def conservativeHeadRichardsMualemVanGenuchten_sd_het(const int nSimplex,
                               const int nPointsPerSimplex,
                               const int nSpace,
                               double pc_eps,
                               np.ndarray  rowptr,
                               ...
                               np.ndarray da,
                               np.ndarray vol_frac):
    cconservativeHeadRichardsMualemVanGenuchten_sd_het(nSimplex,
                               nPointsPerSimplex,
                               nSpace,
                                pc_eps,
                               <int*>  rowptr.data,
...
def conservativeHeadRichardsMualemVanGenuchtenHetEvaluateV2(const int nSimplex,
                                 const int nPointsPerSimplex,
                                 const int nSpace,
                                 np.ndarray materialTypes,
                                 const double rho,
                                 ...
                                 np.ndarray a,
                                 np.ndarray da):
    cconservativeHeadRichardsMualemVanGenuchtenHetEvaluateV2(nSimplex,
                                 nPointsPerSimplex,
                                 nSpace,
                                 <int*> materialTypes.data,
                                 rho,
                                 ...
                                 <double*> a.data,
                                 <double*> da.data)
def seepageBrezis(const int nSimplex,
           const int nPointsPerSimplex,
           const int nSpace,
           np.ndarray materialTypes,
           const double epsFact,
    ...
    cseepageBrezis(nSimplex,
           ...
           <double*> a.data,
           <double*> da.data)
def conservativeHeadRichardsMualemVanGenuchtenHetEvaluate(const int nPoints,
                                                           const int nSpace,
                                                           const double rho,
                                                           np.ndarray gravity,
                                                           np.ndarray alpha,
                                                           ...
                                                           np.ndarray a,
                                                           np.ndarray da):
    cconservativeHeadRichardsMualemVanGenuchtenHetEvaluate(nPoints,
                                                           nSpace,
                                                           rho,
                                                           <double*> gravity.data,
                                                           <double*> alpha.data,
                                                           ...
                                                           <double*> a.data,
                                                           <double*> da.data)
def conservativeSatRichardsMualemVanGenuchtenHomEvaluate(const int nPoints,
                                                          const int nSpace,
                                                          const double rho,
                                                          np.ndarray gravity,
                                                          np.ndarray x,
                                                          ...
                                                          np.ndarray phi,
                                                          np.ndarray dphi):
    cconservativeSatRichardsMualemVanGenuchtenHomEvaluate(nPoints,
                                                          nSpace,
                                                          rho,
                                                          <double*> gravity.data,
                                                          <double*> x.data,
                                                          ...
                                                          <double*> phi.data,
                                                          <double*> dphi.data)
def conservativeHeadRichardsBrooksCoreyBurdineHetEvaluate(const int nPoints,
                                                           const int nSpace,
                                                           const double rho,
                                                           np.ndarray gravity,
                                                           np.ndarray Lambda,
                                                           ...
                                                           np.ndarray a,
                                                           np.ndarray da):
    cconservativeHeadRichardsBrooksCoreyBurdineHetEvaluate(nPoints,
                                                           nSpace,
                                                           rho,
                                                           <double*> gravity.data,
                                                           <double*> Lambda.data,
                                                           ...
                                                           <double*> a.data,
                                                           <double*> da.data)
def conservativeHeadRichardsBrooksCoreyBurdineHomEvaluate(const int nPoints,
                                                           const int nSpace,
                                                           const double rho,
                               const double beta,
                                                           np.ndarray gravity,
                                                           ...
                                                           np.ndarray a,
                                                           np.ndarray da):
    cconservativeHeadRichardsBrooksCoreyBurdineHomEvaluate(nPoints,
                                                           nSpace,
                                                           rho,
                               beta,
                                                           <double*> gravity.data,
...
def conservativeSatRichardsBrooksCoreyBurdineHomEvaluate(const int nPoints,
    ...
    cconservativeSatRichardsBrooksCoreyBurdineHomEvaluate(nPoints,
                              ...
                              <double*> phi.data,
                              <double*> dphi.data)
def conservativeHeadRichardsBCBfromMVGHomEvaluate(const int nPoints,
                           const int nSpace,
                           const double rho,
                           np.ndarray gravity,
                           const double alpha,
                           ...
                           np.ndarray a,
                           np.ndarray da):
    cconservativeHeadRichardsBCBfromMVGHomEvaluate(nPoints,
                           nSpace,
                           rho,
                           <double*> gravity.data,
                           alpha,
                           ...
                           <double*> a.data,
                           <double*> da.data)
def LinearElasticity_1D_Evaluate(const int nPoints,
                                  const double E,
                                  const double nu,
                                  np.ndarray g,
                                  np.ndarray u,
                                  ...
                                  np.ndarray u_force):
    cLinearElasticity_1D_Evaluate(nPoints,
                                  E,
                                  nu,
                                  <double*> g.data,
                                  <double*> u.data,
                                  ...
                                  <double*> u_force.data)
def LinearElasticity_2D_Evaluate(const int nPoints,
                                  const double E,
                                  const double nu,
                                  np.ndarray g,
                                  np.ndarray u,
                                  ...
                                  np.ndarray u_force,
                                  np.ndarray v_force):
    cLinearElasticity_2D_Evaluate(nPoints,
                                  E,
                                  nu,
                                  <double*> g.data,
                                  <double*> u.data,
                                  ...
                                  <double*> u_force.data,
                                  <double*> v_force.data)
def LinearElasticity_3D_Evaluate(const int nPoints,
                                  const double E,
                                  const double nu,
                                  np.ndarray g,
                                  np.ndarray u,
                                  ...
                                  np.ndarray v_force,
                                  np.ndarray w_force):
    cLinearElasticity_3D_Evaluate(nPoints,
                                  E,
                                  nu,
                                  <double*> g.data,
                                  <double*> u.data,
                                  ...
                                  <double*> v_force.data,
                                  <double*> w_force.data)
def MovingMesh_2D_Evaluate(const int nPoints,
                const double E0,
                const double nu,
                np.ndarray g,
                np.ndarray det_J,
                ...
                np.ndarray u_force,
                np.ndarray v_force):
    cMovingMesh_2D_Evaluate(nPoints,
                E0,
                nu,
                <double*> g.data,
                <double*> det_J.data,
                ...
                <double*> u_force.data,
                <double*> v_force.data)
def MovingMesh_3D_Evaluate(const int nPoints,
                const double E0,
                const double nu,
                np.ndarray g,
                np.ndarray det_J,
                ...
                np.ndarray v_force,
                np.ndarray w_force):
    cMovingMesh_3D_Evaluate(nPoints,
                E0,
                nu,
                <double*> g.data,
                <double*> det_J.data,
                ...
                <double*> v_force.data,
                <double*> w_force.data)
def MovingMesh_1D_Evaluate(const int nPoints,
                const double E0,
                const double nu,
                np.ndarray g,
                np.ndarray det_J,
                ...
                np.ndarray uu_diff_ten,
                np.ndarray u_force):
    cMovingMesh_1D_Evaluate(nPoints,
                E0,
                nu,
                <double*> g.data,
                <double*> det_J.data,
                ...
                <double*> uu_diff_ten.data,
                <double*> u_force.data)
def levelSetConservationCoefficientsEvaluate(int nPoints,
                                              int nSpace,
                                              double epsHeaviside,
                                              double epsDirac,
                                              double epsDiffusion,
                                              ...
                                              np.ndarray dr,
                                              np.ndarray a):
    clevelSetConservationCoefficientsEvaluate( nPoints,
                                               nSpace,
                                               epsHeaviside,
                                               epsDirac,
                                               epsDiffusion,
                                              ...
                                              <double*> dr.data,
                                              <double*> a.data)
def levelSetConservationCoefficientsEvaluate_sd(int nPoints,
                         double epsHeaviside,
                         double epsDirac,
                         np.ndarray u_ls,
                         np.ndarray H_vof,
                         ...
                         np.ndarray r,
                         np.ndarray dr):
    clevelSetConservationCoefficientsEvaluate_sd( nPoints,
                          epsHeaviside,
                          epsDirac,
                         <double*> u_ls.data,
                         <double*> H_vof.data,
                         ...
                         <double*> r.data,
                         <double*> dr.data)
def evaluateBuckleyLeverettLiuExample(int nPoints,
                       int nSpace,
                       np.ndarray  x,
                       np.ndarray  u,
                       np.ndarray  m,
                       ...
                       np.ndarray  df,
                       np.ndarray  a):
    cevaluateBuckleyLeverettLiuExample( nPoints,
                        nSpace,
                       <double*>  x.data,
                       <double*>  u.data,
                       <double*>  m.data,
                       ...
                       <double*>  df.data,
                       <double*>  a.data)
def VolumeAveragedNavierStokesFullDevStress_2D_Evaluate(const int nPoints,
                             const double rho,
                             const double mu,
                             ...
                             np.ndarray mom_v_ham,
                             np.ndarray dmom_v_ham_grad_p):
    cVolumeAveragedNavierStokesFullDevStress_2D_Evaluate(nPoints,
                             rho,
                             mu,
                             ...
                             <double*> mom_v_ham.data,
                             <double*> dmom_v_ham_grad_p.data)
def VolumeAveragedNavierStokesFullDevStress_3D_Evaluate(const int nPoints,
                             const double rho,
                             const double mu,
                             np.ndarray meanGrainSize,
                             np.ndarray g,
                             ...
                             np.ndarray mom_w_ham,
                             np.ndarray dmom_w_ham_grad_p):
    cVolumeAveragedNavierStokesFullDevStress_3D_Evaluate(nPoints,
                             rho,
                             mu,
                             <double*> meanGrainSize.data,
                             <double*> g.data,
                             ...
                             <double*> mom_w_ham.data,
                             <double*> dmom_w_ham_grad_p.data)
def VolumeAveragedTwophaseNavierStokes_ST_LS_SO_2D_Evaluate(const int nPoints,
                                 const int killNonlinearDrag,
                                 const double eps_rho,
                                 const double eps_mu,
                                 const double sigma,
                                 ...
                                 np.ndarray mom_v_ham,
                                 np.ndarray dmom_v_ham_grad_p):
    cVolumeAveragedTwophaseNavierStokes_ST_LS_SO_2D_Evaluate(nPoints,
                                 killNonlinearDrag,
                                 eps_rho,
                                 eps_mu,
                                 sigma,
                                 ...
                                 <double*> mom_v_ham.data,
                                 <double*> dmom_v_ham_grad_p.data)
def VolumeAveragedTwophaseNavierStokes_ST_LS_SO_2D_Evaluate_sd(const int nPoints,
                                const int killNonlinearDrag,
                                const double eps_rho,
                                const double eps_mu,
                                const double sigma,
                                ...
                                np.ndarray mom_v_ham,
                                np.ndarray dmom_v_ham_grad_p):
    cVolumeAveragedTwophaseNavierStokes_ST_LS_SO_2D_Evaluate_sd(nPoints,
                                killNonlinearDrag,
                                eps_rho,
                                eps_mu,
                                sigma,
                                ...
                                <double*> mom_v_ham.data,
                                <double*> dmom_v_ham_grad_p.data)
def VolumeAveragedTwophaseNavierStokes_ST_LS_SO_3D_Evaluate(const int nPoints,
                                 const int killNonlinearDrag,
                                 const double eps_rho,
                                 const double eps_mu,
                                 const double sigma,
                                 ...
                                 np.ndarray mom_w_ham,
                                 np.ndarray dmom_w_ham_grad_p):
    cVolumeAveragedTwophaseNavierStokes_ST_LS_SO_3D_Evaluate(nPoints,
                                 killNonlinearDrag,
                                 eps_rho,
                                 eps_mu,
                                 sigma,
                                 ...
                                 <double*> mom_w_ham.data,
                                 <double*> dmom_w_ham_grad_p.data)
def VolumeAveragedTwophaseNavierStokes_ST_LS_SO_3D_Evaluate_sd(const int nPoints,
                                 const int killNonlinearDrag,
                                 const double eps_rho,
                                 const double eps_mu,
                                 const double sigma,
                                 ...
                                 np.ndarray mom_w_ham,
                                 np.ndarray dmom_w_ham_grad_p):
    cVolumeAveragedTwophaseNavierStokes_ST_LS_SO_3D_Evaluate_sd(nPoints,
                                 killNonlinearDrag,
                                 eps_rho,
                                 eps_mu,
                                 sigma,
                                 ...
                                 <double*> mom_w_ham.data,
                                 <double*> dmom_w_ham_grad_p.data)
def VolumeAveragedVOFCoefficientsEvaluate(int nPoints,
                       int nSpace,
                       double eps,
                       np.ndarray v,
                       np.ndarray phi,
                       ...
                       np.ndarray f,
                       np.ndarray df):
    cVolumeAveragedVOFCoefficientsEvaluate( nPoints,
                        nSpace,
                        eps,
                       <double*> v.data,
                       <double*> phi.data,
                       ...
                       <double*> f.data,
                       <double*> df.data)
def kEpsilon_2D_Evaluate(int nPoints,
              int nSpace,
              double sigma_k,
              double sigma_e,
              double c_1,
    ...
    ckEpsilon_2D_Evaluate( nPoints,
              ...
              <double*> dr_e_dk.data,
              <double*> dr_e_de.data)
def kEpsilon_2D_Evaluate_sd(int nPoints,
                 int nSpace,
                 double sigma_k,
                 double sigma_e,
                 double c_1,
                 ...
                 np.ndarray dr_e_dk,
                 np.ndarray dr_e_de):
    ckEpsilon_2D_Evaluate_sd( nPoints,
                  nSpace,
                  sigma_k,
                  sigma_e,
                  c_1,
                 ...
                 <double*> dr_e_dk.data,
                 <double*> dr_e_de.data)
def kEpsilon_3D_Evaluate_sd(int nPoints,
                 int nSpace,
                 double sigma_k,
                 double sigma_e,
                 double c_1,
                 ...
                 np.ndarray dr_e_dk,
                 np.ndarray dr_e_de):
    ckEpsilon_3D_Evaluate_sd( nPoints,
                  nSpace,
                  sigma_k,
                  sigma_e,
                  c_1,
                 ...
                 <double*> dr_e_dk.data,
                 <double*> dr_e_de.data)
def kEpsilon_3D_Evaluate(int nPoints,
                 int nSpace,
                 double sigma_k,
                 double sigma_e,
                 double c_1,
    ...
    ckEpsilon_3D_Evaluate( nPoints,
                 ...
                 <double*> dr_e_dk.data,
                 <double*> dr_e_de.data)
def kEpsilon_k_2D_Evaluate_sd(int nPoints,
                   int nSpace,
                   double sigma_k,
                   double c_mu,
                   double nu,
                   ...
                   np.ndarray r_k,
                   np.ndarray dr_k_dk):
    ckEpsilon_k_2D_Evaluate_sd( nPoints,
                    nSpace,
                    sigma_k,
                    c_mu,
                    nu,
                   ...
                   <double*> r_k.data,
                   <double*> dr_k_dk.data)
def kEpsilon_epsilon_2D_Evaluate_sd(int nPoints,
                     int nSpace,
                     double sigma_e,
                     double c_1,
                     double c_2,
                     ...
                     np.ndarray r_e,
                     np.ndarray dr_e_de):
    ckEpsilon_epsilon_2D_Evaluate_sd( nPoints,
                      nSpace,
                      sigma_e,
                      c_1,
                      c_2,
                     ...
                     <double*> r_e.data,
                     <double*> dr_e_de.data)
def kEpsilon_k_3D_Evaluate_sd(int nPoints,
                   int nSpace,
                   double sigma_k,
                   double c_mu,
                   double nu,
                   ...
                   np.ndarray r_k,
                   np.ndarray dr_k_dk):
    ckEpsilon_k_3D_Evaluate_sd( nPoints,
                    nSpace,
                    sigma_k,
                    c_mu,
                    nu,
                   ...
                   <double*> r_k.data,
                   <double*> dr_k_dk.data)
def kEpsilon_epsilon_3D_Evaluate_sd(int nPoints,
                     int nSpace,
                     double sigma_e,
                     double c_1,
                     double c_2,
                     ...
                     np.ndarray r_e,
                     np.ndarray dr_e_de):
    ckEpsilon_epsilon_3D_Evaluate_sd( nPoints,
                      nSpace,
                      sigma_e,
                      c_1,
                      c_2,
                     ...
                     <double*> r_e.data,
                     <double*> dr_e_de.data)
def ReynoldsAveragedNavierStokes_kEpsilon_2D_Update(const int nPoints,
                             const double nu,
                             const double c_mu,
                             np.ndarray k,
                             np.ndarray grad_k,
                             ...
                             np.ndarray mom_u_source,
                             np.ndarray mom_v_source):
    cReynoldsAveragedNavierStokes_kEpsilon_2D_Update(nPoints,
                             nu,
                             c_mu,
                             <double*> k.data,
                             <double*> grad_k.data,
                             ...
                             <double*> mom_u_source.data,
                             <double*> mom_v_source.data)
def ReynoldsAveragedNavierStokes_kEpsilon_2D_Update_sd(const int nPoints,
                            const double rho,
                            const double nu,
                            const double c_mu,
                            np.ndarray k,
                            ...
                            np.ndarray mom_u_source,
                            np.ndarray mom_v_source):
    cReynoldsAveragedNavierStokes_kEpsilon_2D_Update_sd(nPoints,
                            rho,
                            nu,
                            c_mu,
                            <double*> k.data,
                            ...
                            <double*> mom_u_source.data,
                            <double*> mom_v_source.data)
def ReynoldsAveragedNavierStokes_kEpsilon_3D_Update(const int nPoints,
                             const double nu,
                             const double c_mu,
                             np.ndarray k,
                             np.ndarray grad_k,
                             ...
                             np.ndarray mom_v_source,
                             np.ndarray mom_w_source):
    cReynoldsAveragedNavierStokes_kEpsilon_3D_Update(nPoints,
                             nu,
                             c_mu,
                             <double*> k.data,
                             <double*> grad_k.data,
                             ...
                             <double*> mom_v_source.data,
                             <double*> mom_w_source.data)
def ReynoldsAveragedNavierStokes_kEpsilon_3D_Update_sd(const int nPoints,
                            const double nu,
                            const double c_mu,
                            np.ndarray k,
                            np.ndarray grad_k,
                            ...
                            np.ndarray mom_v_source,
                            np.ndarray mom_w_source):
    cReynoldsAveragedNavierStokes_kEpsilon_3D_Update_sd(nPoints,
                            nu,
                            c_mu,
                            <double*> k.data,
                            <double*> grad_k.data,
                            ...
                            <double*> mom_v_source.data,
                            <double*> mom_w_source.data)
def scriptedSphereMotionSignedDistance(const int nPoints,
                    const double t,
                    const int nSpace,
                    const int nSpheres,
                    np.ndarray  radii,
                    ...
                    np.ndarray  phi,
                    np.ndarray  n):
    cscriptedSphereMotionSignedDistance(nPoints,
                    t,
                    nSpace,
                    nSpheres,
                    <double*>  radii.data,
                    ...
                    <double*>  phi.data,
                    <double*>  n.data)
def shallowWater_1D_Evaluate(const int nPoints,
                            const double h_eps,
                            const double g,
                            const double bedFrictionCoefficient,
                            const double bedFrictionPower,
                            ...
                            np.ndarray mom_diff):
    cshallowWater_1D_Evaluate(nPoints,
                            h_eps,
                            g,
...
def shallowWater_2D_Evaluate(const int nPoints,
                            const double h_eps,
                            const double g,
                            const double bedFrictionCoefficient,
                            const double bedFrictionPower,
    ...
    cshallowWater_2D_Evaluate(nPoints,
                            h_eps,
                            g,
                            bedFrictionCoefficient,
                            bedFrictionPower,
...
def conservativeHeadRichardsMualemVanGenuchtenHetEvaluateV2withUpwindAndHarm_sd(const int upwindFlag,
    ...
    cconservativeHeadRichardsMualemVanGenuchtenHetEvaluateV2withUpwindAndHarm_sd(upwindFlag,
                                         ...
                                         <double*> a.data,
                                         <double*> da.data)
def applyContactLineSlip(int nExteriorElementBoundaries_global,
                          int nQuadraturePoints_elementBoundary,
                          double eps,
    ...
    capplyContactLineSlip( nExteriorElementBoundaries_global,
                           nQuadraturePoints_elementBoundary,
                           eps,
...
def applyContactLineSlipJacobian(int nExteriorElementBoundaries_global,
                                  int nQuadraturePoints_elementBoundary,
                                  int nDOF_trial_element,
                                  double eps,
                                  np.ndarray isDOFBoundary,
    ...
    capplyContactLineSlipJacobian( nExteriorElementBoundaries_global,
                                   nQuadraturePoints_elementBoundary,
                                   nDOF_trial_element,
                                   eps,
                                  <int*> isDOFBoundary.data,
...
def calculateEddyViscosity_Smagorinsky_2D(const int nElements_global,
                       const int nQuadraturePoints_element,
                       const double smagorinskyConstant,
                       np.ndarray  h_e,
                       np.ndarray  grad_u,
                       np.ndarray  grad_v,
                       np.ndarray  nu_t):
    ccalculateEddyViscosity_Smagorinsky_2D(nElements_global,
                       ...
                       <double*>  grad_v.data,
                       <double*>  nu_t.data)
def calculateEddyViscosity_Smagorinsky_3D(const int nElements_global,
                       const int nQuadraturePoints_element,
                       const double smagorinskyConstant,
                       np.ndarray  h_e,
                       np.ndarray  grad_u,
                       ...
                       np.ndarray  grad_w,
                       np.ndarray  nu_t):
    ccalculateEddyViscosity_Smagorinsky_3D(nElements_global,
                       nQuadraturePoints_element,
                       smagorinskyConstant,
                       <double*>  h_e.data,
                       <double*>  grad_u.data,
                       ...
                       <double*>  grad_w.data,
                       <double*>  nu_t.data)
def calculateEddyViscosity_Smagorinsky2P_2D(const int nElements_global,
                         const int nQuadraturePoints_element,
                         const double smagorinskyConstant_0,
                         const double smagorinskyConstant_1,
                         const double  eps,
                         ...
                         np.ndarray  grad_v,
                         np.ndarray  nu_t):
    ccalculateEddyViscosity_Smagorinsky2P_2D(nElements_global,
                         nQuadraturePoints_element,
                         ...
                         <double*>  grad_v.data,
                         <double*>  nu_t.data)
def calculateEddyViscosity_Smagorinsky2P_3D(const int nElements_global,
                         const int nQuadraturePoints_element,
                         const double smagorinskyConstant_0,
                         const double smagorinskyConstant_1,
                         const double eps,
                         ...
                         np.ndarray  grad_w,
                         np.ndarray  nu_t):
    ccalculateEddyViscosity_Smagorinsky2P_3D(nElements_global,
                         nQuadraturePoints_element,
                         smagorinskyConstant_0,
                         smagorinskyConstant_1,
                         eps,
                         ...
                         <double*>  grad_w.data,
                         <double*>  nu_t.data)
def eddyViscosity_2D_Update(const int nPoints,
                 np.ndarray nu_t,
                 np.ndarray mom_u_diff_ten,
                 np.ndarray mom_v_diff_ten,
                 np.ndarray mom_uv_diff_ten,
                 np.ndarray mom_vu_diff_ten):
    ceddyViscosity_2D_Update(nPoints,
                 <double*> nu_t.data,
                 <double*> mom_u_diff_ten.data,
                 <double*> mom_v_diff_ten.data,
                 <double*> mom_uv_diff_ten.data,
                 <double*> mom_vu_diff_ten.data)
def eddyViscosity_2D_Update_sd(const int nPoints,
                np.ndarray nu_t,
                np.ndarray mom_u_diff_ten,
                np.ndarray mom_v_diff_ten,
                np.ndarray mom_uv_diff_ten,
                np.ndarray mom_vu_diff_ten):
    ceddyViscosity_2D_Update_sd(nPoints,
                <double*> nu_t.data,
                <double*> mom_u_diff_ten.data,
                <double*> mom_v_diff_ten.data,
                <double*> mom_uv_diff_ten.data,
                <double*> mom_vu_diff_ten.data)
def eddyViscosity_3D_Update(const int nPoints,
                 np.ndarray nu_t,
                 np.ndarray mom_u_diff_ten,
                 np.ndarray mom_v_diff_ten,
                 np.ndarray mom_w_diff_ten,
                 ...
                 np.ndarray mom_wu_diff_ten,
                 np.ndarray mom_wv_diff_ten):
    ceddyViscosity_3D_Update(nPoints,
                 <double*> nu_t.data,
                 <double*> mom_u_diff_ten.data,
                 <double*> mom_v_diff_ten.data,
                 <double*> mom_w_diff_ten.data,
                 ...
                 <double*> mom_wu_diff_ten.data,
                 <double*> mom_wv_diff_ten.data)
def eddyViscosity_3D_Update_sd(const int nPoints,
                np.ndarray nu_t,
                np.ndarray mom_u_diff_ten,
                np.ndarray mom_v_diff_ten,
                np.ndarray mom_w_diff_ten,
                ...
                np.ndarray mom_wu_diff_ten,
                np.ndarray mom_wv_diff_ten):
    ceddyViscosity_3D_Update_sd(nPoints,
                <double*> nu_t.data,
                <double*> mom_u_diff_ten.data,
                <double*> mom_v_diff_ten.data,
                <double*> mom_w_diff_ten.data,
                ...
                <double*> mom_wu_diff_ten.data,
                <double*> mom_wv_diff_ten.data)
def calculateWaveFunction3d_ref(int nElements_global,
                 int nDOF_element_mesh,
                 int nQuadraturePoints_element,
                 np.ndarray mesh_trial_ref,
                 np.ndarray mesh_dof,
                 np.ndarray mesh_l2g,
                 ...
                 double waterDepth,
                 np.ndarray source):
    ccalculateWaveFunction3d_ref(nElements_global,
                  nDOF_element_mesh,
                  nQuadraturePoints_element,
                 ...
                 <double*> omega_s_z.data,
                  ...
                  waterDepth,
                 <double*> source.data)
def Mass_2D_Evaluate(const int nPoints,
              double rho,
              np.ndarray p,
              np.ndarray u,
              np.ndarray v,
    ...
    cMass_2D_Evaluate(nPoints,
              ...
              <double*> dmom_u_acc_u.data,
              <double*> dmom_v_acc_v.data)
def Mass_3D_Evaluate(const int nPoints,
              double rho,
              np.ndarray p,
              np.ndarray u,
              np.ndarray v,
    ...
    cMass_3D_Evaluate(nPoints,
              ...
              <double*> dmom_v_acc_v.data,
              <double*> dmom_w_acc_w.data)
def TwoPhaseAdvection_2D_Evaluate(const int nPoints,
                                  const double eps,
                                  const double rho_0,
                                  const double nu_0,
                                  const double rho_1,
                                  ...
                                  np.ndarray dmom_v_adv_u,
                                  np.ndarray dmom_v_adv_v):
    cTwoPhaseAdvection_2D_Evaluate(nPoints,
                                  eps,
                                  rho_0,
                                  nu_0,
                                  rho_1,
...
def conservativeHeadRichardsJLeverettEvaluate(np.ndarray materialTypes,
                                       ...
                                       np.ndarray a,
                                       np.ndarray da):
    cconservativeHeadRichardsJLeverett(f.shape[0],
                                       f.shape[1],
                                       f.shape[-1],
                                       <int*> materialTypes.data,
                                       rho,
...
def conservativeHeadRichardsJLeverettAniEvaluate(np.ndarray materialTypes,
                                       ...
                                       np.ndarray a,
                                       np.ndarray da):
    cconservativeHeadRichardsJLeverettAni(f.shape[0],
                                        f.shape[1],
                                        f.shape[-1],
                                       <int*> materialTypes.data,
                                       rho,
