...
namespace proteus
{
    ...
    class Richards : public Richards_base
    {
        ...
        xt::pyarray<int>& isSeepageFace = args.m_iarray["isSeepageFace"];
        xt::pyarray<int>& a_rowptr = args.m_iarray["a_rowptr"];
        xt::pyarray<int>& a_colind = args.m_iarray["a_colind"];
        double rho = args.m_dscalar["rho"];
        double beta = args.m_dscalar["beta"];
        xt::pyarray<double>& gravity = args.m_darray["gravity"];
        xt::pyarray<double>& alpha = args.m_darray["alpha"];
        xt::pyarray<double>& n = args.m_darray["n"];
        xt::pyarray<double>& thetaR = args.m_darray["thetaR"];
        xt::pyarray<double>& thetaSR = args.m_darray["thetaSR"];
        xt::pyarray<double>& KWs = args.m_darray["KWs"];
        ...
        xt::pyarray<double>& ebqe_bc_flux_ext = args.m_darray["ebqe_bc_flux_ext"];
