        ...
        void calculateResidual(double* mesh_trial_ref,
			       ...
			       double useMetrics, 
		               ...
		               double sc_uref, double sc_alpha,
                               ...
                               double* ebqe_u,
                               double* ebqe_flux)
        void calculateResidual_edge_based(double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
                               double* mesh_velocity_dof,
                               double MOVING_DOMAIN,
...
cdef class cRichards_base:
   ...
   def calculateResidual_edge_based(self,
                         numpy.ndarray mesh_trial_ref,
                         numpy.ndarray mesh_grad_trial_ref,
                         numpy.ndarray mesh_dof,
                         numpy.ndarray mesh_velocity_dof,
			 ...
			 double sc_uref, double sc_alpha,
                         ...
                         numpy.ndarray ebqe_u,
                         numpy.ndarray ebqe_flux):
       self.thisptr.calculateResidual_edge_based(<double*> mesh_trial_ref.data,
                                                 <double*> mesh_grad_trial_ref.data,
                                                 <double*> mesh_dof.data,
                                                 <double*> mesh_velocity_dof.data,
                                                 MOVING_DOMAIN,
