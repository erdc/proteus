...
cdef extern from "MeshAdaptPUMI/MeshAdaptPUMI.h":
    cdef cppclass MeshAdaptPUMIDrvr:
        ...
        int transferPropertiesToPUMI(double*, double*,double*,double,double,double)
...
cdef class MeshAdaptPUMI:
    ...
    def transferPropertiesToPUMI(self, np.ndarray[np.double_t,ndim=1,mode="c"] rho, np.ndarray[np.double_t,ndim=1,mode="c"] nu, np.ndarray[np.double_t,ndim=1,mode="c"] g, double deltaT, double T_simulation,double interfaceBandSize):
        ...
        return self.thisptr.transferPropertiesToPUMI(<double*> rho.data,<double*>nu.data,<double*>g.data,deltaT,T_simulation,interfaceBandSize)
