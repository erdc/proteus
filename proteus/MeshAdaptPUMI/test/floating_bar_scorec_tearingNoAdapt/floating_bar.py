...
opts=Context.Options([
    ...
    ("cfl",0.33,"Target cfl"),
    ("nsave",50,"Number of time steps to  save"),
...
domain.PUMIMesh = MeshAdaptPUMI.MeshAdaptPUMI(hmax=0.1,hmin=0.04,
                                              numIter=adaptMesh_numIter,sfConfig="alvin",maType="isotropic")
comm = Comm.init()

domain.PUMIMesh.loadModelAndMesh("Floating_Bar_Falling.smd","evil.smb")
