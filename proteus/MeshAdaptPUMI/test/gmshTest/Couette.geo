...
Point(2) = {0.0, 0.0, 0.05,mSize};
Point(3) = {0.1, 0.0, 0.05,mSize};
Point(4) = {0.1, 0.0, 0,mSize};

Point(5) = {0.0, 0.2, 0,mSize};
Point(6) = {0.0, 0.2, 0.05,mSize};
Point(7) = {0.1, 0.2, 0.05,mSize};
Point(8) = {0.1, 0.2, 0,mSize};
