...
if useHex:
    ...
    if structured:
        ...
        domain = Domain.PUMIDomain(fileprefix="Dambreak_2_.smb",modelfile="Dambreak.smd") #initialize the domain
        ...
        domain.PUMIMesh.loadModelAndMesh("Dambreak.smd", "Dambreak_2_.smb")
