...
def multilevelNonlinearSolverChooser(nonlinearOperatorList,
    ...
    elif (levelNonlinearSolverType == LaggedNewton):
        levelNonlinearSolverType = LaggedNewton        
