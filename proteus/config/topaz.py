...
PROTEUS_PRELOAD_LIBS=['/p/home/apps/sgi/mpt-2.15_sgi715r20/lib/libmpi.so',
'/p/home/apps/sgi/mpt-2.15_sgi715r20/lib/libmpi_lustre.so']
...
PROTEUS_EXTRA_LINK_ARGS=['-L'+pjoin(prefix,'lib'),'-lpthread','-lm','-lgfortran'] + platform_extra_link_args
PROTEUS_EXTRA_FC_LINK_ARGS=['-L'+pjoin(prefix,'lib'),'-lpthread','-lm','-lgfortran'] + platform_extra_link_args
