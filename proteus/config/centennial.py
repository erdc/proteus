...
PROTEUS_PRELOAD_LIBS=['/opt/hpe/hpc/mpt/mpt-2.18/lib/libmpi.so','/opt/hpe/hpc/mpt/mpt-2.18/lib/libmpi_lustre.so']
...
#PROTEUS_SUPERLU_LIB_DIRS = [PROTEUS_SUPERLU_LIB_DIR]
#PROTEUS_SUPERLU_LIBS = ['superlu']
#PROTEUS_SUPERLU_INCLUDE_DIRS = [PROTEUS_SUPERLU_INCLUDE_DIR]
