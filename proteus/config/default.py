...
PROTEUS_SCOREC_INCLUDE_DIRS = [PROTEUS_SCOREC_INCLUDE_DIR, PROTEUS_PETSC_INCLUDE_DIR, PROTEUS_ZOLTAN_INCLUDE_DIR, PROTEUS_PARMETIS_INCLUDE_DIR, PROTEUS_MPI_INCLUDE_DIR]
PROTEUS_SCOREC_LIB_DIRS =     [PROTEUS_SCOREC_LIB_DIR,     PROTEUS_PETSC_LIB_DIR,     PROTEUS_ZOLTAN_LIB_DIR, PROTEUS_PARMETIS_LIB_DIR,     PROTEUS_MPI_LIB_DIR]
PROTEUS_SCOREC_LIBS = [
    'spr',
    'ma',
    'parma',
...
PROTEUS_CGAL_INCLUDE_DIR, PROTEUS_CGAL_LIB_DIR = get_flags('CGAL')
PROTEUS_CGAL_LIBS =['CGAL','CGAL_Core','gmp','mpfr','boost_log','boost_thread']
