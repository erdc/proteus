...
# PARAMETERS FOR ELEMENT EV in NS
NS_ENTROPY_VISCOSITY = 1
NS_cE = 5.0
NS_cMax = 5.0
# PARAMETERS FOR VOF
VOF_EDGE_VISCOSITY=1
VOF_ENTROPY_VISCOSITY=1
VOF_FCT=1
cK=0.25
VOF_forceStrongConditions=0
# FOR ELEMENT BASED EV in VOF
cE=1.0
cMax=1.0
# PARAMETERS FOR NCLS
NCLS_EDGE_VISCOSITY=1
NCLS_ENTROPY_VISCOSITY=1
NCLS_FCT=1
...
if vspaceOrder == 1:
    hFactor = 1.0
    if useHex:
        vbasis = C0_AffineLinearOnCubeWithNodalBasis
        elementQuadrature = CubeGaussQuadrature(nd, 2)
        elementBoundaryQuadrature = CubeGaussQuadrature(nd - 1, 2)
    else:
        vbasis = C0_AffineLinearOnSimplexWithNodalBasis
        elementQuadrature = SimplexGaussQuadrature(nd, 3)
        elementBoundaryQuadrature = SimplexGaussQuadrature(nd - 1, 3)
elif vspaceOrder == 2:
    hFactor = 0.5
    if useHex:
        vbasis = C0_AffineLagrangeOnCubeWithNodalBasis
