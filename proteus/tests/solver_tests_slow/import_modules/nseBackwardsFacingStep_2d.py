...
#                 TH - Taylor Hood
#                 C0P1C0P1 - stabilized continuous linears velocity and pressure
# parallel - this must be a boolean value

##########################################################

opts = Context.Options([
    ("nLevels", 2, "number of levels of uniform refinement"),
    ("name", "backwardsFacingStepTrial", "output data file name"),
    ...
    ("RE_through_bdy",False,"Flag: is the reynolds number enforced through boundary condition?")
    ])
