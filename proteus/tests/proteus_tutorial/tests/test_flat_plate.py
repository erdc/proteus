...
def test_run_flat_plate_serial():
    ...
    currentPath = "../2d"
    runCommand = "cd "+currentPath+"; parun --TwoPhaseFlow flat_plate.py -l 5 -C \"final_time=0.2\" -D ../tests/serial"
...
def test_run_flat_plate_parallel():
    """Test restart workflow"""
    currentPath = "../2d"
    runCommand = "cd "+currentPath+"; mpiexec -np 2 parun --TwoPhaseFlow flat_plate.py -l 5 -C \"final_time=0.2\" -D ../tests/parallel"
    subprocess.check_call(runCommand,shell=True)
