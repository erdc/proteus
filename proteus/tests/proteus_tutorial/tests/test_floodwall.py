...
def test_run_floodwall_serial():
    ...
    currentPath = "../2d"
    runCommand = "cd "+currentPath+"; parun --TwoPhaseFlow floodwall.py -l 5 -C \"final_time=0.2\" -D ../tests/serial"
...
def test_run_floodwall_parallel():
    """Test restart workflow"""
    currentPath = "../2d"
    runCommand = "cd "+currentPath+"; mpiexec -np 2 parun --TwoPhaseFlow floodwall.py -l 5 -C \"final_time=0.2\" -D ../tests/parallel"
    subprocess.check_call(runCommand,shell=True)
