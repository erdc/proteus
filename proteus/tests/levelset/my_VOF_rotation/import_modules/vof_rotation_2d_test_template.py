"""
Basic setup for VOF tests following Alistair's template
"""
#selling out
...
n.shockCapturing = VOF.ShockCapturing(p.coefficients,p.nd,shockCapturingFactor=rot2D.shockCapturingFactor_vof,
                                      lag=rot2D.lag_shockCapturing_vof)

if rot2D.parallel or p.LevelModelType == VOF.LevelModel:
