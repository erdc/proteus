"""
Basic setup for NCLS3P tests following Alistair's template
"""
#selling out
...
p.T = rot2D.T
p.LevelModelType = NCLS3P.LevelModel
...
p.coefficients = rot2D.MyCoefficients(epsFact=rot2D.epsFactHeaviside,checkMass=rot2D.checkMass,useMetrics=rot2D.useMetrics,ME_model=0,
                                      ...
                                      POWER_SMOOTHNESS_INDICATOR=rot2D.POWER_SMOOTHNESS_INDICATOR,
                                      FCT=rot2D.FCT)
...
n.timeIntegration = NCLS3P.RKEV
n.stepController = StepControl.Min_dt_RKcontroller
if rot2D.timeIntegration_ncls == "SSP33":
    n.timeOrder = 3
    n.nStagesTime = 3
else:
    n.timeOrder = 1
...
n.shockCapturing = NCLS3P.ShockCapturing(p.coefficients,p.nd,shockCapturingFactor=rot2D.shockCapturingFactor_ncls,
                                       lag=rot2D.lag_shockCapturing_ncls)

if rot2D.parallel or p.LevelModelType == NCLS3P.LevelModel:
    #n.numericalFluxType = NumericalFlux.Advection_DiagonalUpwind_IIPG_exterior
    n.numericalFluxType = NCLS3P.NumericalFlux
...
n.nl_atol_res = 100*rot2D.atolLevelSet
n.l_atol_res = rot2D.atolLevelSet
