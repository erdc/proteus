#!/usr/bin/env python
"""
Test module for NCLS3P rotation with EV
"""
...
class TestNCLS3ProtationEV():
    ...
    def test_ncls_T1_SSP33_ElementBasedEV(self):
        ...
        # READ REFERENCE 
        ref_total_mass = np.loadtxt(os.path.join(run_dir,'comparison_files','total_mass_comp_0_T1m1_rotation_c0p1_SSP33_EdgeBasedEV_level_3_ncls3p.txt'))
