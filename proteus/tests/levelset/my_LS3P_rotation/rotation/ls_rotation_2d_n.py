...
timeIntegration = NCLS3P.RKEV # SSP33 #mwf right now need timeIntegration to be SSP33 to run
...
shockCapturing = NCLS3P.ShockCapturing(coefficients,nd,shockCapturingFactor=shockCapturingFactor_ncls,lag=lag_shockCapturing_ncls)
