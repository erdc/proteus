...
n.shockCapturing = NCLS3P.ShockCapturing(p.coefficients,p.nd,shockCapturingFactor=vort2D.shockCapturingFactor_ncls,
                                       lag=vort2D.lag_shockCapturing_ncls)

if vort2D.parallel or p.LevelModelType == NCLS3P.LevelModel:
