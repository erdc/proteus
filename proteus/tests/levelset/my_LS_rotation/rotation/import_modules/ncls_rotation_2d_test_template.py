...
n.shockCapturing = NCLS.ShockCapturing(p.coefficients,p.nd,shockCapturingFactor=rot2D.shockCapturingFactor_ncls,
                                       lag=rot2D.lag_shockCapturing_ncls)

if rot2D.parallel or p.LevelModelType == NCLS.LevelModel:
    #n.numericalFluxType = NumericalFlux.Advection_DiagonalUpwind_IIPG_exterior
    n.numericalFluxType = NCLS.NumericalFlux
