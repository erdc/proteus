#!/usr/bin/env python
"""
Test module for NCLS vortex with EV
"""
...
class TestNCLSvortexEV():
    ...
    def test_ncls_T1_SSP33_ElementBasedEV(self):
        ...
        ref_total_mass = np.loadtxt(os.path.join(run_dir,'comparison_files','total_mass_comp_0_T1_vortex_c0p1_SSP33_EdgeBasedEV_level_3_ncls.txt'))
