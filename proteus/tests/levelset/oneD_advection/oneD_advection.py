...
if useHex:
    hex=True
    soname="oneD_advection_c0q"+`pDegree_vof`+"_"+timeIntegration_vof+"_level_"+`lRefinement`
else:
    soname="oneD_advection_c0p"+`pDegree_vof`+"_"+timeIntegration_vof+"_level_"+`lRefinement`
