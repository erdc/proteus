...
def parametricMaps_getValuesTrace(np.ndarray psi,
    ...
    cparametricMaps_getValuesTrace(nElements_global,
                                   ...
                                   <double*>nodeArray.data,
                                   <double*>xArray.data)
def parametricMaps_getInverseValues(int nElements_global,
                                    int nQuadraturePoints_element,
                                    int nDOF_element,
                                    int nSpace_global,
...
def updateMassJacobian_weak(int nElements_global,
                            int nQuadraturePoints_element,
                            int nDOF_trial_element,
                            int nDOF_test_element,
                            np.ndarray dmt,
...
def updateMassJacobian_weak_lowmem(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_trial_element,
                                   int nDOF_test_element,
                                   np.ndarray dmt,
    ...
    cupdateMassJacobian_weak_lowmem(nElements_global,
                                    ...
                                    <double*> w_dV.data,
                                    <double*> jacobian_weak_residual.data)
def updateMass_strong(int nElements_global,
                      int nQuadraturePoints_element,
                      np.ndarray mt,
                      np.ndarray strong_residual):
    cupdateMass_strong(nElements_global,
                       ...
                       <double*>mt.data,
                       <double*>strong_residual.data)
def updateMassJacobian_strong(int nElements_global,
                              int nQuadraturePoints_element,
                              int nDOF_trial_element,
                              np.ndarray dmt,
                              np.ndarray v,
    ...
    cupdateMassJacobian_strong(nElements_global,
                               ...
                               <double*>v.data,
                               <double*>dstrong_residual.data)
def updateMass_adjoint(int nElements_global,
                       int nQuadraturePoints_element,
                       int nDOF_test_element,
                       np.ndarray dmt,
                       np.ndarray w_dV,
    ...
    cupdateMass_adjoint(nElements_global,
                        ...
                        <double*>w_dV.data,
                        <double*>Lstar_w_dV.data)
def updateAdvection_weak(int nElements_global,
                         int nQuadraturePoints_element,
                         int nDOF_test_element,
                         int nSpace,
                         np.ndarray f,
    ...
    cupdateAdvection_weak(nElements_global,
                          ...
                          <double*>weak_residual.data)
def updateAdvectionJacobian_weak(int nElements_global,
                                 int nQuadraturePoints_element,
                                 int nDOF_trial_element,
                                 int nDOF_test_element,
                                 int nSpace,
    ...
    cupdateAdvectionJacobian_weak(nElements_global,
                                  ...
                                  <double*>jacobian_weak_residual.data)
def updateAdvectionJacobian_weak_lowmem(int nElements_global,
                                        int nQuadraturePoints_element,
                                        int nDOF_trial_element,
                                        int nDOF_test_element,
                                        int nSpace,
    ...
    cupdateAdvectionJacobian_weak_lowmem(nElements_global,
                                         ...
                                         <double*> grad_w_dV.data,
                                         <double*> jacobian_weak_residual.data)
def updateAdvection_strong(int nElements_global,
                           int nQuadraturePoints_element,
                           int nSpace,
                           np.ndarray df,
                           np.ndarray grad_u,
    ...
    cupdateAdvection_strong(nElements_global,
                            ...
                            <double*>grad_u.data,
                            <double*>strong_residual.data)
def updateAdvectionJacobian_strong(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_trial_element,
                                   int nSpace,
                                   np.ndarray df,
    ...
    cupdateAdvectionJacobian_strong(nElements_global,
                                    ...
                                    <double*>grad_v.data,
                                    <double*>dstrong_residual.data)
def updateAdvection_adjoint(int nElements_global,
                            int nQuadraturePoints_element,
                            int nDOF_test_element,
                            int nSpace,
                            np.ndarray df,
    ...
    cupdateAdvection_adjoint(nElements_global,
                             ...
                             <double*>grad_w_dV.data,
                             <double*>Lstar_w_dV.data)
def updateHamiltonian_weak(int nElements_global,
                           int nQuadraturePoints_element,
                           int nDOF_test_element,
                           np.ndarray H,
                           np.ndarray w_dV,
    ...
    cupdateHamiltonian_weak(nElements_global,
                            ...
                            <double*>w_dV.data,
                            <double*>weak_residual.data)
def updateHamiltonianJacobian_weak(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_trial_element,
                                   int nDOF_test_element,
                                   int nSpace,
    ...
    cupdateHamiltonianJacobian_weak(nElements_global,
                                    ...
                                    <double*>jacobian_weak_residual.data)
def updateHamiltonianJacobian_weak_lowmem(int nElements_global,
                                          int nQuadraturePoints_element,
                                          int nDOF_trial_element,
                                          int nDOF_test_element,
                                          int nSpace,
    ...
    cupdateHamiltonianJacobian_weak_lowmem(nElements_global,
                                           ...
                                           <double*> w_dV.data,
                                           <double*> jacobian_weak_residual.data)
def updateHamiltonian_strong(int nElements_global,
                             int nQuadraturePoints_element,
                             int nSpace,
                             np.ndarray dH,
                             np.ndarray grad_u,
    ...
    cupdateHamiltonian_strong(nElements_global,
                              ...
                              <double*>grad_u.data,
                              <double*>strong_residual.data)
def updateHamiltonianJacobian_strong(int nElements_global,
                                     int nQuadraturePoints_element,
                                     int nDOF_trial_element,
                                     int nSpace,
                                     np.ndarray dH,
    ...
    cupdateHamiltonianJacobian_strong(nElements_global,
                                      ...
                                      <double*>grad_v.data,
                                      <double*>dstrong_residual.data)
def updateHamiltonian_adjoint(int nElements_global,
                              int nQuadraturePoints_element,
                              int nDOF_test_element,
                              int nSpace,
                              np.ndarray dH,
    ...
    cupdateHamiltonian_adjoint(nElements_global,
                               ...
                               <double*>grad_w_dV.data,
                               <double*>Lstar_w_dV.data)
def updateDiffusion_weak(int nElements_global,
                         int nQuadraturePoints_element,
                         int nDOF_test_element,
                         int nSpace,
                         np.ndarray a,
    ...
    cupdateDiffusion_weak(nElements_global,
                          ...
                          <double*>weak_residual.data)
def updateDiffusion_weak_lowmem(int nElements_global,
                                int nQuadraturePoints_element,
                                int nDOF_test_element,
                                int nSpace,
                                np.ndarray a,
    ...
    cupdateDiffusion_weak_lowmem(nElements_global,
                                 ...
                                 <double*> grad_w_dV.data,
                                 <double*> weak_residual.data)
def updateDiffusionJacobian_weak(int nElements_global,
                                 int nQuadraturePoints_element,
                                 int nDOF_trial_element,
                                 int nDOF_test_element,
                                 int nSpace,
    ...
    cupdateDiffusionJacobian_weak(nElements_global,
                                  ...
                                  <double*>jacobian_weak_residual.data)
def updateDiffusionJacobian_weak_lowmem(int nElements_global,
                                        int nQuadraturePoints_element,
                                        int nDOF_trial_element,
                                        int nDOF_test_element,
                                        int nSpace,
    ...
    cupdateDiffusionJacobian_weak_lowmem(nElements_global,
                                         ...
                                         <double*> grad_v.data,
                                         <double*> jacobian_weak_residual.data)
def updateDiffusion_strong(int nElements_global,
                           int nQuadraturePoints_element,
                           int nSpace,
                           np.ndarray da,
                           np.ndarray grad_phi,
    ...
    cupdateDiffusion_strong(nElements_global,
                            ...
                            <double*>grad_u.data,
                            <double*>strong_residual.data)
def updateDiffusionJacobian_strong(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_trial_element,
                                   int nSpace,
                                   np.ndarray l2g,
    ...
    cupdateDiffusionJacobian_strong(nElements_global,
                                    ...
                                    <double*>grad_v.data,
                                    <double*>dstrong_residual.data)
def updateDiffusion_adjoint(int nElements_global,
                            int nQuadraturePoints_element,
                            int nDOF_test_element,
                            int nSpace,
                            np.ndarray da,
    ...
    cupdateDiffusion_adjoint(nElements_global,
                             ...
                             <double*>grad_w_dV.data,
                             <double*>Lstar_w_dV.data)
def updateReaction_weak(int nElements_global,
                        int nQuadraturePoints_element,
                        int nDOF_test_element,
                        np.ndarray r,
                        np.ndarray w_dV,
    ...
    cupdateReaction_weak(nElements_global,
                         ...
                         <double*>w_dV.data,
                         <double*>weak_residual.data)
def updateReactionJacobian_weak(int nElements_global,
                                int nQuadraturePoints_element,
                                int nDOF_trial_element,
                                int nDOF_test_element,
                                np.ndarray dr,
    ...
    cupdateReactionJacobian_weak(nElements_global,
                                 ...
                                 <double*>v_X_w_dV.data,
                                 <double*>jacobian_weak_residual.data)
def updateReactionJacobian_weak_lowmem(int nElements_global,
                                       int nQuadraturePoints_element,
                                       int nDOF_trial_element,
                                       int nDOF_test_element,
                                       np.ndarray dr,
    ...
    cupdateReactionJacobian_weak_lowmem(nElements_global,
                                        ...
                                        <double*> w_dV.data,
                                        <double*> jacobian_weak_residual.data)
def updateReaction_strong(int nElements_global,
                          int nQuadraturePoints_element,
                          np.ndarray r,
                          np.ndarray strong_residual):
    cupdateReaction_strong(nElements_global,
                           ...
                           <double*>r.data,
                           <double*>strong_residual.data)
def updateReactionJacobian_strong(int nElements_global,
                                  int nQuadraturePoints_element,
                                  int nDOF_trial_element,
                                  np.ndarray dr,
                                  np.ndarray v,
    ...
    cupdateReactionJacobian_strong(nElements_global,
                                   ...
                                   <double*>v.data,
                                   <double*>dstrong_residual.data)
def updateReaction_adjoint(int nElements_global,
                           int nQuadraturePoints_element,
                           int nDOF_test_element,
                           np.ndarray dr,
                           np.ndarray w_dV,
    ...
    cupdateReaction_adjoint(nElements_global,
                            ...
                            <double*>w_dV.data,
                            <double*>Lstar_w_dV.data)
def updateSubgridError(int nElements_global,
                       int nQuadraturePoints_element,
                       int nDOF_test_element,
                       np.ndarray error,
                       np.ndarray Lstar_w_dV,
    ...
    cupdateSubgridError(nElements_global,
                        ...
                        <double*>Lstar_w_dV.data,
                        <double*>weak_residual.data)
def updateSubgridErrorJacobian(int nElements_global,
                               int nQuadraturePoints_element,
                               int nDOF_trial_element,
                               int nDOF_test_element,
                               np.ndarray derror,
    ...
    cupdateSubgridErrorJacobian(nElements_global,
                                ...
                                <double*>Lstar_w_dV.data,
                                <double*>jacobian_weak_residual.data)
def updateNumericalDiffusion(int nElements_global,
                             int nQuadraturePoints_element,
                             int nDOF_test_element,
                             int nSpace,
                             np.ndarray numDiff,
    ...
    cupdateNumericalDiffusion(nElements_global,
                              ...
                              <double*>weak_residual.data)
def updateNumericalDiffusion_lowmem(int nElements_global,
                                    int nQuadraturePoints_element,
                                    int nDOF_test_element,
                                    int nSpace,
                                    np.ndarray numDiff,
    ...
    cupdateNumericalDiffusion_lowmem(nElements_global,
                                     ...
                                     <double*> grad_w_dV.data,
                                     <double*> weak_residual.data)
def updateNumericalDiffusionJacobian(int nElements_global,
                                     int nQuadraturePoints_element,
                                     int nDOF_trial_element,
                                     int nDOF_test_element,
                                     int nSpace,
    ...
    cupdateNumericalDiffusionJacobian(nElements_global,
                                      ...
                                      <double*>grad_v_X_grad_w_dV.data,
                                      <double*>jacobian_weak_residual.data)
def updateNumericalDiffusionJacobian_lowmem(int nElements_global,
                                            int nQuadraturePoints_element,
                                            int nDOF_trial_element,
                                            int nDOF_test_element,
                                            int nSpace,
    ...
    cupdateNumericalDiffusionJacobian_lowmem(nElements_global,
                                             ...
                                             <double*> grad_w_dV.data,
                                             <double*> jacobian_weak_residual.data)
def calculateScalarScalarProduct(int nElements_global,
                                 int nQuadraturePoints_element,
                                 np.ndarray s1,
                                 np.ndarray s2,
                                 np.ndarray sResult):
    ccalculateScalarScalarProduct(nElements_global,
                                  ...
                                  <double*>s2.data,
                                  <double*>sResult.data)
def calculateVectorScalarProduct(int nElements_global,
                                 int nQuadraturePoints_element,
                                 int nSpace,
                                 np.ndarray v,
                                 np.ndarray s,
    ...
    ccalculateVectorScalarProduct(nElements_global,
                                  ...
                                  <double*>s.data,
                                  <double*>vResult.data)
def calculateTensorScalarProduct(int nElements_global,
                                 int nQuadraturePoints_element,
                                 int nSpace,
                                 np.ndarray t,
                                 np.ndarray s,
    ...
    ccalculateTensorScalarProduct(nElements_global,
                                  ...
                                  <double*>s.data,
                                  <double*>tResult.data)
def updateInteriorElementBoundaryFlux(int nInteriorElementBoundaries_global,
                                      int nElementBoundaries_element,
                                      int nQuadraturePoints_elementBoundary,
                                      int nDOF_test_element,
                                      np.ndarray interiorElementBoundaries, 
...
def updateExteriorElementBoundaryFlux(int nExteriorElementBoundaries_global,
    ...
    cupdateExteriorElementBoundaryFlux(nExteriorElementBoundaries_global,
                                       ...
                                       <double*>w_dS.data,
                                       <double*>residual.data)
def updateGlobalResidualFromElementResidual(int nElements_global,
                                            int nDOF_test_element,
                                            int offset_r,
                                            int stride_r,
                                            np.ndarray nFreeDOF_element_r,
...
def updateGlobalJacobianFromElementJacobian_dense(int nElements_global,
                                                  int nDOF_test_element,
                                                  int nDOF_trial_element,
                                                  int offset_r,
                                                  int stride_r,
...
def updateGlobalJacobianFromElementJacobian_eb_dense(np.ndarray elementNeighbors,
    ...
    cupdateGlobalJacobianFromElementJacobian_eb_dense(<int *>elementNeighbors.data,
                                                      ...
                                                      <double*>globalJacobian.data)
def updateGlobalJacobianFromInteriorElementBoundaryFluxJacobian_dense(int nInteriorElementBoundaries_global,
                                                                      int nElementBoundaries_element,
                                                                      int nQuadraturePoints_elementBoundary,
                                                                      int nDOF_test_element,
                                                                      int nDOF_trial_element,
...
def updateGlobalJacobianFromInteriorElementBoundaryFluxJacobian_eb_dense(np.ndarray elementNeighbors,
    ...
    cupdateGlobalJacobianFromInteriorElementBoundaryFluxJacobian_eb_dense(<int *>elementNeighbors.data,
                                                                          ...
                                                                          <double*>w_dS.data,
                                                                          <double*>jac.data)
def updateGlobalJacobianFromExteriorElementBoundaryFluxJacobian_dense(int nExteriorElementBoundaries_global,
                                                                      int nElementBoundaries_element,
                                                                      int nQuadraturePoints_elementBoundary,
                                                                      int nDOF_test_element,
                                                                      int nDOF_trial_element,
...
def updateGlobalJacobianFromExteriorElementBoundaryFluxJacobian_eb_dense(np.ndarray elementNeighbors,
    ...
    cupdateGlobalJacobianFromExteriorElementBoundaryFluxJacobian_eb_dense(<int *>elementNeighbors.data,
                                                                          ...
                                                                          <double*>w_dS.data,
                                                                          <double*>jac.data)
def updateGlobalJacobianFromElementJacobian_CSR(int nElements_global,
                                                int nDOF_test_element,
                                                int nDOF_trial_element,
                                                np.ndarray nFreeDOF_element_r,
                                                np.ndarray freeLocal_r,
...
def updateGlobalJacobianFromElementJacobian_eb_CSR(np.ndarray elementNeighbors,
    ...
    cupdateGlobalJacobianFromElementJacobian_eb_CSR(<int *>elementNeighbors.data,
                                                    ...
                                                    <double*>elementJacobian_eb.data,
                                                    <double*>globalJacobian.data)
def updateGlobalJacobianFromInteriorElementBoundaryFluxJacobian_CSR(int nInteriorElementBoundaries_global,
                                                                    int nElementBoundaries_element,
                                                                    int nQuadraturePoints_elementBoundary,
                                                                    int nDOF_test_element,
                                                                    int nDOF_trial_element,
    ...
    cupdateGlobalJacobianFromInteriorElementBoundaryFluxJacobian_CSR(nInteriorElementBoundaries_global,
                                                                     ...
                                                                     <double*>w_dS.data,
                                                                     <double*>jac.data)
def updateGlobalJacobianFromExteriorElementBoundaryFluxJacobian_CSR(int nExteriorElementBoundaries_global,
                                                                    int nElementBoundaries_element,
                                                                    int nQuadraturePoints_elementBoundary,
                                                                    int nDOF_test_element,
                                                                    int nDOF_trial_element,
...
def calculateWeightedShapeGradients(np.ndarray dVR,
    ...
    ccalculateWeightedShapeGradients(nElements_global,
                                     ...
                                     <double*>grad_w.data,
                                     <double*>grad_w_dV.data)
def calculateShape_X_weightedShape(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_trial_element,
                                   int nDOF_test_element,
                                   np.ndarray v,
    ...
    ccalculateShape_X_weightedShape(nElements_global,
                                    ...
                                    <double*>w_dV.data,
                                    <double*>v_X_w_dV.data)
def calculateShape_X_weightedGradShape(int nElements_global,
                                       int nQuadraturePoints_element,
                                       int nDOF_trial_element,
                                       int nDOF_test_element,
                                       int nSpace,
    ...
    ccalculateShape_X_weightedGradShape(nElements_global,
                                        ...
                                        <double*>grad_w_dV.data,
                                        <double*>v_X_grad_w_dV.data)
def calculateGradShape_X_weightedShape(int nElements_global,
                                       int nQuadraturePoints_element,
                                       int nDOF_trial_element,
                                       int nDOF_test_element,
                                       int nSpace,
    ...
    ccalculateGradShape_X_weightedShape(nElements_global,
                                        ...
                                        <double*>w_dV.data,
                                        <double*>grad_v_X_w_dV.data)
def calculateGradShape_X_weightedGradShape(int nElements_global,
                                           int nQuadraturePoints_element,
                                           int nDOF_trial_element,
                                           int nDOF_test_element,
                                           int nSpace,
...
def calculateWeightedShapeTrace(np.ndarray dSR,
    ...
    ccalculateWeightedShapeTrace(nElements_global,
                                 ...
                                 <double*>w.data,
                                 <double*>w_dS.data)
def calculateShape_X_weightedShapeTrace(int nElements_global,
                                        int nElementBoundaries_element,
                                        int nElementBoundaryQuadraturePoints_elementBoundary,
                                        int nDOF_trial_element,
                                        int nDOF_test_element,
...
def calculateGradShape_X_weightedShapeTrace(int nElements_global,
                                            int nElementBoundaries_element,
                                            int nElementBoundaryQuadraturePoints_elementBoundary,
                                            int nDOF_trial_element,
                                            int nDOF_test_element,
...
def calculateElementBoundaryIntegrationWeights(np.ndarray sqrt_det_g,
    ...
    ccalculateElementBoundaryIntegrationWeights(nElements_global,
                                                ...
                                                <double*>referenceWeights.data,
                                                <double*>weights.data)
def calculateFiniteElementFunctionValues(int nElements_global,
                                         int nQuadraturePoints_element,
                                         int nDOF_trial_element,
                                         int nComponents,
                                         np.ndarray l2g,
    ...
    ccalculateFiniteElementFunctionValues(nElements_global,
                                          ...
                                          <double*>v.data,
                                          <double*>u.data)
def calculateFiniteElementFunctionGradientValues(int nElements_global,
                                                 int nQuadraturePoints_element,
                                                 int nDOF_trial_element,
                                                 int nComponents,
                                                 int nSpace,
    ...
    ccalculateFiniteElementFunctionGradientValues(nElements_global,
                                                  ...
                                                  <double*>grad_v.data,
                                                  <double*>grad_u.data)
def calculateFiniteElementFunctionGradientTensorValues(int nElements_global,
                                                       int nQuadraturePoints_element,
                                                       int nDOF_trial_element,
                                                       int nDOF_test_element,
                                                       int nComponents,
    ...
    ccalculateFiniteElementFunctionGradientTensorValues(nElements_global,
                                                        ...
                                                        <double*>grad_v_X_grad_w_dV.data,
                                                        <double*>grad_u_X_grad_w_dV.data)
def calculateFiniteElementFunctionValuesTrace(int nElements_global,
                                              int nElementBoundaries_element,
                                              int nQuadraturePoints_elementBoundary,
                                              int nDOF_trial_element,
                                              int nComponents,
    ...
    ccalculateFiniteElementFunctionValuesTrace(nElements_global,
                                               ...
                                               <double*>v.data,
                                               <double*>u.data)
def calculateFiniteElementFunctionGradientValuesTrace(int nElements_global,
                                                      int nElementBoundaries_element,
                                                      int nQuadraturePoints_elementBoundary,
                                                      int nDOF_trial_element,
                                                      int nComponents,
    ...
    ccalculateFiniteElementFunctionGradientValuesTrace(nElements_global,
                                                       ...
                                                       <double*>grad_v.data,
                                                       <double*>grad_u.data)
def calculateFlowVelocity(int nElements_global,
                          int nQuadraturePoints_element,
                          int nSpace,
                          np.ndarray f,
                          np.ndarray a,
...
def calculateDimensionlessNumbersADR(int nElements_global,
    ...
    ccalculateDimensionlessNumbersADR(nElements_global,
                                      ...
                                      <double*>pe.data,
                                      <double*>cfl.data)
def calculateCFLADR(int nElements_global,
                    int nQuadraturePoints_element,
                    int nSpace,
                    np.ndarray elementDiameter,
                    np.ndarray dm,
    ...
    ccalculateCFLADR(nElements_global,
                     ...
                     <double*>df.data,
                     <double*>cfl.data)
def updateInteriorElementBoundaryDiffusiveVelocity(int nInteriorElementBoundaries_global,
                                                   int nElementBoundaries_element,
                                                   int nQuadraturePoints_elementBoundary,
                                                   int nSpace,
                                                   np.ndarray interiorElementBoundaries,
...
def updateExteriorElementBoundaryDiffusiveVelocity(int nExteriorElementBoundaries_global,
                                                   int nElementBoundaries_element,
                                                   int nQuadraturePoints_elementBoundary,
                                                   int nSpace,
                                                   np.ndarray exteriorElementBoundaries,
    ...
    cupdateExteriorElementBoundaryDiffusiveVelocity(nExteriorElementBoundaries_global,
                                                    ...
                                                    <double*>grad_phi.data,
                                                    <double*>velocity.data)
def updateInteriorElementBoundaryAdvectiveVelocity(int nInteriorElementBoundaries_global,
                                                   int nElementBoundaries_element,
                                                   int nQuadraturePoints_elementBoundary,
                                                   int nSpace,
                                                   np.ndarray interiorElementBoundaries,
    ...
    cupdateInteriorElementBoundaryAdvectiveVelocity(nInteriorElementBoundaries_global,
                                                    ...
                                                    <double*>f.data,
                                                    <double*>velocity.data)
def updateExteriorElementBoundaryAdvectiveVelocity(int nExteriorElementBoundaries_global,
                                                   int nElementBoundaries_element,
                                                   int nQuadraturePoints_elementBoundary,
                                                   int nSpace,
                                                   np.ndarray exteriorElementBoundaries,
    ...
    cupdateExteriorElementBoundaryAdvectiveVelocity(nExteriorElementBoundaries_global,
                                                    ...
                                                    <double*>f.data,
                                                    <double*>velocity.data)
def updateInteriorElementBoundaryShockCapturingVelocity(int nInteriorElementBoundaries_global,
                                                        int nElementBoundaries_element,
                                                        int nQuadraturePoints_elementBoundary,
                                                        int nQuadraturePoints_element,
                                                        int nSpace,
    ...
    cupdateInteriorElementBoundaryShockCapturingVelocity(nInteriorElementBoundaries_global,
                                                         ...
                                                         <double*>grad_u.data,
                                                         <double*>velocity.data)
def updateExteriorElementBoundaryShockCapturingVelocity(int nExteriorElementBoundaries_global,
                                                        int nElementBoundaries_element,
                                                        int nQuadraturePoints_elementBoundary,
                                                        int nQuadraturePoints_element,
                                                        int nSpace,
                                                        ...
                                                        np.ndarray grad_u,
                                                        np.ndarray velocity):
    cupdateExteriorElementBoundaryShockCapturingVelocity(nExteriorElementBoundaries_global,
                                                         nElementBoundaries_element,
                                                         nQuadraturePoints_elementBoundary,
                                                         nQuadraturePoints_element,
                                                         nSpace,
                                                         ...
                                                         <double*>grad_u.data,
                                                         <double*>velocity.data)
def calculateInteriorElementBoundaryAverageVelocity(int nInteriorElementBoundaries_global,
                                                    int nElementBoundaries_element,
                                                    int nQuadraturePoints_elementBoundary,
                                                    int nSpace,
                                                    np.ndarray interiorElementBoundaries,
    ...
    ccalculateInteriorElementBoundaryAverageVelocity(nInteriorElementBoundaries_global,
                                                     ...
                                                     <double*>v.data,
                                                     <double*>vAverage.data)
def calculateExteriorElementBoundaryAverageVelocity(int nExteriorElementBoundaries_global,
                                                    int nElementBoundaries_element,
                                                    int nQuadraturePoints_elementBoundary,
                                                    int nSpace,
                                                    np.ndarray exteriorElementBoundaries,
    ...
    ccalculateExteriorElementBoundaryAverageVelocity(nExteriorElementBoundaries_global,
                                                     ...
                                                     <double*>v.data,
                                                     <double*>vAverage.data)
def calculateConservationResidualDG(int nElements_global,
                                    int nDOF_test_element,
                                    np.ndarray elementResidual,
                                    np.ndarray conservationResidual):
    ccalculateConservationResidualDG(nElements_global,
                                     ...
                                     <double*>elementResidual.data,
                                     <double*>conservationResidual.data)
def calculateConservationResidual(int nElements_global,
                                  int nDOF_test_element,
                                  int nElementBoundaries_element,
                                  int nQuadraturePoints_elementBoundary,
                                  int nSpace,
...
def calculateConservationResidualGlobalBoundaries(int nElements_global,
    ...
    ccalculateConservationResidualGlobalBoundaries(nElements_global,
                                                   ...
                                                   <double*>velocity.data,
                                                   <double*>conservationResidual.data)
def copyGlobalElementBoundaryVelocityToElementBoundary(int nElements_global,
                                                       int nInteriorElementBoundaries_global,
                                                       int nExteriorElementBoundaries_global,
                                                       int nElementBoundaries_global,
                                                       int nElementBoundaries_element,
...
def loadBoundaryFluxIntoGlobalElementBoundaryVelocity(int nExteriorElementBoundaries_global,
                                                      int nQuadraturePoints_elementBoundary,
                                                      int nSpace,
                                                      np.ndarray exteriorElementBoundaries,
    ...
    cloadBoundaryFluxIntoGlobalElementBoundaryVelocity(nExteriorElementBoundaries_global,
                                                       ...
                                                       updateCoef,
                                                       <double*>velocity.data)
def calculateInteriorNumericalTrace_Potential(int nInteriorElementBoundaries_global,
                                              int nElementBoundaries_element,
                                              int nQuadraturePoints_elementBoundary,
                                              np.ndarray interiorElementBoundaries,
                                              np.ndarray elementBoundaryElements,
...
def calculateExteriorNumericalTrace_Potential(np.ndarray isDOFBoundary,
    ...
    ccalculateExteriorNumericalTrace_Potential(<int *>isDOFBoundary.data,
                                               ...
                                               <double*>phi_trace.data,
                                               <double*>dphi_trace_left.data)
def updateInteriorElementBoundary_MixedForm_weak(int nInteriorElementBoundaries_global,
                                                 int nElementBoundaries_element,
                                                 int nQuadraturePoints_elementBoundary,
                                                 int nDOF_test_element,
                                                 int nSpace,
    ...
    cupdateInteriorElementBoundary_MixedForm_weak(nInteriorElementBoundaries_global,
                                                  ...
                                                  <double*>w_dS.data,
                                                  <double*>b.data)
def updateInteriorElementBoundary_MixedForm_weakJacobian(int nInteriorElementBoundaries_global,
                                                         int nElementBoundaries_element,
                                                         int nQuadraturePoints_elementBoundary,
                                                         int nDOF_test_element,
                                                         int nSpace,
    ...
    cupdateInteriorElementBoundary_MixedForm_weakJacobian(nInteriorElementBoundaries_global,
                                                          ...
                                                          <double*>db.data,
                                                          <double*>db_eb.data)
def updateExteriorElementBoundary_MixedForm_weak(int nExteriorElementBoundaries_global,
                                                 int nElementBoundaries_element,
                                                 int nQuadraturePoints_elementBoundary,
                                                 int nDOF_test_element,
                                                 int nSpace,
    ...
    cupdateExteriorElementBoundary_MixedForm_weak(nExteriorElementBoundaries_global,
                                                  ...
                                                  <double*>w_dS.data,
                                                  <double*>b.data)
def updateExteriorElementBoundary_MixedForm_weakJacobian(int nExteriorElementBoundaries_global,
                                                         int nElementBoundaries_element,
                                                         int nQuadraturePoints_elementBoundary,
                                                         int nDOF_test_element,
                                                         int nSpace,
    ...
    cupdateExteriorElementBoundary_MixedForm_weakJacobian(nExteriorElementBoundaries_global,
                                                          ...
                                                          <double*>db.data,
                                                          <double*>db_eb.data)
def updatePotential_MixedForm_weak(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_test_element,
                                   int nSpace,
                                   np.ndarray phi,
    ...
    cupdatePotential_MixedForm_weak(nElements_global,
                                    ...
                                    <double*>grad_w_dV.data,
                                    <double*>b.data)
def updatePotential_MixedForm_weakJacobian(int nElements_global,
                                           int nQuadraturePoints_element,
                                           int nDOF_test_element,
                                           int nSpace,
                                           np.ndarray dphi,
    ...
    cupdatePotential_MixedForm_weakJacobian(nElements_global,
                                            ...
                                            <double*>grad_w_dV.data,
                                            <double*>db.data)
def calculateVelocityQuadrature_MixedForm(int nElements_global,
                                          int nElementBoundaries_element,
                                          int nElementBoundaryQuadraturePoints_elementBoundary,
                                          int nDOF_element,
                                          int nSpace,
    ...
    ccalculateVelocityQuadrature_MixedForm(nElements_global,
                                           ...
                                           <double*>qv.data,
                                           <double*>qV.data)
def calculateVelocityQuadrature_MixedForm_Jacobian(int nElements_global,
                                                   int nElementBoundaries_element,
                                                   int nElementBoundaryQuadraturePoints_elementBoundary,
                                                   int nDOF_element,
                                                   int nSpace,
    ...
    ccalculateVelocityQuadrature_MixedForm_Jacobian(nElements_global,
                                                    ...
                                                    <double*>qDV.data,
                                                    <double*>qDV_eb.data)
def calculateVelocityProjectionMatrixLDG(int nElements_global,
                                         int nQuadraturePoints_element,
                                         int nDOF_element,
                                         np.ndarray vXw_dV,
                                         np.ndarray A_inv):
    ccalculateVelocityProjectionMatrixLDG(nElements_global,
                                          ...
                                          <double*>vXw_dV.data,
                                          <double*>A_inv.data)
def updateDiffusion_MixedForm_weak(int nElements_global,
                                   int nQuadraturePoints_element,
                                   int nDOF_test_element,
                                   int nSpace,
                                   np.ndarray a,
    ...
    cupdateDiffusion_MixedForm_weak(nElements_global,
                                    ...
                                    <double*>grad_w_dV.data,
                                    <double*>weak_residual.data)
def updateDiffusionJacobian_MixedForm_weak(int nElements_global,
                                           int nElementBoundaries_element,
                                           int nQuadraturePoints_element,
                                           int nDOF_trial_element,
                                           int nDOF_test_element,
...
def estimate_mt(int nElements_global,
                int nQuadraturePoints_element,
                int nDOF_element,
                np.ndarray v,
                np.ndarray vXw_dV,
    ...
    cestimate_mt(nElements_global,
                 ...
                 <double*>mt.data)
def estimate_mt_lowmem(int nElements_global,
                       int nQuadraturePoints_element,
                       int nDOF_element,
                       np.ndarray v,
                       np.ndarray w_dV,
    ...
    cestimate_mt_lowmem(nElements_global,
                        ...
                        <double*> elementSpatialResidual.data,
                        <double*> mt.data)
def scalarDomainIntegral(int nElements_global,
                         int nQuadraturePoints_element,
                         np.ndarray dV,
...
def scalarHeavisideDomainIntegral(int nElements_global,
    ...
    output = cscalarHeavisideDomainIntegral(nElements_global,
                                            ...
                                            <double*> nValueArray.data)
    return output
def scalarSmoothedHeavisideDomainIntegral(int nElements_global,
					  int nQuadraturePoints_element,
					  double epsFact,
					  np.ndarray elementDiameter,
					  np.ndarray dV,
    ...
    output = cscalarSmoothedHeavisideDomainIntegral(nElements_global,
						    ...
						    <double*> nValueArray.data)
    return output
def fluxDomainBoundaryIntegral(int nExteriorElementBoundaries,
			       int nElementBoundaries_owned,
                               int nQuadraturePoints_elementBoundary,
                               np.ndarray flag,
                               np.ndarray exteriorElementBoundariesArray,
...
def fluxDomainBoundaryIntegralFromVector(int nExteriorElementBoundaries,
    ...
    output = cfluxDomainBoundaryIntegralFromVector(nExteriorElementBoundaries,
						   ...
						   <double*> normal.data)
    return output
def copyExteriorElementBoundaryValuesFromElementBoundaryValues(int nExteriorElementBoundaries_global,
							       int nElements_global,
							       int nElementBoundaries_element,
							       int nQuadraturePoints_elementBoundary,
							       int nValuesPerQuadraturePoint,
    ...
    ccopyExteriorElementBoundaryValuesFromElementBoundaryValues(nExteriorElementBoundaries_global,
							        ...
							        <double*> ebq_val.data,
							        <double*> ebqe_val.data)
def copyExteriorElementBoundaryValuesToElementBoundaryValues(int nExteriorElementBoundaries_global,
							     int nElements_global,
							     int nElementBoundaries_element,
							     int nQuadraturePoints_elementBoundary,
							     int nValuesPerQuadraturePoint,
    ...
    ccopyExteriorElementBoundaryValuesToElementBoundaryValues(nExteriorElementBoundaries_global,
							      ...
							      <double*> ebqe_val.data,
							      <double*> ebq_val.data)
def copyExteriorElementBoundaryValuesToGlobalElementBoundaryValues(int nExteriorElementBoundaries_global,
								   int nQuadraturePoints_elementBoundary,
								   int nValuesPerQuadraturePoint,
								   np.ndarray  exteriorElementBoundaries,
								   np.ndarray elementBoundaryElements,
    ...
    ccopyExteriorElementBoundaryValuesToGlobalElementBoundaryValues(nExteriorElementBoundaries_global,
								    ...
								    <double*> ebqe_val.data,
								    <double*> ebq_global_val.data)
def copyExteriorElementBoundaryValuesFromGlobalElementBoundaryValues(int nExteriorElementBoundaries_global,
								     int nQuadraturePoints_elementBoundary,
								     int nValuesPerQuadraturePoint,
								     np.ndarray exteriorElementBoundaries,
								     np.ndarray elementBoundaryElements,
    ...
    ccopyExteriorElementBoundaryValuesFromGlobalElementBoundaryValues(nExteriorElementBoundaries_global,
								      ...
								      <double*> ebq_global_val.data,
								      <double*> ebqe_val.data)
def computeC0P1InterpolantDGP0(int nElements_global,
			       int nNodes_global,
			       int nNodes_element,
			       int nDOF_element,
			       int dim_dof,
...
def computeC0P1InterpolantNCP1(int nElements_global,
			       int nNodes_global,
			       int nNodes_element,
			       int nDOF_element,
			       int dim_dof,
    ...
    ccomputeC0P1InterpolantNCP1(nElements_global,
			        ...
			        <double*> dof.data,
			        <double*> nodalAverage.data)
def computeC0P1InterpolantDGP12(int nElements_global,
				int nNodes_global,
				int nNodes_element,
				int nDOF_element,
				int dim_dof,
...
def parametricMaps_getValuesGlobalExteriorTrace(np.ndarray exteriorElementBoundariesArray,
    ...
    cparametricMaps_getValuesGlobalExteriorTrace(nQuadraturePoints_elementBoundary,
						 ...
						 <double*> nodeArray.data,
						 <double*> xArray.data)
def parametricMaps_getInverseValuesGlobalExteriorTrace(int nElementBoundaryQuadraturePoints_elementBoundary,
						       int nDOF_element,
						       int nSpace_global,
						       int nExteriorElementBoundaries_global,
						       np.ndarray exteriorElementBoundariesArray,
...
def updateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_eb_dense(np.ndarray elementNeighbors,
    ...
    cupdateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_eb_dense(<int*> elementNeighbors.data,
									        ...
									        <double*> w_dS.data,
									        <double*> jac.data)
def updateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_dense(int nExteriorElementBoundaries_global,
									    int nQuadraturePoints_elementBoundary,
									    int nDOF_test_element,
									    int nDOF_trial_element,
									    int offset_r,
    ...
    cupdateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_dense(nExteriorElementBoundaries_global,
									     ...
									     <double*> w_dS.data,
									     <double*> jac.data)
def updateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_CSR(int nExteriorElementBoundaries_global,
									  int nQuadraturePoints_elementBoundary,
									  int nDOF_test_element,
									  int nDOF_trial_element,
									  np.ndarray exteriorElementBoundaries,
    ...
    cupdateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_CSR(nExteriorElementBoundaries_global,
									   ...
									   <double*> w_dS.data,
									   <double*> jac.data)
def updateGlobalJacobianFromGlobalExteriorElementBoundaryFluxJacobian_eb_CSR(np.ndarray elementNeighbors,
									     int nExteriorElementBoundaries_global,
									     int nElementBoundaries_element,
									     int nQuadraturePoints_elementBoundary,
									     int nDOF_test_element,
...
def calculateWeightedShapeGlobalExteriorTrace(np.ndarray exteriorElementBoundariesArray,
    ...
    ccalculateWeightedShapeGlobalExteriorTrace(nElementBoundaryQuadraturePoints_elementBoundary,
					       ...
					       <double*> w.data,
					       <double*> w_dS.data)
def calculateShape_X_weightedShapeGlobalExteriorTrace(int nElementBoundaryQuadraturePoints_elementBoundary,
						      int nDOF_trial_element,
						      int nDOF_test_element,
						      int nExteriorElementBoundaries_global,
						      np.ndarray exteriorElementBoundariesArray,
    ...
    ccalculateShape_X_weightedShapeGlobalExteriorTrace(nElementBoundaryQuadraturePoints_elementBoundary,
						       ...
						       <double*> w_dS.data,
						       <double*> v_X_w_dS.data)
def calculateGradShape_X_weightedShapeGlobalExteriorTrace(int nElementBoundaryQuadraturePoints_elementBoundary,
							  int nDOF_trial_element,
							  int nDOF_test_element,
							  int nSpace,
							  int nExteriorElementBoundaries_global,
...
def calculateGlobalExteriorElementBoundaryIntegrationWeights(int nQuadraturePoints_elementBoundary,
    ...
    ccalculateGlobalExteriorElementBoundaryIntegrationWeights(nQuadraturePoints_elementBoundary,
							      ...
							      <double*> referenceWeights.data,
							      <double*> weights.data)
def calculateFiniteElementFunctionValuesGlobalExteriorTrace(int nQuadraturePoints_elementBoundary,
							    int nDOF_trial_element,
							    int nComponents,
							    int nExteriorElementBoundaries_global,
							    np.ndarray exteriorElementBoundariesArray,
    ...
    ccalculateFiniteElementFunctionValuesGlobalExteriorTrace(nQuadraturePoints_elementBoundary,
							     ...
							     <double*> v.data,
							     <double*> u.data)
def calculateFiniteElementFunctionGradientValuesGlobalExteriorTrace(int nQuadraturePoints_elementBoundary,
								    int nDOF_trial_element,
								    int nComponents,
								    int nSpace,
								    int nExteriorElementBoundaries_global,
    ...
    ccalculateFiniteElementFunctionGradientValuesGlobalExteriorTrace(nQuadraturePoints_elementBoundary,
								     ...
								     <double*> grad_v.data,
								     <double*> grad_u.data)
def updateGlobalExteriorElementBoundaryDiffusiveVelocity(int nExteriorElementBoundaries_global,
							 int nQuadraturePoints_elementBoundary,
							 int nSpace,
							 np.ndarray exteriorElementBoundaries,
							 np.ndarray elementBoundaryElements,
    ...
    cupdateGlobalExteriorElementBoundaryDiffusiveVelocity(nExteriorElementBoundaries_global,
							  ...
							  <double*> grad_phi.data,
							  <double*> velocity.data)
def updateGlobalExteriorElementBoundaryAdvectiveVelocity(int nExteriorElementBoundaries_global,
							 int nQuadraturePoints_elementBoundary,
							 int nSpace,
							 np.ndarray exteriorElementBoundaries,
							 np.ndarray elementBoundaryElements,
    ...
    cupdateGlobalExteriorElementBoundaryAdvectiveVelocity(nExteriorElementBoundaries_global,
							  ...
							  <double*> f.data,
							  <double*> velocity.data)
def updateGlobalExteriorElementBoundaryShockCapturingVelocity(int nExteriorElementBoundaries_global,
							      int nQuadraturePoints_elementBoundary,
							      int nSpace,
							      np.ndarray exteriorElementBoundaries,
							      np.ndarray elementBoundaryElements,
							      ...
							      np.ndarray grad_u,
							      np.ndarray velocity):
    cupdateGlobalExteriorElementBoundaryShockCapturingVelocity(nExteriorElementBoundaries_global,
							       nQuadraturePoints_elementBoundary,
							       nSpace,
							       <int*> exteriorElementBoundaries.data,
							       <int*> elementBoundaryElements.data,
							       ...
							       <double*> grad_u.data,
							       <double*> velocity.data)
def copyFreeUnknownsToGlobalUnknowns(int nDOF2set,
				     int offset,
				     int stride,
				     ...
				     np.ndarray  free_u,
				     np.ndarray  u):
    ccopyFreeUnknownsToGlobalUnknowns(nDOF2set,
				      offset,
				      stride,
				      ...
				      <double*> free_u.data,
				      <double*> u.data)
def copyGlobalUnknownsToFreeUnknowns(int nDOF2set,
				     int offset,
				     int stride,
				     np.ndarray globalDOFids,
				     np.ndarray freeDOFids,
    ...
    ccopyGlobalUnknownsToFreeUnknowns(nDOF2set,
				      ...
				      <double*> u.data,
				      <double*> free_u.data)
def updateInteriorElementBoundaryDiffusionAdjoint(int nInteriorElementBoundaries_global,
						  int nElementBoundaries_element,
						  int nQuadraturePoints_elementBoundary,
						  int nDOF_test_element,
						  int nSpace,
    ...
    cupdateInteriorElementBoundaryDiffusionAdjoint(nInteriorElementBoundaries_global,
						   ...
						   <double*> dS.data,
						   <double*> residual.data)
def updateExteriorElementBoundaryDiffusionAdjoint(int nExteriorElementBoundaries_global,
						  int nQuadraturePoints_elementBoundary,
						  int nDOF_test_element,
						  int nSpace,
    ...
    cupdateExteriorElementBoundaryDiffusionAdjoint(nExteriorElementBoundaries_global,
						   ...
						   <double*> dS.data,
						   <double*> residual.data)
def updateGlobalJacobianFromInteriorElementBoundaryDiffusionAdjoint_dense(int nInteriorElementBoundaries_global,
									  int nElementBoundaries_element,
									  int nQuadraturePoints_elementBoundary,
									  int nDOF_test_element,
									  int nDOF_trial_element,
    ...
    cupdateGlobalJacobianFromInteriorElementBoundaryDiffusionAdjoint_dense(nInteriorElementBoundaries_global,
									   ...
									   <double*> dS.data,
									   <double*> jac.data)
def updateGlobalJacobianFromExteriorElementBoundaryDiffusionAdjoint_dense(int nExteriorElementBoundaries_global,
									  int nQuadraturePoints_elementBoundary,
									  int nDOF_test_element,
									  int nDOF_trial_element,
									  int nSpace,
    ...
    cupdateGlobalJacobianFromExteriorElementBoundaryDiffusionAdjoint_dense(nExteriorElementBoundaries_global,
									   ...
									   <double*> dS.data,
									   <double*> jac.data)
def updateInteriorElementBoundaryDiffusionAdjoint_sd(int nInteriorElementBoundaries_global,
						     int nElementBoundaries_element,
						     int nQuadraturePoints_elementBoundary,
						     int nDOF_test_element,
						     int nSpace,
...
def updateExteriorElementBoundaryDiffusionAdjoint_sd(int nExteriorElementBoundaries_global,
    ...
    cupdateExteriorElementBoundaryDiffusionAdjoint_sd(nExteriorElementBoundaries_global,
						      ...
						      <double*> dS.data,
						      <double*> residual.data)
def updateGlobalJacobianFromInteriorElementBoundaryDiffusionAdjoint_dense_sd(int nInteriorElementBoundaries_global,
									     int nElementBoundaries_element,
									     int nQuadraturePoints_elementBoundary,
									     int nDOF_test_element,
									     int nDOF_trial_element,
    ...
    cupdateGlobalJacobianFromInteriorElementBoundaryDiffusionAdjoint_dense_sd(nInteriorElementBoundaries_global,
									      ...
									      <double*> dS.data,
									      <double*> jac.data)
def updateGlobalJacobianFromExteriorElementBoundaryDiffusionAdjoint_dense_sd(int nExteriorElementBoundaries_global,
									     int nQuadraturePoints_elementBoundary,
									     int nDOF_test_element,
									     int nDOF_trial_element,
									     int nSpace,
    ...
    cupdateGlobalJacobianFromExteriorElementBoundaryDiffusionAdjoint_dense_sd(nExteriorElementBoundaries_global,
									      ...
									      <double*> dS.data,
									      <double*> jac.data)
def updateGlobalJacobianFromInteriorElementBoundaryDiffusionAdjoint_CSR_sd(int nInteriorElementBoundaries_global,
									   int nElementBoundaries_element,
									   int nQuadraturePoints_elementBoundary,
									   int nDOF_test_element,
									   int nDOF_trial_element,
...
def update_f_movingDomain_q(int nElements_global,
			    ...
			    np.ndarray m,
			    np.ndarray f):
    cupdate_f_movingDomain_q(nElements_global,
			     nQuadraturePoints_element,
			     nSpace,
			     <double*> xt.data,
			     <double*> m.data,
			     <double*> f.data)
def update_f_movingDomain_constantMass_q(int nElements_global,
					 int nQuadraturePoints_element,
					 int nSpace,
					 np.ndarray xt,
					 np.ndarray f):
    cupdate_f_movingDomain_constantMass_q(nElements_global,
					  nQuadraturePoints_element,
					  nSpace,
					  <double*> xt.data,
					  <double*> f.data)
def update_f_movingDomain_ebq(int nElements_global,
			      int nElementBoundaries_element,
			      int nQuadraturePoints_elementBoundary,
			      int nSpace,
			      np.ndarray xt,
			      np.ndarray m,
			      np.ndarray f):
    cupdate_f_movingDomain_ebq(nElements_global,
			       nElementBoundaries_element,
			       nQuadraturePoints_elementBoundary,
			       nSpace,
			       <double*> xt.data,
			       <double*> m.data,
			       <double*> f.data)
def update_f_movingDomain_constantMass_ebq(int nElements_global,
					   int nElementBoundaries_element,
					   int nQuadraturePoints_elementBoundary,
					   int nSpace,
					   np.ndarray xt,
					   np.ndarray f):
    cupdate_f_movingDomain_constantMass_ebq(nElements_global,
					    nElementBoundaries_element,
					    nQuadraturePoints_elementBoundary,
					    nSpace,
					    <double*> xt.data,
					    <double*> f.data)
def updateStress_weak(int nElements_global,
		      int nQuadraturePoints_element,
		      int nDOF_test_element,
		      int nSpace,
		      np.ndarray sigma,
...
def updateStressJacobian_weak(int nElements_global,
			      int nQuadraturePoints_element,
			      int nDOF_trial_element,
			      int nDOF_test_element,
			      int nSpace,
			      np.ndarray dsigma_xx,
...
def projectFromNodalInterpolationConditions(int nElements_global,
					    int nDOF_element,
					    int dim_dof,
					    np.ndarray l2g,
