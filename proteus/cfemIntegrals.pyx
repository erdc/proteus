...
cdef extern from "femIntegrals.h":
     ...
     void cprojectFromNodalInterpolationConditions "projectFromNodalInterpolationConditions"(int nElements_global,
					                                                     ...
					                                                     double * dofs)
     void cccalculateVelocityQuadrature_MixedForm2_sd "calculateVelocityQuadrature_MixedForm2_sd"(int nElements_global,
                                               int nElementBoundaries_element,
                                               int nElementBoundaryQuadraturePoints_elementBoundary,
                                               int nDOF_element,
                                               int nSpace,
                                               ...
                                               double* qv,
                                               double* qV)
     void cupdateDiffusion_MixedForm_weak_sd "updateDiffusion_MixedForm_weak_sd"(int nElements_global,
                                       int nQuadraturePoints_element,
                                       int nDOF_test_element,
                                       int nSpace,
                                       int rho_split,
                                       ...
                                       double* velocity,
                                       double* weak_residual)
     void ccalculateVelocityQuadrature_MixedForm2_Jacobian_sd "calculateVelocityQuadrature_MixedForm2_Jacobian_sd"(int nElements_global,
                        int nElementBoundaries_element,
                        int nElementBoundaryQuadraturePoints_elementBoundary,
                        int nDOF_element,
                        int nSpace,
                        ...
                        double* qDV,
                        double* qDV_eb)
     void cupdateDiffusionJacobian_MixedForm_weak_sd "updateDiffusionJacobian_MixedForm_weak_sd"(int nElements_global,
                                               int nElementBoundaries_element,
                                               int nQuadraturePoints_element,
                                               int nDOF_trial_element,
                                               int nDOF_test_element,
...
def projectFromNodalInterpolationConditions(int dim_dof,
    ...
    cprojectFromNodalInterpolationConditions(nElements_global,
					     ...
					     <double*> dofs.data)
def calculateVelocityQuadrature_MixedForm2_sd(np.ndarray rowptr,
                                            np.ndarray colind,
                                            np.ndarray qa,
                                            np.ndarray qw_dV,
                                            np.ndarray b,
                                            ...
                                            np.ndarray qv,
                                            np.ndarray qV):
    cccalculateVelocityQuadrature_MixedForm2_sd(v.shape[0],
                                            v.shape[1],
                                            v.shape[2],
                                            v.shape[3],
                                            b.shape[1],
...
def updateDiffusion_MixedForm_weak_sd(np.ndarray rowptr,
                    np.ndarray colind,
                    np.ndarray a,
                    np.ndarray qV,
                    np.ndarray grad_w_dV,
                    ...
                    np.ndarray residual,
                    int rho_split):
    cupdateDiffusion_MixedForm_weak_sd(grad_w_dV.shape[0],
                    grad_w_dV.shape[1],
                    grad_w_dV.shape[2],
                    grad_w_dV.shape[3],
                    rho_split,
...
def calculateVelocityQuadrature_MixedForm2_Jacobian_sd(np.ndarray rowptr,
                    np.ndarray colind,
                    np.ndarray qa,
                    np.ndarray qw_dV,
                    np.ndarray db,
                    ...
                    np.ndarray qDV,
                    np.ndarray qDV_eb):
    ccalculateVelocityQuadrature_MixedForm2_Jacobian_sd(v.shape[0],
                    v.shape[1],
                    v.shape[2],
                    v.shape[3],
                    db.shape[1],
                    ...
                    <double*> qDV.data,
                    <double*> qDV_eb.data)
def updateDiffusionJacobian_MixedForm_weak_sd(np.ndarray rowptr,
                       np.ndarray colind,
                       np.ndarray a,
                       np.ndarray da,
                       np.ndarray qV,
                       ...
                       np.ndarray v,
                       np.ndarray jacobian,
                       np.ndarray jacobian_eb):
    cupdateDiffusionJacobian_MixedForm_weak_sd(qDV_eb.shape[0],
                        qDV_eb.shape[1],
                        qDV_eb.shape[2],
                        qDV_eb.shape[3],
                        grad_w_dV.shape[2],
                        ...
                        <double*> grad_w_dV.data,
                        <double*> v.data,
                        <double*> jacobian.data,
                        <double*> jacobian_eb.data)