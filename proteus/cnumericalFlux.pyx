...
#######2222222
    ...
    void ccalculateInteriorNumericalAdvectiveFluxRusanov "calculateInteriorNumericalAdvectiveFluxRusanov"(double safetyFactor,
                            ...
                            double* dflux_left,
                            double* dflux_right)
    void capplySeepageFace "applySeepageFace"(int nExteriorElementBoundaries_global,
                            int nQuadraturePoints_elementBoundary,
                            int nSpace,
                            int* exteriorElementBoundaries,
                            int* elementBoundaryElements,
                            ...
                            double* diffusiveFlux)
    void capplySeepageFaceJacobian "applySeepageFaceJacobian"(int nExteriorElementBoundaries_global,
                            int nQuadraturePoints_elementBoundary,
                            int nDOF_trial_element,
                            int nSpace,
                            int* exteriorElementBoundaries,
...
def calculateInteriorNumericalAdvectiveFluxRusanovWithEigenvalueBound(double safetyFactor,
    ...
    ccalculateInteriorNumericalAdvectiveFluxRusanovWithEigenvalueBound( safetyFactor,
                                       ...
                                       <double*> flux.data)
def calculateInteriorLesaintRaviartNumericalFlux(int speedEvalFlag,
                                                        np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
         ...
         ccalculateInteriorLesaintRaviartNumericalFlux(interiorElementBoundaries.shape[0],
                                                         dH.shape[1],
                                                         dH.shape[2],
                                                         dH.shape[3],
                                                         speedEvalFlag,
...
def calculateInteriorNumericalDiffusiveFlux(np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
                                                        np.ndarray a,
         ...
         ccalculateInteriorNumericalDiffusiveFlux( scale_penalty,
                                                        ...
                                                        <double*> penalty.data,
                                                        <double*> flux.data)
def updateInteriorNumericalDiffusiveFluxJacobian(np.ndarray l2g,
                                                        np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
...
def updateInteriorNumericalAdvectiveFluxJacobian(       np.ndarray interiorElementBoundaries,
         ...
         cupdateInteriorNumericalAdvectiveFluxJacobian( interiorElementBoundaries.shape[0],
                                                        ...
                                                        <double*> v.data,
                                                        <double*> fluxJacobian.data)
def calculateInteriorNumericalAdvectiveFlux_average(np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
                                                        np.ndarray u,
         ...
         ccalculateInteriorNumericalAdvectiveFlux_average(interiorElementBoundaries.shape[0],
                                                         f.shape[1],
                                                         f.shape[2],
                                                         f.shape[3],
                                                        <int*> interiorElementBoundaries.data,
...
def updateExteriorNumericalAdvectiveFluxJacobian( np.ndarray exteriorElementBoundaries,
    ...
    if v.ndim==4:
        ...
        cupdateGlobalExteriorNumericalAdvectiveFluxJacobian( exteriorElementBoundaries.shape[0],
                                                        ...
                                                        <double*> v.data,
                                                        <double*> fluxJacobian.data)
def calculateInteriorNumericalDiffusiveFlux_LDG_upwind(np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
                                                        np.ndarray u,
         ...
         ccalculateInteriorNumericalDiffusiveFlux_LDG_upwind(interiorElementBoundaries.shape[0],
                                                         n.shape[1],
                                                         n.shape[2],
                                                         n.shape[3],
                                                        <int*> interiorElementBoundaries.data,
                                                        ...
                                                        <double*> penalty.data,
                                                        <double*> flux.data)
def updateInteriorNumericalDiffusiveFluxJacobian_LDG_upwind(np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
                                                        np.ndarray a,
         ...
         cupdateInteriorNumericalDiffusiveFluxJacobian_LDG_upwind(interiorElementBoundaries.shape[0],
                                                        v.shape[1],
                                                        v.shape[2],
                                                        v.shape[3],
                                                        n.shape[3],
...
def setInflowFlux(np.ndarray exteriorElementBoundaries,
                np.ndarray inflowFlux,
                np.ndarray flux):
         csetInflowFlux( exteriorElementBoundaries.shape[0],
                                                        flux.shape[1],
                                                        <int*> exteriorElementBoundaries.data,
                                                        <double*> inflowFlux.data,
                                                        <double*> flux.data)
def updateInteriorTwoSidedNumericalFluxJacobian(np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray dflux_left,
                                                        np.ndarray dflux_right,
         ...
         cupdateInteriorTwoSidedNumericalFluxJacobian(interiorElementBoundaries.shape[0],
                                                         v.shape[1],
                                                         v.shape[2],
                                                         v.shape[3],
                                                        <int*> interiorElementBoundaries.data,
...
def updateGlobalExteriorNumericalAdvectiveFluxJacobian(int nExteriorElementBoundaries_global,
         ...
         cupdateGlobalExteriorNumericalAdvectiveFluxJacobian( nExteriorElementBoundaries_global,
                                                        ...
                                                        <double*> v.data,
                                                        <double*> fluxJacobian.data)
def calculateInteriorChengShuNumericalFlux(int speedEvalFlag,
                                                        np.ndarray interiorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray n,
                                                        ...
                                                        np.ndarray dflux_left,
                                                        np.ndarray dflux_right):
         ccalculateInteriorChengShuNumericalFlux(interiorElementBoundaries.shape[0],
                                                         dH.shape[1],
                                                         dH.shape[2],
                                                         dH_element.shape[1],
                                                         dH.shape[3],
                                                        ...
                                                        <double*> dflux_left.data,
                                                        <double*> dflux_right.data)
def calculateGlobalExteriorNumericalFluxDarcyFCFF(np.ndarray exteriorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
         ...
         ccalculateGlobalExteriorNumericalFluxDarcyFCFF(exteriorElementBoundaries.shape[0],
                                                        n.shape[1],
                                                        n.shape[2],
                                                        <int*> exteriorElementBoundaries.data,
                                                        <int*> elementBoundaryElements.data,
...
def calculateGlobalExteriorNumericalFluxDarcyFCFF_diffusiveFluxJacobian(np.ndarray l2g,
                                                        np.ndarray exteriorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray isDOFBoundary_uw,
         ...
         ccalculateGlobalExteriorNumericalFluxDarcyFCFF_diffusiveFluxJacobian(exteriorElementBoundaries.shape[0],
                                                        n.shape[1],
                                                        n.shape[2],
                                                        l2g.shape[1],
                                                        <int*> l2g.data,
...
def updateExteriorNumericalStressFluxJacobian(np.ndarray exteriorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
         ...
         cupdateExteriorNumericalStressFluxJacobian(v.shape[0],
                                                        v.shape[1],
                                                        v.shape[2],
                                                        n.shape[2],
                                                        <int*> exteriorElementBoundaries.data,
...
def updateExteriorNumericalDiffusiveFluxJacobian_free_sd(np.ndarray rowptr,
    ...
    if grad_v.ndim == 5:
        ...
        exit(1)
def calculateInteriorNumericalDiffusiveFlux_LDG_upwind_sd(np.ndarray rowptr,
                               np.ndarray colind,
                               np.ndarray interiorElementBoundaries,
                               np.ndarray elementBoundaryElements,
                               np.ndarray elementBoundaryLocalElementBoundaries,
                               ...
                               np.ndarray penalty,
                               np.ndarray flux):
     ccalculateInteriorNumericalDiffusiveFlux_LDG_upwind_sd(interiorElementBoundaries.shape[0],
                                n.shape[1],
                                n.shape[2],
                                n.shape[3],
                               <int*> rowptr.data,
                               ...
                               <double*> penalty.data,
                               <double*> flux.data)
def updateInteriorNumericalDiffusiveFluxJacobian_LDG_upwind_sd(np.ndarray rowptr,
                                np.ndarray colind,
                                np.ndarray interiorElementBoundaries,
                                np.ndarray elementBoundaryElements,
                                np.ndarray elementBoundaryLocalElementBoundaries,
                                ...
                                np.ndarray fluxJacobian,
                                np.ndarray fluxJacobian_eb):
     cupdateInteriorNumericalDiffusiveFluxJacobian_LDG_upwind_sd(interiorElementBoundaries.shape[0],
                                 v.shape[1],
                                 v.shape[2],
                                 v.shape[3],
                                 n.shape[3],
...
def calculateDiffusionMatrixSplittings_LDG_sd(int aSplit,
     ...
     ccalculateDiffusionMatrixSplittings_LDG_sd( aSplit,
                            ...
                            <double*> aHat.data,
                            <double*> aTilde.data)
def calculateGlobalExteriorNumericalFluxDarcyFCFF_sd(np.ndarray rowptr_wm,
                                ...
                                np.ndarray diffusiveFlux_mw,
                                np.ndarray diffusiveFlux_mm):
     ccalculateGlobalExteriorNumericalFluxDarcyFCFF_sd(exteriorElementBoundaries.shape[0],
                                n.shape[1],
                                n.shape[2],
                                <int*> rowptr_wm.data,
                                <int*> colind_wm.data,
                                ...
                                <double*> diffusiveFlux_mw.data,
                                <double*> diffusiveFlux_mm.data)
def calculateGlobalExteriorNumericalFluxDarcyFCFF_diffusiveFluxJacobian_sd(np.ndarray rowptr_wm,
                                        np.ndarray colind_wm,
                                        np.ndarray rowptr_mw,
                                        np.ndarray colind_mw,
                                        np.ndarray rowptr_mm,
                                        ...
                                        np.ndarray fluxJacobian_mw,
                                        np.ndarray fluxJacobian_mm):
     ccalculateGlobalExteriorNumericalFluxDarcyFCFF_diffusiveFluxJacobian_sd(exteriorElementBoundaries.shape[0],
                                        n.shape[1],
                                        n.shape[2],
                                        l2g.shape[1],
                                        <int*> rowptr_wm.data,
                                        ...
                                        <double*> fluxJacobian_mw.data,
                                        <double*> fluxJacobian_mm.data)
def calculateGlobalExteriorNumericalFluxDarcyFC(np.ndarray exteriorElementBoundaries,
                         np.ndarray elementBoundaryElements,
                         np.ndarray elementBoundaryLocalElementBoundaries,
                         np.ndarray isDOFBoundary_uw,
     ...
     ccalculateGlobalExteriorNumericalFluxDarcyFC(exteriorElementBoundaries.shape[0],
                         n.shape[1],
                         n.shape[2],
                         <int*> exteriorElementBoundaries.data,
                         <int*> elementBoundaryElements.data,
...
def calculateGlobalExteriorNumericalFluxDarcyFC_sd(np.ndarray rowptr_ww,
                            ...
                            np.ndarray  diffusiveFlux_ww,
                            np.ndarray  diffusiveFlux_nn):
     ccalculateGlobalExteriorNumericalFluxDarcyFC_sd(exteriorElementBoundaries.shape[0],
                            n.shape[1],
                            n.shape[2],
                            <int*> rowptr_ww.data,
                            <int*> colind_ww.data,
                            ...
                            <double*>  diffusiveFlux_ww.data,
                            <double*>  diffusiveFlux_nn.data)
def calculateGlobalExteriorNumericalFluxDarcyFC_diffusiveFluxJacobian(np.ndarray l2g,
                                       np.ndarray exteriorElementBoundaries,
                                       np.ndarray elementBoundaryElements,
                                       np.ndarray elementBoundaryLocalElementBoundaries,
                                       np.ndarray isDOFBoundary_uw,
     ...
     ccalculateGlobalExteriorNumericalFluxDarcyFC_diffusiveFluxJacobian(exteriorElementBoundaries.shape[0],
                                        n.shape[1],
                                        n.shape[2],
                                        l2g.shape[1],
                                        <int*> l2g.data,
...
def calculateGlobalExteriorNumericalFluxDarcyFC_diffusiveFluxJacobian_sd(np.ndarray rowptr_ww,
                                      np.ndarray colind_ww,
                                      np.ndarray rowptr_nn,
                                      np.ndarray colind_nn,
                                      np.ndarray l2g,
                                      ...
                                      np.ndarray  fluxJacobian_nw,
                                      np.ndarray  fluxJacobian_nn):
     ccalculateGlobalExteriorNumericalFluxDarcyFC_diffusiveFluxJacobian_sd(exteriorElementBoundaries.shape[0],
                                        n.shape[1],
                                        n.shape[2],
                                        l2g.shape[1],
                                        <int*> rowptr_ww.data,
                                        ...
                                        <double*>  fluxJacobian_nw.data,
                                        <double*>  fluxJacobian_nn.data)
def calculateGlobalExteriorNumericalFluxDarcyFCPP(np.ndarray exteriorElementBoundaries,
                           np.ndarray elementBoundaryElements,
                           np.ndarray elementBoundaryLocalElementBoundaries,
                           np.ndarray isDOFBoundary_uw,
                           np.ndarray isDOFBoundary_un,
                           ...
                           np.ndarray  diffusiveFlux_ww,
                           np.ndarray  diffusiveFlux_nn):
     ccalculateGlobalExteriorNumericalFluxDarcyFCPP(exteriorElementBoundaries.shape[0],
                            n.shape[1],
                            n.shape[2],
                            <int*> exteriorElementBoundaries.data,
                            <int*> elementBoundaryElements.data,
                            ...
                            <double*>  diffusiveFlux_ww.data,
                            <double*>  diffusiveFlux_nn.data)
def calculateGlobalExteriorNumericalFluxDarcyFCPP_sd(np.ndarray rowptr_ww,
                              np.ndarray colind_ww,
                              np.ndarray rowptr_nn,
                              np.ndarray colind_nn,
                              np.ndarray exteriorElementBoundaries,
                              ...
                              np.ndarray  diffusiveFlux_ww,
                              np.ndarray  diffusiveFlux_nn):
     ccalculateGlobalExteriorNumericalFluxDarcyFCPP_sd(exteriorElementBoundaries.shape[0],
                                n.shape[1],
                                n.shape[2],
                                <int*> rowptr_ww.data,
                                <int*> colind_ww.data,
                                ...
                                <double*>  diffusiveFlux_ww.data,
                                <double*>  diffusiveFlux_nn.data)
def calculateGlobalExteriorNumericalFluxDarcyFCPP_diffusiveFluxJacobian(np.ndarray l2g,
                                     np.ndarray exteriorElementBoundaries,
                                     np.ndarray elementBoundaryElements,
                                     np.ndarray elementBoundaryLocalElementBoundaries,
                                     np.ndarray isDOFBoundary_uw,
                                     ...
                                     np.ndarray  fluxJacobian_nw,
                                     np.ndarray  fluxJacobian_nn):
     ccalculateGlobalExteriorNumericalFluxDarcyFCPP_diffusiveFluxJacobian(exteriorElementBoundaries.shape[0],
                                    n.shape[1],
                                    n.shape[2],
                                    l2g.shape[1],
                                    <int*> l2g.data,
                                    ...
                                    <double*>  fluxJacobian_nw.data,
                                    <double*>  fluxJacobian_nn.data)
def calculateGlobalExteriorNumericalFluxDarcyFCPP_diffusiveFluxJacobian_sd(np.ndarray rowptr_ww,
                                        np.ndarray colind_ww,
                                        np.ndarray rowptr_nn,
                                        np.ndarray colind_nn,
                                        np.ndarray l2g,
                                        ...
                                        np.ndarray  fluxJacobian_nw,
                                        np.ndarray  fluxJacobian_nn):
     ccalculateGlobalExteriorNumericalFluxDarcyFCPP_diffusiveFluxJacobian_sd(exteriorElementBoundaries.shape[0],
                                        n.shape[1],
                                        n.shape[2],
                                        l2g.shape[1],
                                        <int*> rowptr_ww.data,
...
def calculateInteriorNumericalFluxShallowWater_1D(double h_eps,
                                                double tol_u,
                                                double g,
                                                np.ndarray interiorElementBoundaries,
                                                np.ndarray elementBoundaryElements,
                                                ...
                                                np.ndarray flux_h,
                                                np.ndarray flux_hu):
     ccalculateInteriorNumericalFluxShallowWater_1D(interiorElementBoundaries.shape[0],
                                                    hu.shape[1],
                                                    hu.shape[2],
                                                    h_eps,
                                                    tol_u,
...
def calculateExteriorNumericalFluxShallowWater_1D(int nExteriorElementBoundaries_global,
     ...
     ccalculateExteriorNumericalFluxShallowWater_1D( nExteriorElementBoundaries_global,
                                                    ...
                                                    <double*> flux_h.data,
                                                    <double*> flux_hu.data)
def calculateInteriorNumericalFluxShallowWater_2D(double h_eps,
                                                    double tol_u,
                                                    double g,
                                                    np.ndarray interiorElementBoundaries,
                                                    np.ndarray elementBoundaryElements,
                                                    ...
                                                    np.ndarray flux_hu,
                                                    np.ndarray flux_hv):
     ccalculateInteriorNumericalFluxShallowWater_2D(interiorElementBoundaries.shape[0],
                                                    hu.shape[1],
                                                    hu.shape[2],
                                                    h_eps,
                                                    tol_u,
...
def calculateExteriorNumericalFluxShallowWater_2D(int nExteriorElementBoundaries_global,
     ...
     ccalculateExteriorNumericalFluxShallowWater_2D( nExteriorElementBoundaries_global,
                                                    ...
                                                    <double*> flux_hu.data,
                                                    <double*> flux_hv.data)
def calculateInteriorNumericalFluxShallowWaterHLL_1D(double h_eps,
                              double tol_u,
                              double g,
                              np.ndarray interiorElementBoundaries,
                              np.ndarray elementBoundaryElements,
                              ...
                              np.ndarray flux_h,
                              np.ndarray flux_hu):
     ccalculateInteriorNumericalFluxShallowWaterHLL_1D(interiorElementBoundaries.shape[0],
                               hu.shape[1],
                               hu.shape[2],
                               h_eps,
                               tol_u,
...
def calculateExteriorNumericalFluxShallowWaterHLL_1D(int nExteriorElementBoundaries_global,
     ...
     ccalculateExteriorNumericalFluxShallowWaterHLL_1D( nExteriorElementBoundaries_global,
                              ...
                              <double*> flux_h.data,
                              <double*> flux_hu.data)
def calculateGlobalExteriorNumericalStressFlux(np.ndarray exteriorElementBoundaries,
                        np.ndarray elementBoundaryElements,
                        np.ndarray elementBoundaryLocalElementBoundaries,
                        np.ndarray isDOFBoundary_u,
                        np.ndarray isDOFBoundary_v,
     ...
     ccalculateGlobalExteriorNumericalStressFlux(n.shape[0],
                        n.shape[1],
                        n.shape[2],
                        <int*> exteriorElementBoundaries.data,
                        <int*> elementBoundaryElements.data,
...
def calculateGlobalExteriorNumericalDiffusiveFlux_sd(np.ndarray rowptr,
                                                    np.ndarray colind,
                                                    np.ndarray exteriorElementBoundaries,
                                                    np.ndarray elementBoundaryElements,
                                                    np.ndarray elementBoundaryLocalElementBoundaries,
...
def calculateGlobalExteriorNumericalFluxDarcySplitPressure_sd(np.ndarray rowptr,
    ...
    if grad_phi.ndim == 3:
        ...
        exit(1)
def updateExteriorNumericalDiffusiveFluxWithUpwindingJacobian_sd(np.ndarray rowptr,
                                    np.ndarray colind,
                                    np.ndarray l2g,
                                    np.ndarray exteriorElementBoundaries,
                                    np.ndarray elementBoundaryElements,
...
def updateGlobalExteriorNumericalDiffusiveFluxWithUpwindingJacobian_sd(int scale_penalty,
    ...
    cupdateGlobalExteriorNumericalDiffusiveFluxWithUpwindingJacobian_sd( scale_penalty,
                                    ...
                                    <double*> penalty.data,
                                    <double*> fluxJacobian.data)
def calculateGlobalExteriorNumericalAdvectiveFluxStokes2D(np.ndarray exteriorElementBoundaries,
                                    np.ndarray elementBoundaryElements,
                                    np.ndarray elementBoundaryLocalElementBoundaries,
                                    np.ndarray isDOFBoundary_p,
                                    np.ndarray isDOFBoundary_u,
    ...
    ccalculateGlobalExteriorNumericalAdvectiveFluxStokes2D(exteriorElementBoundaries.shape[0],
                                                    ...
                                                    <double*> dflux_vmom_dp.data,
                                                    <double*> velocity.data)
def calculateGlobalExteriorNumericalAdvectiveFluxStokes3D(np.ndarray exteriorElementBoundaries,
                                                        np.ndarray elementBoundaryElements,
                                                        np.ndarray elementBoundaryLocalElementBoundaries,
                                                        np.ndarray isDOFBoundary_p,
                                                        np.ndarray isDOFBoundary_u,
                                                        ...
                                                        np.ndarray dflux_wmom_dp,
                                                        np.ndarray velocity):
    ccalculateGlobalExteriorNumericalAdvectiveFluxStokes3D(exteriorElementBoundaries.shape[0],
                                                        f_mass.shape[1],
                                                        f_mass.shape[2],
                                                        <int*> exteriorElementBoundaries.data,
                                                        <int*> elementBoundaryElements.data,
                                                        ...
                                                        <double*> dflux_wmom_dp.data,
                                                        <double*> velocity.data)
def applySeepageFace(np.ndarray exteriorElementBoundaries,
                    np.ndarray elementBoundaryElements,
                    np.ndarray elementBoundaryLocalElementBoundaries,
                    np.ndarray isSeepageFace,
                    np.ndarray isDOFBoundary,
                    double epsFact,
                    np.ndarray elementDiameters,
                    np.ndarray g,
                    np.ndarray n,
                    np.ndarray grad_u,
                    np.ndarray u,
                    ...
                    np.ndarray diffusiveFlux):
    capplySeepageFace(exteriorElementBoundaries.sape[0],
                    grad_u.shape[1],
                    grad_u.shape[2],
                    <int*> exteriorElementBoundaries.data,
                    <int*> elementBoundaryElements.data,
                    ...
                    <double*> diffusiveFlux.data)
def applySeepageFaceJacobian(np.ndarray exteriorElementBoundaries,
                    np.ndarray elementBoundaryElements,
                    np.ndarray elementBoundaryLocalElementBoundaries,
                    np.ndarray isSeepageFace,
                    double epsFact,
                    ...
                    np.ndarray v,
                    np.ndarray fluxJacobian):
    capplySeepageFaceJacobian(exteriorElementBoundaries.shape[0],
                    grad_u.shape[1],
