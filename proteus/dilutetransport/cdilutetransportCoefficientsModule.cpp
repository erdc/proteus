                                                               ...
                                                               PyObject* args)
{
  ...
  if(!PyArg_ParseTuple(args,"dddOOOOOOOOOOO",
                       &K,
                       &grav,
                       &L,
                       &u,
...
static PyObject* cdilutetransportCoefficientsDiluteEvaluate(PyObject* self, 
                                                               PyObject* args)
{
  int i,nPoints=1;
  double poro,diff,alpha_L;
...
static PyObject* cdilutetransportCoefficientsAdvectionEvaluate(PyObject* self, 
                                                               PyObject* args)
{
  int i,nPoints=1;
  double poro,diff,alpha_L;
...
static PyMethodDef cdilutetransportCoefficientsMethods[] = {
  ...
  { "DiluteEvaluate", 
      cdilutetransportCoefficientsDiluteEvaluate,
      METH_VARARGS, 
      "Evaluate the coefficients for Dilute Transport"}, 
  { "AdvectionEvaluate", 
      cdilutetransportCoefficientsAdvectionEvaluate,
      METH_VARARGS, 
