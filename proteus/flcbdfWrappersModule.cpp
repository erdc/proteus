...
CKSP_useTrueResidualConvergence(CKSP *self, PyObject *args, PyObject *kwds)
{
  ...
  PetscOptionsGetReal(PETSC_NULL,NULL,"-ksp_atol",&atol,&found);
  if (found) self->tres_ctx.atol  = atol;
  PetscOptionsGetReal(PETSC_NULL,NULL,"-ksp_rtol",&rtol,&found);
  if (found) self->tres_ctx.rtol  = rtol;
  PetscOptionsGetReal(PETSC_NULL,NULL,"-ksp_divtol",&divtol,&found);
  if (found) self->tres_ctx.divtol  = divtol;
  PetscOptionsGetInt(PETSC_NULL,NULL,"-ksp_max_it",&max_it,&found);
