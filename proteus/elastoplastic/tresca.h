...
inline void tresca(const double& phi, const double& psi, const double& c, const double* stress, //inputs
                               double& f, double* df, double& g, double* r, double* dr) //outputs
{
  ...
  f = -c + sqrt(6)*sqrt(targ)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/6;

  df_dtmp[SKEY] = 0;

  df_dtmp[TARGKEY] = sqrt(6)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(12*sqrt(targ)) + 9*J3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(2*pow(targ, 2)*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3)));

  df_dtmp[J3KEY] = -3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(targ*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3)));
  ...
  g = -c + sqrt(6)*sqrt(targ)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/6;

  dg_dtmp[SKEY] = 0;

  dg_dtmp[TARGKEY] = sqrt(6)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(12*sqrt(targ)) + 9*J3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(2*pow(targ, 2)*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3)));

  dg_dtmp[J3KEY] = -3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(targ*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3)));
  ...
  ddg_dtmp[TARGKEY+3*TARGKEY] = -sqrt(6)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(24*pow(targ, 3.0/2.0)) - 19683*sqrt(3)*pow(J3, 3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(2*pow(targ, 6)*pow(1 - 1458*pow(J3, 2)/pow(targ, 3), 3.0/2.0)) - 243*sqrt(6)*pow(J3, 2)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(4*pow(targ, 9.0/2.0)*(1 - 1458*pow(J3, 2)/pow(targ, 3))) - 27*J3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(4*pow(targ, 3)*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3)));

  ddg_dtmp[TARGKEY+3*J3KEY] = 3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(pow(targ, 2)*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3))) + 6561*sqrt(3)*pow(J3, 2)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(pow(targ, 5)*pow(1 - 1458*pow(J3, 2)/pow(targ, 3), 3.0/2.0)) + 81*J3*sqrt(6)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(2*pow(targ, 7.0/2.0)*(1 - 1458*pow(J3, 2)/pow(targ, 3)));

  ddg_dtmp[J3KEY+3*SKEY] = 0;

  ddg_dtmp[J3KEY+3*TARGKEY] = 3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(pow(targ, 2)*sqrt(1 - 1458*pow(J3, 2)/pow(targ, 3))) + 6561*sqrt(3)*pow(J3, 2)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(pow(targ, 5)*pow(1 - 1458*pow(J3, 2)/pow(targ, 3), 3.0/2.0)) + 81*J3*sqrt(6)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(2*pow(targ, 7.0/2.0)*(1 - 1458*pow(J3, 2)/pow(targ, 3)));

  ddg_dtmp[J3KEY+3*J3KEY] = -27*sqrt(6)*cos(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(pow(targ, 5.0/2.0)*(1 - 1458*pow(J3, 2)/pow(targ, 3))) - 4374*J3*sqrt(3)*sin(asin(27*J3*sqrt(2)/pow(targ, 3.0/2.0))/3)/(pow(targ, 4)*pow(1 - 1458*pow(J3, 2)/pow(targ, 3), 3.0/2.0));
