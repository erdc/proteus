...
namespace proteus
{
    ...
    template<class CompKernelType,
        ...
        xt::pyarray<double>& ebqe_penalty = args.array<double>("ebqe_penalty");
        int gravityStep = args.scalar<int>("gravityStep");
        ...
        double pore_fluid_unit_weight = args.scalar<double>("pore_fluid_unit_weight");
        xt::pyarray<double>& pore_pressure_head_dof = args.array<double>("pore_pressure_head_dof");
        xt::pyarray<double>& q_strain = args.array<double>("q_strain");
        xt::pyarray<double>& q_strain0 = args.array<double>("q_strain0");
        xt::pyarray<double>& q_strain_last = args.array<double>("q_strain_last");
        xt::pyarray<double>& q_plasticStrain = args.array<double>("q_plasticStrain");
        xt::pyarray<double>& q_plasticStrain_last = args.array<double>("q_plasticStrain_last");
        xt::pyarray<double>& ebqe_strain = args.array<double>("ebqe_strain");
        xt::pyarray<double>& ebqe_strain0 = args.array<double>("ebqe_strain0");
        xt::pyarray<double>& ebqe_strain_last = args.array<double>("ebqe_strain_last");
        xt::pyarray<double>& ebqe_plasticStrain = args.array<double>("ebqe_plasticStrain");
        xt::pyarray<double>& ebqe_plasticStrain_last = args.array<double>("ebqe_plasticStrain_last");
        ...
        xt::pyarray<double>& ebqe_bc_stressFlux_w_ext = args.array<double>("ebqe_bc_stressFlux_w_ext");
                ...
                virtual void calculateJacobian(arguments_dict& args)
                        {
        int usePicard = args.scalar<int>("usePicard");
        xt::pyarray<double>& mesh_trial_ref = args.array<double>("mesh_trial_ref");
        xt::pyarray<double>& mesh_grad_trial_ref = args.array<double>("mesh_grad_trial_ref");
        xt::pyarray<double>& mesh_dof = args.array<double>("mesh_dof");
        xt::pyarray<int>& mesh_l2g = args.array<int>("mesh_l2g");
