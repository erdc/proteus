...
namespace proteus
{
    ...
    template<class CompKernelType,
        ...
        xt::pyarray<double>& ebqe_penalty = args.m_darray["ebqe_penalty"];
        int gravityStep = args.m_iscalar["gravityStep"];
        ...
        double pore_fluid_unit_weight = args.m_dscalar["pore_fluid_unit_weight"];
        xt::pyarray<double>& pore_pressure_head_dof = args.m_darray["pore_pressure_head_dof"];
        xt::pyarray<double>& q_strain = args.m_darray["q_strain"];
        xt::pyarray<double>& q_strain0 = args.m_darray["q_strain0"];
        xt::pyarray<double>& q_strain_last = args.m_darray["q_strain_last"];
        xt::pyarray<double>& q_plasticStrain = args.m_darray["q_plasticStrain"];
        xt::pyarray<double>& q_plasticStrain_last = args.m_darray["q_plasticStrain_last"];
        xt::pyarray<double>& ebqe_strain = args.m_darray["ebqe_strain"];
        xt::pyarray<double>& ebqe_strain0 = args.m_darray["ebqe_strain0"];
        xt::pyarray<double>& ebqe_strain_last = args.m_darray["ebqe_strain_last"];
        xt::pyarray<double>& ebqe_plasticStrain = args.m_darray["ebqe_plasticStrain"];
        xt::pyarray<double>& ebqe_plasticStrain_last = args.m_darray["ebqe_plasticStrain_last"];
        ...
        xt::pyarray<double>& ebqe_bc_stressFlux_w_ext = args.m_darray["ebqe_bc_stressFlux_w_ext"];
                ...
                virtual void calculateJacobian(arguments_dict& args)
                        {
        int usePicard = args.m_iscalar["usePicard"];
        xt::pyarray<double>& mesh_trial_ref = args.m_darray["mesh_trial_ref"];
        xt::pyarray<double>& mesh_grad_trial_ref = args.m_darray["mesh_grad_trial_ref"];
        xt::pyarray<double>& mesh_dof = args.m_darray["mesh_dof"];
        xt::pyarray<int>& mesh_l2g = args.m_iarray["mesh_l2g"];
