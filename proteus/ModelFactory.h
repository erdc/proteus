          ...
          if (nDOF_trial_elementIn == 6)
            {
              ...
              else if (nQuadraturePoints_elementIn == 24)//hk=0.5
                {
                      if (nQuadraturePoints_elementBoundaryIn == 4)
                       {
                            return static_cast<Model_Base*>(new ModelTemplate<CompKernelTemplate<2,3,6,6>,2,24,3,6,6,4>());
                       }
                       else
                          NO_INSTANCE
                 }
              else if (nQuadraturePoints_elementIn == 54)//hk=0.3
                  {
                        if (nQuadraturePoints_elementBoundaryIn == 4)
                         {
                              return static_cast<Model_Base*>(new ModelTemplate<CompKernelTemplate<2,3,6,6>,2,54,3,6,6,4>());
                         }
                         else
                            NO_INSTANCE
                   }
              else if (nQuadraturePoints_elementIn == 150)//hk=0.2
                  {
                        if (nQuadraturePoints_elementBoundaryIn == 4)
                         {
                              return static_cast<Model_Base*>(new ModelTemplate<CompKernelTemplate<2,3,6,6>,2,150,3,6,6,4>());
                         }
                         else
                            NO_INSTANCE
                   }
            ...
            NO_INSTANCE
            }//end of nDOF_trial_elementIn=6
          else
            NO_INSTANCE
        }//end of nDOF_mesh_trial_elementIn=3
          else
        NO_INSTANCE
        }//end of space=2
    }//end of CompKernelFlag=0
      else
        {
          NO_INSTANCE
        }
