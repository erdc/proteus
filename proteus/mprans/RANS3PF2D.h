    ...
    cppRANS3PF2D():
                                  ...
                                  double* ball_angular_velocity)
      {
        ...
        if(USE_SBM==-1)
        {
            ...
            double phi_s=0.0;
            double vel[2];
            int i = get_distance_to_ball(nParticles,ball_center,ball_radius,x,y,z,phi_s);
            if(phi_s<=0.0)
            {
            ...
            //mass advective flux, for rans2p
            mass_adv[0]=0.0;
            mass_adv[1]=0.0;
            dmass_adv_u[0]=0.0;
            dmass_adv_u[1]=0.0;
            ...
            mom_uu_diff_ten[1] = nu_0;//2*nu_0 has no difference 
            ...
            for(int k=0;k<nQuadraturePoints_element;k++)
              {
                ...
                if(nParticles > 0 && (USE_SBM==0||USE_SBM==0))
