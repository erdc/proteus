...
class LevelModel(proteus.Transport.OneLevelTransport):
    ...
    def __init__(self,
        ...
        self.velFunction = options.velFunction
    ...
    def updateVelocityAtDOFs(self):
        ...
        self.u_vel_dofs[:] = self.velFunction[0](X,t)
        self.v_vel_dofs[:] = self.velFunction[1](X,t)
    #
    ...
    def update_uInlet_dofs(self):        
        ...
        self.quantDOFs2[:] = self.uInletDOFs
    ...
    def compute_matrices(self):
        if self.cterm_global is None:
            ...
            self.uInletDOFs=np.zeros(self.u[0].dof.shape,'d')
