...
namespace proteus
{
  ...
  public:
    ...
    inline void calculateElementResidual_bdf(//element
                     double dt,
                     double* mesh_trial_ref,
                     double* mesh_grad_trial_ref,
                     double* mesh_dof,
      ...
      for(int eN=0;eN<nElements_global;eN++)
    {
      ...
      calculateElementResidual_bdf(dt,
                   mesh_trial_ref,
                   mesh_grad_trial_ref,
                   mesh_dof,
                   mesh_l2g,
    ...
    inline void calculateElementJacobian_bdf(//element
                     double dt,
                     double* mesh_trial_ref,
                     double* mesh_grad_trial_ref,
                     double* mesh_dof,
      ...
      for(int eN=0;eN<nElements_global;eN++)
    {
      ...
      calculateElementResidual(0.0,//useless
                   mesh_trial_ref,
                   mesh_grad_trial_ref,
                   mesh_dof,
                   mesh_l2g,
