...
namespace proteus
{
  ...
  public:
    ...
    virtual void calculateResidual_explicit_comp_quad(//element
    				   double dt,
    				   double* mesh_trial_ref,
    				   double* mesh_grad_trial_ref,
    				   double* mesh_dof,
  ...
  public:
    ...
    inline
    void evaluateCoefficients_explicit_comp_quad(const double& epsHeaviside,
    			      const double& epsDirac,
    			      const double& phi,
    			      const double& H,
    ...
    inline void calculateElementResidual_explicit_comp_quad(//element
    		   	   	   	 double dt,
					 double* mesh_trial_ref,
					 double* mesh_grad_trial_ref,
					 double* mesh_dof,
      ...
      for  (int k=0;k<nQuadraturePoints_element;k++)
	{
	  ...
	  epsDiffusion = epsFactDiffusion*(useMetrics*h_phi+(1.0-useMetrics)*elementDiameter[eN]);
	  // *(useMetrics*h_phi+(1.0-useMetrics)*elementDiameter[eN]);
	  evaluateCoefficients_explicit_comp_quad(epsHeaviside,
			       epsDirac,
			       q_phi[eN_k],
			       q_H[eN_k],
				   q_phi_old[eN_k],///YY
    ...
    void calculateResidual_explicit_comp_quad(//element
    			   double dt,
    			   double* mesh_trial_ref,
    			   double* mesh_grad_trial_ref,
    			   double* mesh_dof,
          ...
          for(int eN=0;eN<nElements_global;eN++)
    	{
    	  ...
    	  calculateElementResidual_explicit_comp_quad(dt,
    			       mesh_trial_ref,
    				   mesh_grad_trial_ref,
    				   mesh_dof,
    				   mesh_l2g,
