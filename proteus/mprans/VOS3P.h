              ...
              for (int j=0;j<nDOF_trial_element;j++)
                {
                  ...
                  globalJacobian_a.data()[csrRowIndeces_u_u.data()[eN_i] + csrColumnOffsets_u_u.data()[eN_i_j]] += elementJacobian_u_u[i][j];
                }//j
            }//i
        }//elements
      //
                  ...
                  for (int j=0;j<nDOF_trial_element;j++)
                    {
                      ...
                      globalJacobian_a.data()[csrRowIndeces_u_u.data()[eN_i] + csrColumnOffsets_eb_u_u.data()[ebN_i_j]] += fluxJacobian_u_u[j]*u_test_dS[i];
                    }//j
                }//i
            }//kb
        }//ebNE
