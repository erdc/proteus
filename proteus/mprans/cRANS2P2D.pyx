...
cdef class cRANS2P2D_base:
    ...
    def calculateLSCStabilizationC1(self,
                                    double TYPE,
                                    double NONCONSERVATIVE_FORM,
                                    double MOMENTUM_SGE,
                                    double PRESSURE_SGE,
                                    ...
                                    numpy.ndarray elementFlags,
                                    numpy.ndarray boundaryFlags):
        cdef numpy.ndarray rowptr, colind, LSC_stab_c1_vals
        (rowptr, colind, LSC_stab_c1_vals) = LSC_stab_c1.getCSRrepresentation()
        self.thisptr.calculateLSCStabilizationC1(TYPE,
