...
cdef extern from "mprans/VOF3P.h" namespace "proteus":
    cdef cppclass cppVOF3P_base:
        ...
        void getInflowDOFs(double* mesh_dof,            
                           ...
                           double* inflow_DOFs)
        void calculateResidual_cellBased(double * mesh_trial_ref,
...
cdef class VOF3P:
    ...
    def calculateResidual_cellBased(self,
...
#                assert(self.nElementBoundaryQuadraturePoints_elementBoundary == 1)
    ...
    def getResidual(self, u, r):
        ...
        self.dt_times_dC_minus_dL = numpy.zeros(Cx.shape,'d')
        ...
        self.vof.calculateResidual_edgeBased(  # element
