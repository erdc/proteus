...
namespace proteus
{
  ...
  public:
    ...
    virtual void FCTStep(double dt, 
			 ...
			 double* low_order_solution, //operators to construct low order solution
    ...
    virtual void getInflowDOFs(
			       ...
			       double* inflow_DOFs)=0;
    virtual void calculateResidual_cellBased(//element
  ...
  public:
		...
		for (int i=0;i<nDOF_test_element;i++)
		  {
		    ...
		    inflow_DOFs[offset_u+stride_u*u_l2g[eN_i]] = 1.0;
		  }
	    }//ebNE	  
	}
    }

    void calculateResidual_cellBased(//element
			   double* mesh_trial_ref,
			   double* mesh_grad_trial_ref,
			   double* mesh_dof,
			   double* mesh_velocity_dof,
    ...
    void calculateResidual_edgeBased(//element
			   double* mesh_trial_ref,
			   double* mesh_grad_trial_ref,
			   double* mesh_dof,
			   double* mesh_velocity_dof,
      ...
      for(int eN=0;eN<nElements_global;eN++)
	{
	  ...
	  for  (int k=0;k<nQuadraturePoints_element;k++)
		...
		q_dV_last[eN_k] = dV;
	      ...
	      //////////////////////////////
	      calculateCFL(elementDiameter[eN],vn,cfl[eN_k]); // TODO: ADJUST SPEED IF MESH IS MOVING
