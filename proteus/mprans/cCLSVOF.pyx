...
cdef extern from "CLSVOF.h" namespace "proteus":
    cdef cppclass CLSVOF_base:
        ...
        void FCTStep(int NNZ,
                     ...
                     double * MassMatrix)
        void calculateResidualPreRedistancing(double dt,
                               double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
                               double* mesh_velocity_dof,
			       ...
			       double alpha,
			       double* ref_levelSet_dof)
        void calculateJacobianPreRedistancing(double dt,
                               double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
                               double* mesh_velocity_dof,
...
cdef class cCLSVOF_base:
   ...
   def calculateResidual(self,
			 ...
			 double epsFact_redist,
			 double alpha,
			 numpy.ndarray ref_levelSet_dof):
   ...
   def calculateResidualPreRedistancing(self,
                         double dt,
                         numpy.ndarray mesh_trial_ref,
                         numpy.ndarray mesh_grad_trial_ref,
                         numpy.ndarray mesh_dof,
			 ...
			 double alpha,
			 numpy.ndarray ref_levelSet_dof):
       self.thisptr.calculateResidualPreRedistancing(dt,
                                      <double*> mesh_trial_ref.data,
                                      <double*> mesh_grad_trial_ref.data,
                                      <double*> mesh_dof.data,
                                      <double*> mesh_velocity_dof.data,
				      ...
				      alpha,
				      <double*> ref_levelSet_dof.data)
   def calculateJacobianPreRedistancing(self,
                         double dt,
                         numpy.ndarray mesh_trial_ref,
                         numpy.ndarray mesh_grad_trial_ref,
                         numpy.ndarray mesh_dof,
       ...
       cdef numpy.ndarray rowptr,colind,globalJacobian_a
       (rowptr,colind,globalJacobian_a) = globalJacobian.getCSRrepresentation()
       self.thisptr.calculateJacobianPreRedistancing(dt,
                                      <double*> mesh_trial_ref.data,
                                      <double*> mesh_grad_trial_ref.data,
                                      <double*> mesh_dof.data,
                                      <double*> mesh_velocity_dof.data,
