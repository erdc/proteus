...
cdef extern from "NCLS.h" namespace "proteus":
    cdef cppclass NCLS_base:
        ...
        double calculateRhsSmoothing(double* mesh_trial_ref,
                                      ...
                                      int offset_u, int stride_u, 
                                      double* globalResidual)
        double calculateMass(double* mesh_trial_ref,
                             double* mesh_grad_trial_ref,
                             double* mesh_dof,
                             int* mesh_l2g,
                             double* dV_ref,
        ...
        void calculateJacobian(double dt,
                               ...
                               int LUMPED_MASS_MATRIX)
        void calculateJacobian_TG3(double dt,
                               double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
                               double* mesh_velocity_dof,
...
cdef class cNCLS_base:
   ...
   def calculateMass(self, 
                     ...
                     numpy.ndarray u_dof,
		     double epsFactHeaviside):
        return self.thisptr.calculateMass(
                                       <double*>mesh_trial_ref.data,
                                       <double*>mesh_grad_trial_ref.data,
                                       <double*>mesh_dof.data,
                                       <int*>mesh_l2g.data,
   ...
   def calculateJacobian(self,
       ...
       self.thisptr.calculateJacobian(dt, 
                                       ...
                                       LUMPED_MASS_MATRIX)
   def calculateJacobian_TG3(self,
                         double dt,
                         numpy.ndarray mesh_trial_ref,
                         numpy.ndarray mesh_grad_trial_ref,
                         numpy.ndarray mesh_dof,
       ...
       cdef numpy.ndarray rowptr,colind,globalJacobian_a
       (rowptr,colind,globalJacobian_a) = globalJacobian.getCSRrepresentation()
       self.thisptr.calculateJacobian_TG3(dt, 
                                       <double*>mesh_trial_ref.data,
                                       <double*>mesh_grad_trial_ref.data,
                                       <double*>mesh_dof.data,
                                       <double*>mesh_velocity_dof.data,
