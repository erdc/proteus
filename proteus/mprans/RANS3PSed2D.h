  ...
  template<class CompKernelType,
	...
	if(density > 1e-8)
      ...
      void calculateResidual(arguments_dict& args)
      {
        ...
        const xt::pyarray<double>& q_velocity_fluid = args.m_darray["q_velocity_fluid"];
        const xt::pyarray<double>& q_velocityStar_fluid = args.m_darray["q_velocityStar_fluid"];
        ...
        double LAG_MU_FR = args.m_dscalar["LAG_MU_FR"];
        xt::pyarray<double>& q_mu_fr_last = args.m_darray["q_mu_fr_last"];
        xt::pyarray<double>& q_mu_fr = args.m_darray["q_mu_fr"];
        //
