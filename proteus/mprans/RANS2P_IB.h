  ...
  template<class CompKernelType,
    ...
    RANS2P_IB():
      ...
      void calculateResidual(arguments_dict& args)
      {
        ...
        xt::pyarray<double>& q_dragBeam1 = args.array<double>("q_dragBeam1");
        xt::pyarray<double>& q_dragBeam2 = args.array<double>("q_dragBeam2");
        xt::pyarray<double>& q_dragBeam3 = args.array<double>("q_dragBeam3");
        xt::pyarray<double>& ebqe_dragBeam1 = args.array<double>("ebqe_dragBeam1");
        xt::pyarray<double>& ebqe_dragBeam2 = args.array<double>("ebqe_dragBeam2");
        xt::pyarray<double>& ebqe_dragBeam3 = args.array<double>("ebqe_dragBeam3");
        //
        ...
        for(int eN=0;eN<nElements_global;eN++)
          {
            ...
            double elementResidual_p[nDOF_test_element],
      ...
      void calculateForce   (arguments_dict& args)
      {
        ...
        xt::pyarray<double>& w_dof = args.array<double>("w_dof");
        xt::pyarray<double>& g = args.array<double>("g");
        xt::pyarray<double>& rho_init = args.array<double>("rho_init");
        const double useVF = args.scalar<double>("useVF");
        xt::pyarray<double>& vf = args.array<double>("vf");
        xt::pyarray<double>& phi = args.array<double>("phi");
        xt::pyarray<double>& normal_phi = args.array<double>("normal_phi");
        ...
        int stride_v = args.scalar<int>("stride_v");
        int stride_w = args.scalar<int>("stride_w");
        xt::pyarray<double>& cg = args.array<double>("cg");
        xt::pyarray<double>& force = args.array<double>("force");
        xt::pyarray<double>& moment = args.array<double>("moment");
        int nExteriorElementBoundaries_global = args.scalar<int>("nExteriorElementBoundaries_global");
        xt::pyarray<int>& exteriorElementBoundariesArray = args.array<int>("exteriorElementBoundariesArray");
        xt::pyarray<int>& elementBoundaryElementsArray = args.array<int>("elementBoundaryElementsArray");
        xt::pyarray<int>& elementBoundaryLocalElementBoundariesArray = args.array<int>("elementBoundaryLocalElementBoundariesArray");
        xt::pyarray<int>& forceExtractionFaces = args.array<int>("forceExtractionFaces");
        int nForceExtractionFaces = args.scalar<int>("nForceExtractionFaces");
        xt::pyarray<double>& ebqe_vf_ext = args.array<double>("ebqe_vf_ext");
        xt::pyarray<double>& ebqe_phi_ext = args.array<double>("ebqe_phi_ext");
        xt::pyarray<double>& ebqe_normal_phi_ext = args.array<double>("ebqe_normal_phi_ext");
        xt::pyarray<double>& ebqe_kappa_phi_ext = args.array<double>("ebqe_kappa_phi_ext");
      ...
      void calculateBeams(arguments_dict& args)
      {
        ...
        xt::pyarray<double>& ebqe_dragBeam2 = args.array<double>("ebqe_dragBeam2");
        xt::pyarray<double>& ebqe_dragBeam3 = args.array<double>("ebqe_dragBeam3");
        int nBeams = args.scalar<int>("nBeams");
        int nBeamElements = args.scalar<int>("nBeamElements");
        int beam_quadOrder = args.scalar<int>("beam_quadOrder");
        double beam_Cd = args.scalar<double>("beam_Cd");
        xt::pyarray<double>& beamRadius = args.array<double>("beamRadius");
        xt::pyarray<double>& xq = args.array<double>("xq");
        xt::pyarray<double>& yq = args.array<double>("yq");
        xt::pyarray<double>& zq = args.array<double>("zq");
        xt::pyarray<double>& Beam_h = args.array<double>("Beam_h");
        xt::pyarray<double>& dV_beam = args.array<double>("dV_beam");
        xt::pyarray<double>& q1 = args.array<double>("q1");
        xt::pyarray<double>& q2 = args.array<double>("q2");
        xt::pyarray<double>& q3 = args.array<double>("q3");
        xt::pyarray<double>& vel_avg = args.array<double>("vel_avg");
        xt::pyarray<double>& netBeamDrag = args.array<double>("netBeamDrag");
        //
        //loop over elements to compute volume integrals and load them into element and global residual
        //
        double globalConservationError=0.0;
