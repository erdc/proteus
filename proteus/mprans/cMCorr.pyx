...
cdef class cMCorr_base:
    ...
    def calculateResidual(self,
                          ...
                          numpy.ndarray u_dof,
                          numpy.ndarray lambda_dof,
                          numpy.ndarray q_phiExact,
			  numpy.ndarray q_phi,			  			  
                          ...
                          numpy.ndarray global_LAGR_u,
                          numpy.ndarray global_b_u,
                          numpy.ndarray global_b_l,
                          int nExteriorElementBoundaries_global,
                          ...
                          double epsFactDiffusion_last,
                          const double H1):
        cdef double global_L1_interface
        cdef double global_L2_interface
        cdef double global_LInf_interface
        cdef double global_L1_Hinterface
        cdef double global_L2_Hinterface
        cdef double global_LInf_Hinterface
        cdef double global_L1_Dinterface
        cdef double global_L2_Dinterface
        cdef double global_LInf_Dinterface	
        ...
        self.thisptr.calculateResidual(<double*> mesh_trial_ref.data,
                                       ...
                                       <double*> u_dof.data,
                                       <double*> lambda_dof.data,
                                       <double*> q_phiExact.data,	
                                       <double*> q_phi.data,			       
                                       ...
                                       &global_L1_interface,
				       &global_L2_interface,
				       &global_LInf_interface,
                                       &global_L1_Hinterface,
				       &global_L2_Hinterface,
				       &global_LInf_Hinterface,
                                       &global_L1_Dinterface,
				       &global_L2_Dinterface,
				       &global_LInf_Dinterface,				       
                                       &global_L2_u,				       
                                       &global_H1_u,
                                       &global_J,
                                       &global_LAGR,
                                       ...
                                       <double*> global_LAGR_u.data,
                                       <double*> global_b_u.data,
                                       <double*> global_b_l.data,
    ...
    def calculateJacobian(self,
        ...
        (rowptr_N,colind_N,globalN_a) = globalN.getCSRrepresentation()
