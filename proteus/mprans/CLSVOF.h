  ...
  template<class CompKernelType,
    ...
    CLSVOF():
      ...
      void calculateResidual(arguments_dict& args)
      {
        ...
        int degree_polynomial = args.m_iscalar["degree_polynomial"];
        xt::pyarray<double>& u_dof = args.m_darray["u_dof"];
        xt::pyarray<double>& u_dof_old = args.m_darray["u_dof_old"];
        xt::pyarray<double>& velocity = args.m_darray["velocity"];
        xt::pyarray<double>& velocity_old = args.m_darray["velocity_old"];
        ...
        xt::pyarray<double>& q_mH = args.m_darray["q_mH"];
        ...
        xt::pyarray<double>& ebqe_velocity_ext = args.m_darray["ebqe_velocity_ext"];
        ...
        xt::pyarray<int>& isFluxBoundary_u = args.m_iarray["isFluxBoundary_u"];
        ...
        xt::pyarray<double>& ebqe_H = args.m_darray["ebqe_H"];
        xt::pyarray<double>& ebqe_flux = args.m_darray["ebqe_flux"];
        int timeOrder = args.m_iscalar["timeOrder"];
        int timeStage = args.m_iscalar["timeStage"];
        double epsFactHeaviside = args.m_dscalar["epsFactHeaviside"];
        double epsFactDirac = args.m_dscalar["epsFactDirac"];
        double epsFactRedist = args.m_dscalar["epsFactRedist"];
        double lambdaFact = args.m_dscalar["lambdaFact"];
        xt::pyarray<double>& min_distance = args.m_darray["min_distance"];
        xt::pyarray<double>& max_distance = args.m_darray["max_distance"];
        xt::pyarray<double>& mean_distance = args.m_darray["mean_distance"];
        xt::pyarray<double>& volume_domain = args.m_darray["volume_domain"];
        double norm_factor_lagged = args.m_dscalar["norm_factor_lagged"];
        double VelMax = args.m_dscalar["VelMax"];
        xt::pyarray<double>& projected_qx_tn = args.m_darray["projected_qx_tn"];
        xt::pyarray<double>& projected_qy_tn = args.m_darray["projected_qy_tn"];
        xt::pyarray<double>& projected_qz_tn = args.m_darray["projected_qz_tn"];
        xt::pyarray<double>& projected_qx_tStar = args.m_darray["projected_qx_tStar"];
        xt::pyarray<double>& projected_qy_tStar = args.m_darray["projected_qy_tStar"];
        xt::pyarray<double>& projected_qz_tStar = args.m_darray["projected_qz_tStar"];
        ...
        int preRedistancingStage = args.m_iscalar["preRedistancingStage"];
        xt::pyarray<double>& interface_locator = args.m_darray["interface_locator"];
          ...
          calculateMetricsAtEOS(arguments_dict& args)
      {
        ...
        int nElements_global = args.m_iscalar["nElements_global"];
        int nElements_owned = args.m_iscalar["nElements_owned"];
        int useMetrics = args.m_iscalar["useMetrics"];
        xt::pyarray<int>& u_l2g = args.m_iarray["u_l2g"];
        xt::pyarray<double>& elementDiameter = args.m_darray["elementDiameter"];
        xt::pyarray<double>& nodeDiametersArray = args.m_darray["nodeDiametersArray"];
        ...
        double epsFactHeaviside = args.m_dscalar["epsFactHeaviside"];
        xt::pyarray<double>& u_dof = args.m_darray["u_dof"];
        xt::pyarray<double>& u0_dof = args.m_darray["u0_dof"];
      ...
      std::tuple<double, double, double, double, double> calculateMetricsAtETS(arguments_dict& args)
      {
        ...
        int stride_u = args.m_iscalar["stride_u"];
        int numDOFs = args.m_iscalar["numDOFs"];
        xt::pyarray<double>& R_vector = args.m_darray["R_vector"];
        xt::pyarray<double>& sR_vector = args.m_darray["sR_vector"];
        double global_V = 0.0;
        double global_V0 = 0.0;
        double global_sV = 0.0;
        double global_sV0 = 0.0;
      ...
      void normalReconstruction(arguments_dict& args)
      {
        ...
        int stride_u = args.m_iscalar["stride_u"];
        int numDOFs = args.m_iscalar["numDOFs"];
        xt::pyarray<double>& weighted_lumped_mass_matrix = args.m_darray["weighted_lumped_mass_matrix"];
        xt::pyarray<double>& rhs_qx = args.m_darray["rhs_qx"];
        xt::pyarray<double>& rhs_qy = args.m_darray["rhs_qy"];
        xt::pyarray<double>& rhs_qz = args.m_darray["rhs_qz"];
        xt::pyarray<int>& csrRowIndeces_u_u = args.m_iarray["csrRowIndeces_u_u"];
        xt::pyarray<int>& csrColumnOffsets_u_u = args.m_iarray["csrColumnOffsets_u_u"];
        xt::pyarray<double>& weighted_mass_matrix = args.m_darray["weighted_mass_matrix"];
        for (int i=0; i<numDOFs; i++)
          {
      ...
      void calculateRhsL2Proj(arguments_dict& args)
      {
        ...
        xt::pyarray<int>& u_l2g = args.m_iarray["u_l2g"];
        xt::pyarray<double>& elementDiameter = args.m_darray["elementDiameter"];
        double he_for_disc_ICs = args.m_dscalar["he_for_disc_ICs"];
        xt::pyarray<double>& u_dof = args.m_darray["u_dof"];
        int offset_u = args.m_iscalar["offset_u"];
        int stride_u = args.m_iscalar["stride_u"];
        int numDOFs = args.m_iscalar["numDOFs"];
        xt::pyarray<double>& rhs_l2_proj = args.m_darray["rhs_l2_proj"];
        for (int i=0; i<numDOFs; i++)
      ...
      void assembleSpinUpSystem(arguments_dict& args)
      {
        ...
        int nElements_global = args.m_iscalar["nElements_global"];
        xt::pyarray<int>& u_l2g = args.m_iarray["u_l2g"];
        xt::pyarray<double>& uInitial = args.m_darray["uInitial"];
        int offset_u = args.m_iscalar["offset_u"];
        int stride_u = args.m_iscalar["stride_u"];
        xt::pyarray<double>& globalResidual = args.m_darray["globalResidual"];
        xt::pyarray<int>& csrRowIndeces_u_u = args.m_iarray["csrRowIndeces_u_u"];
        xt::pyarray<int>& csrColumnOffsets_u_u = args.m_iarray["csrColumnOffsets_u_u"];
        xt::pyarray<double>& globalMassMatrix = args.m_darray["globalMassMatrix"];
        for(int eN=0;eN<nElements_global;eN++)
          {
            register double
      ...
      void FCTStep(arguments_dict& args)
      {
        ...
        int numDOFs = args.m_iscalar["numDOFs"];
        xt::pyarray<double>& lumped_mass_matrix = args.m_darray["lumped_mass_matrix"];
        xt::pyarray<double>& soln = args.m_darray["soln"];
        xt::pyarray<double>& solH = args.m_darray["solH"];
        xt::pyarray<double>& solL = args.m_darray["solL"];
        xt::pyarray<double>& limited_solution = args.m_darray["limited_solution"];
        ...
        xt::pyarray<double>& MassMatrix = args.m_darray["matrix"];
