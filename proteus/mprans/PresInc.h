...
namespace proteus
{
  ...
  public:
    ...
    void calculateResidual(arguments_dict& args)
    {
        ...
        xt::pyarray<int>& isDOFBoundary = args.m_iarray["isDOFBoundary"];
        xt::pyarray<int>& isFluxBoundary = args.m_iarray["isFluxBoundary"];
        ...
        xt::pyarray<double>& q_vf = args.m_darray["q_vf"];
        xt::pyarray<double>& q_divU = args.m_darray["q_divU"];
        xt::pyarray<double>& q_vs = args.m_darray["q_vs"];
        xt::pyarray<double>& q_vos = args.m_darray["q_vos"];
        double rho_s = args.m_dscalar["rho_s"];
        xt::pyarray<double>& q_rho_f = args.m_darray["q_rho_f"];
        double rho_s_min = args.m_dscalar["rho_s_min"];
        double rho_f_min = args.m_dscalar["rho_f_min"];
        xt::pyarray<double>& ebqe_vf = args.m_darray["ebqe_vf"];
        xt::pyarray<double>& ebqe_vs = args.m_darray["ebqe_vs"];
        xt::pyarray<double>& ebqe_vos = args.m_darray["ebqe_vos"];
        xt::pyarray<double>& ebqe_rho_f = args.m_darray["ebqe_rho_f"];
        ...
        xt::pyarray<double>& ebqe_adv_flux = args.m_darray["ebqe_adv_flux"];
        xt::pyarray<double>& ebqe_diff_flux = args.m_darray["ebqe_diff_flux"];
        xt::pyarray<double>& bc_adv_flux = args.m_darray["bc_adv_flux"];
        xt::pyarray<double>& bc_diff_flux = args.m_darray["bc_diff_flux"];
        ...
        int INTEGRATE_BY_PARTS_DIV_U = args.m_iscalar["INTEGRATE_BY_PARTS_DIV_U"];
