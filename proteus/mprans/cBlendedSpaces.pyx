...
cdef class cBlendedSpaces_base:
    ...
    def calculateResidual(self,
			  ...
			  numpy.ndarray MC,
                          ...
                          numpy.ndarray xFlux_dof_old,
			  numpy.ndarray yFlux_dof_old,
                          double umaxG,
			  double uminG,
                          numpy.ndarray uHDot,
                          double cE,
			  numpy.ndarray EntVisc,
                          numpy.ndarray elem_patch,
                          numpy.ndarray gamma_elem,
        ...
        self.thisptr.calculateResidual(dt,
				       ...
				       <double*> dLow.data,
			               ...
			               < double*> MC.data,
                                       ...
                                       <double*> xFlux_dof_old.data,
			               <double*> yFlux_dof_old.data,
                                       umaxG,
				       uminG,
                                       <double*> uHDot.data,
                                       cE,
