...
cdef class RANS3PF:
    ...
    def calculateResidual(self,
                          ...
                          int KILL_PRESSURE_TERM,
                          double dt,
                          numpy.ndarray entropyResidualAtCell,
                          numpy.ndarray maxSpeed2AtCell,
                          double maxSpeed2AtOmega,
                          numpy.ndarray rhoAtCell,
                          numpy.ndarray muAtCell,
        ...
        self.thisptr.calculateResidual(< double * > mesh_trial_ref.data,
                                        ...
                                        KILL_PRESSURE_TERM,
                                        dt,
                                        < double * > entropyResidualAtCell.data,
                                        < double * > maxSpeed2AtCell.data,
                                        maxSpeed2AtOmega,
                                        < double * > rhoAtCell.data,
                                        < double * > muAtCell.data,
