...
cdef class cSW2DCV_base:
    ...
    def calculateResidual(self,
                          ...
                          numpy.ndarray ebqe_nx,
			  numpy.ndarray ebqe_ny,
                          numpy.ndarray x_grad_h,
			  numpy.ndarray x_grad_hu,
			  numpy.ndarray x_grad_hv,
                          numpy.ndarray y_grad_h,
			  numpy.ndarray y_grad_hu,
			  numpy.ndarray y_grad_hv,
                          numpy.ndarray dLow,
                          numpy.ndarray hLow,
			  numpy.ndarray huLow,
			  numpy.ndarray hvLow,
        ...
        self.thisptr.calculateResidual(< double * > mesh_trial_ref.data,
                                       ...
                                       <double*> ebqe_nx.data,
			               <double*> ebqe_ny.data,
                                       <double*> x_grad_h.data,
				       <double*> x_grad_hu.data,
				       <double*> x_grad_hv.data,
                                       <double*> y_grad_h.data,
				       <double*> y_grad_hu.data,
				       <double*> y_grad_hv.data,
                                       < double * > dLow.data,
                                       <double*> hLow.data,
				       <double*> huLow.data,
				       <double*> hvLow.data,
