...
cdef extern from "SW2DCV.h" namespace "proteus":
    cdef cppclass SW2DCV_base:
        ...
        void calculateJacobian_cell_based_entropy_viscosity(double* mesh_trial_ref,
                               ...
                               int* csrColumnOffsets_eb_v_u,
                               int* csrColumnOffsets_eb_v_v)                               
        void calculateJacobian_second_order_NonFlatB_with_EV(double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
                               double* mesh_velocity_dof,
                               double MOVING_DOMAIN,
                               ...
                               int* csrColumnOffsets_eb_v_u,
                               int* csrColumnOffsets_eb_v_v)                               
        void calculateJacobian_GP(double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
                               double* mesh_velocity_dof,
                               double MOVING_DOMAIN,
...
cdef class cSW2DCV_base:
   ...
   def calculateResidual(self,
			 ...
			 double useMetrics, 
                         ...
                         numpy.ndarray h_dof_old_old, 
                         numpy.ndarray hu_dof_old_old, 
                         numpy.ndarray hv_dof_old_old, 
       ...
       self.thisptr.calculateResidual(#element
           <double*> mesh_trial_ref.data,
            ...
            <int*> h_l2g.data, 
            <int*> vel_l2g.data, 
            <double*> h_dof_old_old.data, 
            <double*> hu_dof_old_old.data, 
            <double*> hv_dof_old_old.data, 
   ...
   def calculateJacobian_cell_based_entropy_viscosity(self,
       ...
       self.thisptr.calculateJacobian_cell_based_entropy_viscosity(<double*> mesh_trial_ref.data,
                                      ...
                                      <int*> csrColumnOffsets_eb_v_u.data,
                                      <int*> csrColumnOffsets_eb_v_v.data)
   def calculateJacobian_second_order_NonFlatB_with_EV(self,
                         numpy.ndarray mesh_trial_ref,
                         numpy.ndarray mesh_grad_trial_ref,
                         numpy.ndarray mesh_dof,
                         numpy.ndarray mesh_velocity_dof,
       ...
       cdef numpy.ndarray rowptr,colind,globalJacobian_a
       (rowptr,colind,globalJacobian_a) = globalJacobian.getCSRrepresentation()
       self.thisptr.calculateJacobian_second_order_NonFlatB_with_EV(<double*> mesh_trial_ref.data,
                                       <double*> mesh_grad_trial_ref.data,
                                       <double*> mesh_dof.data,
                                       <double*> mesh_velocity_dof.data,
                                       MOVING_DOMAIN,
   ...
   def calculateJacobian_GP(self,
       ...
       cdef numpy.ndarray rowptr,colind,globalJacobian_a
       (rowptr,colind,globalJacobian_a) = globalJacobian.getCSRrepresentation()
       self.thisptr.calculateJacobian_GP(<double*> mesh_trial_ref.data,
                                       <double*> mesh_grad_trial_ref.data,
                                       <double*> mesh_dof.data,
                                       <double*> mesh_velocity_dof.data,
                                       MOVING_DOMAIN,
