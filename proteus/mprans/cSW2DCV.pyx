...
cdef class cSW2DCV_base:
   ...
   def calculateEdgeBasedCFL(self, 
	       ...
	       numpy.ndarray CTy,
	       numpy.ndarray alpha, 
	       numpy.ndarray global_entropy_residual, 
	       numpy.ndarray dLow, 
       ...
       self.thisptr.calculateEdgeBasedCFL(
			    ...
			    <double*> CTy.data,
			    <double*> alpha.data,
			    <double*> global_entropy_residual.data,
			    <double*> dLow.data,
   ...
   def calculateResidual_SUPG(self,
			 ...
			 double useMetrics, 
                         ...
                         numpy.ndarray h_dof_lstage, 
                         numpy.ndarray hu_dof_lstage, 
                         numpy.ndarray hv_dof_lstage, 
                         numpy.ndarray b_dof, 
                         numpy.ndarray h_dof, 
       ...
       self.thisptr.calculateResidual_SUPG(#element
           <double*> mesh_trial_ref.data,
            ...
            <double*> h_dof_lstage.data, 
            <double*> hu_dof_lstage.data, 
            <double*> hv_dof_lstage.data, 
            <double*> b_dof.data, 
            <double*> h_dof.data, 
            <double*> hu_dof.data, 
            <double*> hv_dof.data, 
