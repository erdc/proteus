...
cdef extern from "EVNonDiluteTransport.h" namespace "proteus":
    cdef cppclass EVNonDiluteTransport_base:
        ...
        void calculateMassMatrix(double dt,
                               ...
                               int* csrColumnOffsets_eb_u_u,
                               int LUMPED_MASS_MATRIX)
    EVNonDiluteTransport_base* newEVNonDiluteTransport(int nSpaceIn,
...
cdef class cEVNonDiluteTransport_base:
   ...
   def calculateResidual(self,
                         ...
                         double mass_in,
                         numpy.ndarray p_dof,
                         numpy.ndarray p_quad,
                         numpy.ndarray entropy,
                         numpy.ndarray u_vel_norm,
                         int ModelId,
                         bint Alt_Split,
                         bint Mom_Split,
