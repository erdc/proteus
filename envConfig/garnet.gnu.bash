...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${PROTEUS_PREFIX}/lib:${ACML_DIR}/gnu64/lib:/opt/xt-libsci/11.0.00/gnu/46/mc8/lib
#export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${PROTEUS_PREFIX}/lib:${ACML_DIR}/gnu64/lib:/opt/xt-libsci/10.4.9/gnu/46/mc8/lib
