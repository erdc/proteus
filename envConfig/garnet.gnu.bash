...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${PROTEUS_PREFIX}/lib:/opt/cray/libsci/12.1.00/gnu/48/interlagos/lib:/opt/fftw/3.3.0.3/interlagos/lib:/usr/local/usp/openssl/lib
export CC=gcc
export CXX=g++
export FC=gfortran
export F77=gfortran
