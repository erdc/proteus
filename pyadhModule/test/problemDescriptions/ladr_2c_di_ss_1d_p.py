...
# \ref ladr_2c_di_ss_1d_p.py "Linear advection-diffusion-reaction, two-component, diagonal system, at equilibrium"
#

##\ingroup test
#\file ladr_2c_di_ss_1d_p.py
#
#\brief Linear advection-diffusion-reaction system with two-components at equilibrium in 1D.
#\todo finish ladr_2c_di_ss_1d_p.py doc
nd = 1
