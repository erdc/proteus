...
iparsInput = InputTranslators.Ipars("iparsinput_case2",layered=True)
L = iparsInput.L
...
coefficients = ConservativeHeadRichardsJLeverettAni(phi_block=numpy.array([0.4,0.4,0.4,0.4,0.4]),
                                                    psiD_block=numpy.array([psiD,psiD,psiD,psiD,psiD]),
...
psiD=0.0
coefficients = ConservativeHeadRichardsJLeverettAni(phi_block=numpy.array([0.4,0.4,0.4,0.4,0.4]),
                                                    psiD_block=numpy.array([dimensionless_pd,dimensionless_pd,dimensionless_pd,dimensionless_pd,dimensionless_pd]),
