...
vertices =[(0.0,0.0,0.0),                                     #0
           (0.0,(ny+3)*diameter,0.0),                         #1 
           ((nx+3)*diameter,(ny+3)*diameter,0.0),             #2
           ((nx+3)*diameter,0.0,0.0),                         #3
           (0.0,0.0,(nz+3)*diameter),                         #4
           (0.0,(ny+3)*diameter,(nz+3)*diameter),             #5
           ((nx+3)*diameter,(ny+3)*diameter,(nz+3)*diameter), #6
           ((nx+3)*diameter,0.0,(nz+3)*diameter)]             #7
nN = 8
...
for i in range(nz):
    for j in range(ny):
        for k in range(nx):
            grain_centers[(i,j,k)]=(k*diameter+2*diameter,
                                    j*diameter+2*diameter,
                                    i*diameter+2*diameter)
            north_poles[(i,j,k)]=nN
            vertices.append((k*diameter+2*diameter,
                             j*diameter+2*diameter,
                             i*diameter+2*diameter+radius))
            nN+=1
            back_poles[(i,j,k)]=nN
            vertices.append((k*diameter+2*diameter,
                             j*diameter+2*diameter+radius,
                             i*diameter+2*diameter))
            nN+=1
            right_poles[(i,j,k)]=nN
            vertices.append((k*diameter+2*diameter+radius,
                             j*diameter+2*diameter,
                             i*diameter+2*diameter))
            nN+=1
            if i > 0:
