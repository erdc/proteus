...
"""
name = "gw_block_2d_anis_pwl"
##\page Tests Test Problems 
# \ref gw_block_2d_p.py "Heterogeneous Poisson's equation"
#

##\ingroup test
#\file gw_block_2d_p.py
#
...
for j in range(nblocks[1]):
    for i in range(nblocks[0]):
        ...
        if i == nblocks[0]-1 and j == nblocks[1]-1: 
...
def headBCs(x,tag):
    if tag == boundaryTags['left'] and x[1] > L[1]*0.5:
