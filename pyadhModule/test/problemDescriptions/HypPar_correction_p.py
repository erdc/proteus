...
from HypPar_Itr_TransportCoefficients import *
from HypPar_SetParams import *
#John Chrispell, Spring 08

phase = "correction"

coefficients = HypPar_Coefficients(q=q,alpha=alpha,delta=delta,phase=phase,setParamsFunc=setParams)
...
#initialConditions  = {0:ParabolicIC2()}
