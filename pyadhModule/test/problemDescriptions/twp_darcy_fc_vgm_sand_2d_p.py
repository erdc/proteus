...
model = 'VGM'
name = "twp_darcy_fc_vgm_sand_se_top_1"
...
slit_left = 1.0#L[0]*0.3
slit_right= 2.0#L[0]*0.7

hour = 3600.0 #[s]
T = 1.2e-1*hour                          # time [s]
...
def getDBC_psiw(x,flag):
    ...
    if x[1] == L[1] and slit_left <= x[0] and x[0] <= slit_right:
        return (lambda x,t: psi_top,1)
    if x[1] == 0.0:
     	return (lambda x,t: psi_bottom,1)
