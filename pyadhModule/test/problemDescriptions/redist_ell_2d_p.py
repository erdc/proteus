...
# \ref redist_ell_2d_p.py "Hamilton Jacobi LS redistancing (circle)"
# 

##\ingroup test
# \file redist_ell_2d_p.py
# @{
...
x0 = 0.50
y0 = 0.50
analyticalSolution = {0:Ell(x0,y0)}
...
coefficients = RedistanceLevelSet(epsFact=1.5,u0=EllSquared(x0,y0))
...
initialConditions  = {0:EllSquared(x0,y0)}
