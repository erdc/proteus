...
from ls_porousObstacle_st_2d_p import *
...
subgridError = None
#mwf orig subgridError = HamiltonJacobi_ASGS(coefficients,nd,lag=False)
...
#mwf orig shockCapturing = ResGradQuad_SC(coefficients,nd,shockCapturingFactor=0.25,lag=False)
