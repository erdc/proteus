...
import lens2d 
name = "twp_darcy_fc_sand"#"twp_darcy_fc_waterInfil_2d_sand_cgs_T2592"
...
Se_top = 0.8#usual 0.8#0.95#1.0                        # effective saturation top
Sw_top= Se_top*(sw_max-sw_min) + sw_min
psi_top = 0.1     #psi_w at top

waterTable =  -0.1#-1.0#elevation of water table 
...
hour = 3600.0 #[s]
T = 1.8*hour#12.0*hour #24.e-1*hour sand 12*hour, clay 24*hour                          # time [s]
