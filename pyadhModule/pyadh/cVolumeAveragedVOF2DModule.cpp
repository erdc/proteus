...
static PyObject* cVolumeAveragedVOF2D_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
                        "dididOOOOOOOOOOOOOOOOiiOiOOOOOOOOOOOOOO",
			&eps,
                        &nElements_global,
			&alphaBDF,
			&lag_shockCapturing,
...
static PyObject* cVolumeAveragedVOF2D_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
  ...
  if (!PyArg_ParseTuple(args,
    ...
    return NULL;
  //calculateJacobian_VolumeAveragedVOF2D(nElements_global,
...
static PyMethodDef cVolumeAveragedVOF2DMethods[] = {
 { "calculateResidual",
    cVolumeAveragedVOF2D_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cVolumeAveragedVOF2D_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVolumeAveragedVOF2D(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVolumeAveragedVOF2D", cVolumeAveragedVOF2DMethods);
