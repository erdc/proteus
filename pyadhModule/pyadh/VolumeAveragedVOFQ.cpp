...
extern "C" void VOL_VOF_RES (double epsFact,
			     ...
			     double* ebqe_flux)
{
  using namespace VOL_VOF_NAME; //VolumeAveragedVOFQ;
  //
  ...
  std::cout<<"VOFQ global conservation============================================================="<<globalConservation<<std::endl;
}

//extern "C" void calculateJacobian_VolumeAveragedVOFQ(int nElements_global,
