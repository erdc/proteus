...
#include "VolumeAveragedVOF2DQ.h"
...
static PyObject* cVolumeAveragedVOF2DQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
                        "ididOOOOOOOOOOOOOOOiiOiOOOOOOOOOOOOOO",
                        &nElements_global,
			&dt,
			&lag_shockCapturing,
			&shockCapturingDiffusion,
  ...
  //calculateResidual_VolumeAveragedVOF2DQ(nElements_global,
  VOL_VOF_RES(nElements_global,
				      dt,
				      lag_shockCapturing,
				      shockCapturingDiffusion,
				      IDATA(u_l2g), 
...
static PyObject* cVolumeAveragedVOF2DQ_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
  ...
  if (!PyArg_ParseTuple(args,
    ...
    return NULL;
  //calculateJacobian_VolumeAveragedVOF2DQ(nElements_global,
...
static PyMethodDef cVolumeAveragedVOF2DQMethods[] = {
 { "calculateResidual",
    cVolumeAveragedVOF2DQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cVolumeAveragedVOF2DQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVolumeAveragedVOF2DQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVolumeAveragedVOF2DQ", cVolumeAveragedVOF2DQMethods);
