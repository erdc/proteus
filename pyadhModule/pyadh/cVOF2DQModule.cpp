...
static PyObject* cVOF2DQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  //calculateResidual_VOFQ(nElements_global,
  VOFQ_RES(nElements_global,
		    dt,
		    lag_shockCapturing,
		    shockCapturingDiffusion,
		    IDATA(u_l2g), 
...
static PyObject* cVOF2DQ_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
  ...
  if (!PyArg_ParseTuple(args,
    ...
    return NULL;
  //calculateJacobian_VOFQ(nElements_global,
  VOFQ_JAC(nElements_global,
		    dt,
		    lag_shockCapturing,
		    shockCapturingDiffusion,
		    IDATA(u_l2g), 
...
static PyMethodDef cVOF2DQMethods[] = {
 { "calculateResidual",
    cVOF2DQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cVOF2DQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVOF2DQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVOF2DQ", cVOF2DQMethods);
