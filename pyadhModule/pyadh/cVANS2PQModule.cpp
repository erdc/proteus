...
static PyObject* cVANS2PQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args,
			...
			&flux_ext))
    return NULL;
  calculateResidual_VANS2PQ(nElements_global,
			   dt,
			   eps_rho,
			   eps_mu,
			   sigma,
...
static PyObject* cVANS2PQ_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global,
    turbulenceClosureFlag,//new
  ...
  if (!PyArg_ParseTuple(args,
			...
			&csrColumnOffsets_eb_w_w))
    return NULL;
  calculateJacobian_VANS2PQ(nElements_global,
			   dt,
			   eps_rho,
			   eps_mu,
			   sigma,
...
static PyMethodDef cVANS2PQMethods[] = {
 { "calculateResidual",
    cVANS2PQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the two-phase VANS equations"},
 { "calculateJacobian",
    cVANS2PQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVANS2PQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVANS2PQ", cVANS2PQMethods);
