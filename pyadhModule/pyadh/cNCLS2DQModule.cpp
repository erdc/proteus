...
static PyObject* cNCLS2DQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
static PyObject* cNCLS2DQ_calculateJacobian(PyObject* self,
					   PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
...
static PyMethodDef cNCLS2DQMethods[] = {
 { "calculateResidual",
    cNCLS2DQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cNCLS2DQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcNCLS2DQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cNCLS2DQ", cNCLS2DQMethods);
