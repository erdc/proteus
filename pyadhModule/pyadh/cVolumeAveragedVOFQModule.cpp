...
static PyObject* cVolumeAveragedVOFQ_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
static PyObject* cVolumeAveragedVOFQ_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
  ...
  if (!PyArg_ParseTuple(args,
    ...
    return NULL;
  //calculateJacobian_VolumeAveragedVOFQ(nElements_global,
...
static PyMethodDef cVolumeAveragedVOFQMethods[] = {
 { "calculateResidual",
    cVolumeAveragedVOFQ_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cVolumeAveragedVOFQ_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcVolumeAveragedVOFQ(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cVolumeAveragedVOFQ", cVolumeAveragedVOFQMethods);
