...
extern "C" void calculateResidual_VANS2P2DQ(int nElements_global,
					   double dt,
					   double eps_rho,
					   double eps_mu,
					   double sigma,
...
extern "C" void calculateJacobian_VANS2P2DQ(int nElements_global,
					   double dt,
					   double eps_rho,
					   double eps_mu,
					   double sigma,
...
extern "C" void calculateVelocityAverage_VANS2P2DQ(int nInteriorElementBoundaries_global,
