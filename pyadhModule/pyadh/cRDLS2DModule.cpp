...
static PyObject* cRDLS2D_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
static PyObject* cRDLS2D_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int useTimeIntegration,lag_shockCapturing,lag_stabilization,
...
static PyMethodDef cRDLS2DMethods[] = {
 { "calculateResidual",
    cRDLS2D_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for redistancing the level set equation"},
 { "calculateJacobian",
    cRDLS2D_calculateJacobian,
   METH_VARARGS, 
...
extern "C"
{
PyMODINIT_FUNC initcRDLS2D(void)
{
  PyObject *m,*d;
  m = Py_InitModule("cRDLS2D", cRDLS2DMethods);
