...
C pt_adaptive_rk ROUTINES (REPACKAGED TO INTEGRATE WITH PYADH)
C
C < GLOBAL INFO >
...
C ======================================================================
C MWF 
C PYADH TRANSLATION KEY FOR PT123
...
C MWF MODIFIED TO USE WITH PYADH
C MWF CHANGES
...
C      
      DO 600 IPT=1,NPT
CMWF NOTE HAVE TO ACCOUNT FOR BASE ZERO INDEXING IN PYADH
