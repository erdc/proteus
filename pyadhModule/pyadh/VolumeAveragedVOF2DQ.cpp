...
//extern "C" void calculateResidual_VolumeAveragedVOF(int nElements_global,
extern "C" void VOL_VOF_RES (int nElements_global,
						    double dt,
						    ...
						    double* ebqe_u)
{
  using namespace VOL_VOF_NAME; //VolumeAveragedVOF;
  //
  ...
  for (int ebNE = 0; ebNE < nExteriorElementBoundaries_global; ebNE++) 
	...
	{ 
	  ...
	  //	   <<" isFluxBoundary_u= "<<isFluxBoundary_u[ebNE_kb]<<" flux_ext= "<<flux_ext<<std::endl;
...
//extern "C" void calculateJacobian_VolumeAveragedVOF(int nElements_global,
extern "C" void VOL_VOF_JAC(int nElements_global,
						    double dt,
						    int lag_shockCapturing,/*mwf not used yet*/
						    double shockCapturingDiffusion,
						    int* u_l2g,
