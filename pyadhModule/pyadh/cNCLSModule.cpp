...
static PyObject* cNCLS_calculateResidual(PyObject* self,
					   PyObject* args)
{
...
static PyObject* cNCLS_calculateJacobian(PyObject* self,
					 PyObject* args)
{
  int nElements_global;
  int lag_shockCapturing;
...
static PyMethodDef cNCLSMethods[] = {
 { "calculateResidual",
    cNCLS_calculateResidual,
   METH_VARARGS, 
   "Calculate the global residual for the non-conservative level set equation"},
 { "calculateJacobian",
    cNCLS_calculateJacobian,
   METH_VARARGS, 
...
{
  PyObject *m,*d;
  m = Py_InitModule("cNCLS", cNCLSMethods);
