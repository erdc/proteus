...
#define MCorrQ_SPACE_DIM 3
#if (MCorrQ_SPACE_DIM == 3)
 #define nSpace 3
 ...
 #define MCORR_NAME MCorrQ3D
 #define MCORR_RES calculateResidual_MCorrQ3D
 #define MCORR_JAC calculateJacobian_MCorrQ3D
#else
 #if (MCorrQ_SPACE_DIM == 2)
  #define nSpace 2
  ...
  #define MCORR_NAME MCorrQ2D
  #define MCORR_RES calculateResidual_MCorrQ2D
  #define MCORR_JAC calculateJacobian_MCorrQ2D
 #else 
  #define nSpace 1
  ...
  #define MCORR_NAME MCorrQ1D
  #define MCORR_RES calculateResidual_MCorrQ1D
  #define MCORR_JAC calculateJacobian_MCorrQ1D
 #endif
#endif

namespace MCORR_NAME // MCorrQ
{
...
extern "C"
{
  //void calculateResidual_MCorrQ(int nElements_global,
  ...
  //void calculateJacobian_MCorrQ(int nElements_global,
