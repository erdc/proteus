...
extern "C"
{
void calculateResidual_RANS2PQ(int nElements_global,
		       double dt,
		       double eps_rho,
		       double eps_mu,
		       double sigma,
...
void calculateJacobian_RANS2PQ(int nElements_global,
		       double dt,
		       double eps_rho,
		       double eps_mu,
		       double sigma,
...
void calculateVelocityAverage_RANS2PQ(int nExteriorElementBoundaries_global,
				     int* exteriorElementBoundariesArray,
